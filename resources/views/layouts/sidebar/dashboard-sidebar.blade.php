<div class="content-sidebar h-100">
    ...
    @php
        ...
        $sidebarModules = [
            ...
            'csms' => ['route' => 'csms::dashboard', 'label' => 'CMS', 'icon' => 'fa-users-gear'],
    ...
    <ul>
        @auth
            <li class="item-sidebar my-1 mx-3">
                <a href="{{ url('/home') }}"
                    class="d-flex align-items-center justify-content-between fw-bold py-2 px-3 rounded text-white"
                    style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 6px rgba(16, 185, 129, 0.2); text-decoration: none;">
        ...
        @else
            <li class="item-sidebar my-1 mx-3">
                <a href="{{ route('login') }}"
                    class="d-flex align-items-center justify-content-between fw-bold py-2 px-3 rounded text-white"
                    style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 4px 6px rgba(59, 130, 246, 0.2); text-decoration: none;">
        ...
        <li class="item-sidebar my-1 mx-3">
            <a href="{{url('/')}}"
                class="d-flex align-items-center justify-content-between fw-normal bg-green py-2 px-3 rounded text-white"
        ...
        <li class="help-sidebar position-absolute bottom-0 d-flex my-1 mx-3 last">
            <a href="{{url('')}}"
                class="d-flex align-items-center justify-content-between fw-normal bg-green py-2 px-3 rounded text-white">Help</a>
        </li>
    </ul>
