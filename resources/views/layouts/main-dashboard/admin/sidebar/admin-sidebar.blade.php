...
<div class="content-sidebar">
    <ul>
        ...
        <li class="item-sidebar">
            <a href="{{ route('production_index') }}"
                class="link-sidebar text-decoration-none   @if ($routeName == 'production_index') active @endif">Production</a>
        </li>
        ...
        @can('Dashboard - Attachment')
            <li class="item-sidebar">
                <a href="{{ route('attachment_index') }}"
                    class="link-sidebar text-decoration-none   @if ($routeName == 'attachment_index') active @endif">Attachment</a>
            </li>
        @endcan
