...
<div class="inner-content">
    ...
    <div class="header-add-maker h-60px border d-flex gap-2 align-items-center justify-content-between px-3">
        <div class="left-header">
            <a href="{{ route('k3lh_activities_index') }}" class="d-flex align-items-center gap-3 ">
                ...
                <form action="#" class="form-horizontal" wire:submit.prevent="store">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-8">
                            ...
                            @if ($file)
                                <img src="{{ $file->temporaryUrl() }}" class="input-img">
                    ...
                    <div class="mb-3 form-group row">
                        <label for="formFile" class="col-sm-4 col-form-label">Image</label>
                        <div class="col-sm-8">
