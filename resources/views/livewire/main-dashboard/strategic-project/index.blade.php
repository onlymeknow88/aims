        ...
        <div class="col-11">
            ...
            <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2 sticky-top">
                ...
                <div class="toolbar-left d-flex align-items-center">
                    <a href="{{ route('strategic_project_create') }}" type="button"
                ...
                <div class="toolbar-right d-flex align-items-center">
                    {{-- <input type="text" class="form-control form-sm-control" wire:model="search" wire:keydown="render()"   placeholder="search"> --}}
                </div><!-- /.toolbar-right -->
                                ...
                                <tr wire:key="{{ $index }}">
                                    <td>
                                        <input class="form-check-input" name="selected" type="checkbox"
                                            wire:click="SelectRow({{ $list }})" value="{{ $list->id }}"
                                    ...
                                    <td>
                                        {{ strip_tags(Illuminate\Support\Str::words($list->title, 5)) }}
                                    </td>
                                    <td>
                                        {!! strip_tags(Illuminate\Support\Str::words($list->description, 10)) !!}
                                    </td>

                                    <td>
                                        <a href="{{ route('strategic_project_edit', $list->id) }}"><i
                                                class="fas fa-pencil-alt fa-1x"></i></a>
                                        <a href="{{ route('strategic_project_public_show', $list->slug) }}"><i
