        ...
        <div class="col-11">
            ...
            <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2 sticky-top">
                ...
                <div class="toolbar-left d-flex align-items-center">
                    <a href="{{ route('production_create') }}" type="button"
                    ...
                    <table class="table table-document">
                        ...
                        <tbody>
                            @foreach ($data as $index => $list)
                                <tr wire:key="{{ $index }}" wire:click="SelectRow({{ $list }})">
                                    <td>
                                    ...
                                    <td> {{ $list->coal_shiping }}</td>
                                    <td> {{ $list->waste_removal }}</td>
                                    <td> {{ $list->coal_mining }}</td>
                                    <td> {{ $list->coal_hauling }}</td>
                                    <td> {{ $list->coal_barged }}</td>
                                    <td>
                                        <a href="{{ route('production_edit', $list->id) }}"><i
