        ...
        <div class="col-11">
            ...
            <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2 sticky-top">
                ...
                <div class="toolbar-left d-flex align-items-center">
                    <a href="{{ route('incident_notification_create') }}" type="button"
                        ...
                        <tbody>
                            @foreach ($data as $index => $list)
                                <tr>
                                    ...
                                    <td>
                                        <span>
                                            <a href="{{ route('incident_notification_edit', $list->id) }}">
                                        ...
                                        <span>
                                            @if ($list->slug)
                                                <a
                                                    href="{{ route('incident_notification_public_show', $list->slug) }}">
