...
<div class="inner-content">
    ...
    <div class="header-add-maker h-60px border d-flex gap-2 align-items-center justify-content-between px-3">
        <div class="left-header">
            <a href="{{ route('incident_notification_index') }}" class="d-flex align-items-center gap-3 ">
                <span><i class="fa-solid fa-arrow-left"></i></span>
                <span>Incident Notification </span>
            </a>
        </div><!-- /.left-header -->
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-8">
                ...
                <form action="#" class="form-horizontal" wire:submit.prevent="store">
                    ...
                    <div class="mb-3 form-group row ">
                        <label for="inputEmail3" class="col-sm-4 col-form-label">Case</label>
                        <div class="col-sm-8">
                            <input type="text" wire:model.lazy="input.case" class="form-control" placeholder="" />
                            @error('input.case')
                                <small class="error text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 form-group row ">
                        ...
                        <div class="col-sm-8">
                            <input type="text" wire:model="input.category" id="description" :error="'description'"
                                class="form-control">
                        </div>
                    </div>
