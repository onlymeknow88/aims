            ...
            <nav class="navbar  navbar-dark container-fluid  bg-transparent m-0" style="height:60px">
                <div class="container-fluid">
                    ...
                    <div class=" d-flex align-items-center gap-3">
                        <a href="{{ route('k3lh_activities_public_index') }}" class="nav-back text-secondary pr-3"> <i
                                class="fas fa-arrow-left fa-2x"></i> </a>
                        <span class="text-secondary pl-3 index-title">Kegiatan K3LH </span>
                    </div>
                </div>
            </nav>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="show">
                        ...
                        @if ($data->url)
                            <img class="img" src="{{ url($data->url) }}" alt="Image" width="100%"
                                srcset="{{ url($data->url) }}">
                        @endif
