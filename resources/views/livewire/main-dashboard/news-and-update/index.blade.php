        ...
        <div class="col-11">
            ...
            <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2 sticky-top">
                ...
                <div class="toolbar-left d-flex align-items-center">
                    <a href="{{ route('news_and_update_create') }}" type="button"
                ...
                <div class="toolbar-right d-flex align-items-center">
                    {{-- <input type="text" class="form-control form-sm-control" wire:model="search"
                        wire:keydown="render()" placeholder="search"> --}}
                </div><!-- /.toolbar-right -->
                        ...
                        <tbody>
                            @foreach ($data as $index => $list)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('news_and_update_edit', $list->id) }}"><i
                                                class="fas fa-pencil-alt fa-1x"></i></a>
                                        <a href="{{ route('news_and_update_show', $list->slug) }}"><i
