        ...
        <div class="row justify-content-center">
            ...
            <div class="col-8">
                ...
                <form action="#" class="form-horizontal" wire:submit.prevent="store">
                    ...
                    <div class="mb-3 form-group row ">
                        <label for="inputEmail3" class="col-sm-4 col-form-label">Project Date</label>
                        <div class="col-sm-8">
                            <input type="number" wire:model.lazy="input.project_to_date" class="form-control"
                                placeholder="" />
                            @error('input.project_to_date')
                                <small class="error text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="mb-3 form-group row ">
                        <label for="inputEmail3" class="col-sm-4 col-form-label">Manhours</label>
                        <div class="col-sm-8">
                            <input type="number" wire:model.lazy="input.manhours" class="form-control"
                                placeholder="" />
                            @error('input.manhours')
                                <small class="error text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="mb-3 form-group row ">
                        <label for="inputEmail3" class="col-sm-4 col-form-label">Day After Last LTI</label>
                        <div class="col-sm-8">
                            <input type="number" wire:model.lazy="input.day_after_last_lti" class="form-control"
                                placeholder="" />
                            @error('input.day_after_last_lti')
                                <small class="error text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="mb-3 form-group row ">
                        <label for="inputEmail3" class="col-sm-4 col-form-label">Manpower</label>
                        <div class="col-sm-8">
                            <input type="number" wire:model.lazy="input.manpower" class="form-control"
                                placeholder="" />
                            @error('input.manpower')
                                <small class="error text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    </div>
