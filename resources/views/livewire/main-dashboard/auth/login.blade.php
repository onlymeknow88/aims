                    ...
                    <div class="form-wrapper">
                        ...
                        @elseif ($show2FA)
                            <div class="text-center mb-4">
                                ...
                                <h5 class="fw-bold">Otentikasi Dua Faktor</h5>
                                <p class="text-muted small">Masukkan 6-digit kode verifikasi dari aplikasi Google Authenticator Anda.</p>
                            </div>

                            <form method="POST" wire:submit.prevent="verify2FA">
                                <div class="mb-4 form-floating">
                                    <input type="text" wire:model.defer='totp_code'
                                        class="form-control @error('totp_code') is-invalid @enderror"
                                        style="border-radius: 0.5rem; border-color: #cbd5e1; font-size: 1.25rem; font-weight: 600; text-align: center; letter-spacing: 0.5rem; padding-left: 0.5rem;"
                                        id="totp_code" maxlength="6" autocomplete="one-time-code" placeholder="123456" autofocus>
                                    <label for="totp_code" style="color: #64748b; width: 100%; text-align: center;">Kode Verifikasi</label>
                                    @error('totp_code')
                                        <div class="invalid-feedback text-center mt-2" style="display: block;">
                                            {{ $message }}
                                        </div>
                                    @enderror
                                </div>
                                ...
                                <div class="d-grid gap-2 mb-3">
                                    ...
                                    <button type="button" wire:click="cancel2FA"
                                        class="btn btn-outline-secondary btn-lg d-flex align-items-center justify-content-center gap-2"
                                        style="border-radius: 0.5rem; font-size: 1rem; font-weight: 600; padding: 0.75rem 1rem;">
                        ...
                        @elseif ($showEmailOTP)
                            <div class="text-center mb-4">
                                ...
                                <h5 class="fw-bold">OTP Verifikasi Email</h5>
                                <p class="text-muted small">Masukkan 6-digit kode OTP yang telah kami kirimkan ke email Anda.</p>
                            </div>

                            <form method="POST" wire:submit.prevent="verifyEmailOTP">
                                <div class="mb-4 form-floating">
                                    <input type="text" wire:model.defer='email_otp_code'
                                        class="form-control @error('email_otp_code') is-invalid @enderror"
                                        style="border-radius: 0.5rem; border-color: #cbd5e1; font-size: 1.25rem; font-weight: 600; text-align: center; letter-spacing: 0.5rem; padding-left: 0.5rem;"
                                        id="email_otp_code" maxlength="6" autocomplete="one-time-code" placeholder="123456" autofocus>
                                    <label for="email_otp_code" style="color: #64748b; width: 100%; text-align: center;">Kode OTP Email</label>
