<div class="inner-content">
    ...
    <div class="header-detail-approval h-60px bg-green d-flex align-items-center px-3">
        <a href="{{ route('approval') }}" class="d-flex align-items-center gap-3 text-white">
            ...
            <div class="info bg-white">
                ...
                <div class="info-item p-3 border-bottom border-1">
                    ...
                    <div class="pt d-flex flex-column gap-2">
                        <h6 class="fw-normal">PT Lahai Coal</h6>
        ...
        <div class="section-content w-100 py-3 px-5 d-flex flex-column gap-3">
            ...
            <div class="section-info py-3 px-2 d-flex flex-column gap-2">
                ...
                <div class="content-section d-flex flex-column gap-1">
                    ...
                    <div class="module-info-items row">
                        ...
                        <div class="col-8">1. Kebijakan</div>
                    </div><!-- /.module-info-items -->

                    <div class="module-info-items row">
                        <div class="col-4 opacity-50">Category</div>
                        <div class="col-8">1.1 Kebijakan PT MC</div>
                    </div><!-- /.module-info-items -->

                    <div class="module-info-items row">
                        <div class="col-4 opacity-50">Mapping</div>
                        <div class="col-8">1.1.1 Kebijakan KPLHEG</div>
                    </div><!-- /.module-info-items -->
            ...
            <div class="section-status py-3 px-2 d-flex flex-column gap-2">
                ...
                <div class="content-section d-flex flex-column gap-1">
                    ...
                    <div class="module-status-items row">
                        ...
                        <div class="col-8">Document</div>
                    </div><!-- /.module-info-items -->

                    <div class="module-status-items row">
                        <div class="col-4 opacity-50">Document</div>
                        <div class="col-8">Manual</div>
                    </div><!-- /.module-info-items --> 
            ...
            <div class="section-invited-email py-3 px-2 d-flex flex-column gap-2">
                ...
                <div class="content-section d-flex flex-column gap-1 h-200px overflow-auto">
                    ...
                    <div class="module-invited-email-items d-flex flex-wrap gap-2 ">
                        <div class="btn btn-outline-secondary">sebastian.poole@gmail.com</div>
                        <div class="btn btn-outline-secondary">lily.welch@gmail.com</div>
                        <div class="btn btn-outline-secondary">sophie.walker@gmail.com</div>
                        <div class="btn btn-outline-secondary">heather.bell@gmail.com</div>
                        <div class="btn btn-outline-secondary">frank.smith@gmail.com</div>
                        <div class="btn btn-outline-secondary">claire.watson@gmail.com</div>
                        <div class="btn btn-outline-secondary">rose.mitchell@gmail.com</div>
                        <div class="btn btn-outline-secondary">tracey.langdon@gmail.com</div>
                        <div class="btn btn-outline-secondary">sean.young@gmail.com</div>
                        <div class="btn btn-outline-secondary">donna.sutherland@gmail.com</div>
                        <div class="btn btn-outline-secondary">paul.morrison@gmail.com</div>
                    </div><!-- /.module-info-items -->
            ...
            <div class="footer-action">
                <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                    <a href="{{ route('approval') }}" class="btn btn-outline-secondary" >Cancel</a>
                    <div class="button-document">
                        <button class="dropdown-toggle btn btn-outline-default bg-green d-flex justify-content-center align-item-center text-white position-relative"  role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Document Action
                        </button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Approval</a></li>
                            <li><a class="dropdown-item" href="#"  data-bs-toggle="modal" data-bs-target="#modalReview">Return with comment</a></li>
                          </ul>
                    </div>                    
                </div>
            </div>
                        ...
                        <div class="item-content d-flex gap-1 align-items-center">
                            ...
                            <div class="activity-item d-flex flex-column gap-2">
                                ...
                                <div class="activity-header d-flex justify-content-between align-items-center gap-2">
                                    ...
                                    <div class="tools">
                                        <a href="#" role="button"   data-bs-toggle="modal" data-bs-target="#modalActivity"><img src="{{ asset('./images/icons/menu.png') }}" alt="menu"></a>                                        
                                    </div>
                                </div><!-- /.activity-item -->

                                <div class="activity-content" x-data="{ contentOpen: false }"">

                                    <div class="activity-inner d-flex flex-column gap-2" :class="contentOpen ? 'height-auto' : ''" x-transition.delay.5s>
                                        ...
                                        <div class="images">
                                            ...
                                            <div class="image d-flex align-items-center justify-content-between bg-white rounded p-2 border border-1 mb-2">
                        ...
                        <div class="item-content d-flex gap-1 align-items-center">
                            ...
                            <div class="activity-item d-flex flex-column gap-2">
                                ...
                                <div class="activity-content" x-data="{ contentOpen: false }"">
                                    ...
                                    <div class="activity-inner h-auto d-flex flex-column gap-2" :class="contentOpen ? 'height-auto' : ''" x-transition.delay.5s>
                                        <div class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labor...</div>
                                </div><!-- /.actifity-content -->
            ...
            <div class="modal-content">
                <form action="#">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</textarea>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success">Submit this comment</button>
                    </div>
                </form>
            </div>
        </div>
