<div class="inner-content">
    ...
    <div class="header-add-maker h-60px bg-green d-flex gap-2 align-items-center justify-content-between px-3">
        <div class="left-header">
            <a href="{{ route('document-systems::active-document') }}"
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-8">
                <form class="form-horizontal" enctype="multipart/form-data">
                    @include('livewire.document-systems.active-document._form-document')

                    <div class="footer-action mb-2">
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            <a href="{{ route('document-systems::active-document') }}" class="btn btn-outline-secondary">Cancel</a>
