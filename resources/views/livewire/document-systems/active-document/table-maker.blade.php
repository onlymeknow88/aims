...
<div x-data="{ itemSelected: @entangle('itemSelected'), info: @entangle('info') }">
    ...
    <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2">
        ...
        <div class="toolbar-right d-flex align-items-center">
            ...
            <button
                class="dropdown-toggle btn btn-outline-default d-flex text-white position-relative py-2 px-3"
            ...
            <ul class="dropdown-menu">
                ...
                <li class="ms-2">
                    <input class="form-check-input" name="selected" type="checkbox" selected="selected"> Penanggung Jawab
                </li>
                <li class="ms-2">
            ...
            {{-- <a href="#" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3">
                <span class="icon d-flex align-items-center">
                    <img src="{{asset('images/icons/filter.png')}}" alt="image export">
                </span>
            </a> --}}
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr wire:key="{{ $itemIndex }}" wire:click="onSelectedItem({{ $item->id }})">
                    <td>
                        <input class=" form-check-input" name="selected" type="checkbox" value="{{ $item->id }}"
                    ...
                    <td>{{ \App\Enums\DocumentSystem\DocumentLevel::fromValue($item->document_level)->description }}</td>
