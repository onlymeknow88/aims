                ...
                <div class="activity d-flex flex-column gap-2">
                    ...
                    <div class="item-content align-items-center">
                        ...
                        <div class="activity-item d-flex flex-column gap-2">
                            ...
                            <div class="activity-header d-flex justify-content-between align-items-center gap-2">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="title d-flex flex-column">
                                        ...
                                        <span class="opacity-50">{{ $activity->user->department->name }}</span>
                                    </div>
                                </div>
                                <div class="tools">
                            ...
                            <div class="activity-content" x-data="{ contentOpen: true }"">

                                <div class="activity-inner d-flex flex-column gap-2 @if (count($activity->attachments) < 2) height-auto @endif"
