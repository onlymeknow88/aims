                ...
                <div class="col-12 col-md-12 col-lg-8">
                    ...
                    <form class="py-4 d-flex flex-column gap-5" action="#" action="post" wire:submit.prevent='save'>
                        ...
                        <div class="content-form d-flex flex-column gap-3">
                            ...
                            <div class="row form-group">    
                                <label for="id_hydrant" class="col-lg-4 col-md-12 col-form-label">No. ID Hydrant</label>
                                <div class="col-lg-8 col-md-12">
                                    <x-inputs.select2 wire:model="id_hydrant" id="id_hydrant" class="form-select" placeholder="Select No ID Hydrant">
                                        <option value="">Select No ID Hydrant</option>
                            ...
                            </div><!-- /.form-group id_hydrant -->


                            <div class="row form-group">    
                                <label for="type_hydrant" class="col-lg-4 col-md-12 col-form-label">Isi Hydrant</label>
                                <div class="col-lg-8 col-md-12">

                                    <div class="wrapper_type_hydrant d-flex flex-column gap-3">

                                        <x-inputs.select2 wire:model="type_hydrant" id="type_hydrant" class="form-select" placeholder="Select Isi Hydrant">
                                            <option value="">Select Isi Hydrant</option>
                                        ...
                                        <x-inputs.file wire:model="file_type_hydrant" id="file_type_hydrant" placeholder="Choose File" :error="'file_type_hydrant'" />

                                        <x-inputs.texteditor wire:model="komentar_type_hydrant" id="komentar_type_hydrant" placeholder="Komentar Type Hydrant" :error="'komentar_type_hydrant'" />
                                        
                                    </div><!-- /.wrapper_type_hydrant -->
                                    
                                </div><!-- /.col-lg-12 -->

                            </div><!-- /.form-group type_hydrant -->
                            ...
                            <div class="row form-group">    
                                <label for="hose_hydrant" class="col-lg-4 col-md-12 col-form-label">Hose Hydrant</label>
                                <div class="col-lg-8 col-md-12">
                                    ...
                                    <div 
                                        ...
                                        x-init="$watch('versi_hose', (value) => {
                                            $refs.kondisi_hose_hydrant.value = '';
                                            $refs.kondisi_hose_hydrant.dispatchEvent(new Event('change'));
                                        })"
                                    >

                                        <select wire:model="hose_hydrant" id="hose_hydrant" class="form-select" placeholder="Select Hose Hydrant">
                                            <option value="">Select Hose Hydrant</option>
                                            <option value="rubber">Rubber</option>
                                            <option value="canvas">Canvas</option>
                                        </select>

                                        <select wire:model="versi_hose" id="versi_hose" class="form-select" placeholder="Select Hose Hydrant">
                                            <option value="">Select Hose Hydrant</option>
                                            <option value="standard">Standard</option>
                                            <option value="tidak_standard">Tidak Standard</option>
                                        </select>

                                        <select  x-cloak x-ref='kondisi_hose_hydrant'  x-show="versi_hose === 'tidak_standard'" wire:model="kondisi_hose_hydrant" id="kondisi_hose_hydrant" class="form-select" placeholder="Select Kondisi Hose Hydrant">
                                            <option value="">Select Konsidi Hose Hydrant</option>
                                        ...
                                        <x-inputs.file wire:model="file_hose_hydrant" id="file_hose_hydrant" placeholder="Choose File" :error="'file_hose_hydrant'" />

                                        <x-inputs.texteditor wire:model="komentar_hose_hydrant" id="komentar_hose_hydrant" placeholder="Komentar Hose Hydrant" :error="'komentar_hose_hydrant'" />
                                ...
                                <div class="col-lg-8 col-md-12">
                                    ...
                                    >
                                        <select wire:model="type_nozzle" id="type_nozzle" class="form-select" placeholder="Select Type Nozzle">
                                            ...
                                            <option value="hydrant_straight">Hydrant Straight Nozzle</option>
                                        ...
                                        <select  x-cloak x-ref='kondisi_type_nozzle'  x-show="versi_nozzle === 'tidak_standard'" wire:model="kondisi_type_nozzle" id="kondisi_type_nozzle" class="form-select" placeholder="Select Kondisi Nozzle Hydrant">
                                            <option value="">Select Konsidi Nozzle Hydrant</option>
                            ...
                            <div class="row form-group">    
                                <label for="box_hydrant" class="col-lg-4 col-md-12 col-form-label">Box Hydrant</label>
                                <div class="col-lg-8 col-md-12">

                                    <div 
                                        class="wrapper_inspeksi d-flex flex-column gap-3" 
                                        x-data="{ box_hydrant: @entangle('box_hydrant') }" 
                                        x-init="$watch('box_hydrant', (value) => {
                                            $refs.kondisi_box_hydrant.value = '';
                                            $refs.kondisi_box_hydrant.dispatchEvent(new Event('change'));
                                        })"
                                    >

                                        <select wire:model="box_hydrant" id="box_hydrant" class="form-select" placeholder="Select Box Hydrant">
                                            <option value="">Select Box Hydrant</option>
                                            <option value="standard">Standard</option>
                                            <option value="tidak_standard">Tidak Standard</option>
                                        </select>

                                        <select  x-cloak x-ref='kondisi_box_hydrant'  x-show="box_hydrant === 'tidak_standard'" wire:model="kondisi_box_hydrant" id="kondisi_box_hydrant" class="form-select" placeholder="Select Kondisi Box Hydrant">
                                            <option value="">Select Konsidi Box Hydrant</option>
                                            <option value="pudar">Cat Pudar</option>
                                            <option value="berkarat">Berkarat</option>
                                            <option value="penyok">Penyok</option>
                                        </select>

                                        <x-inputs.file wire:model="file_box_hydrant" id="file_box_hydrant" placeholder="Choose File" :error="'file_box_hydrant'" />

                                        <x-inputs.texteditor wire:model="komentar_box_hydrant" id="komentar_box_hydrant" placeholder="Komentar Box Hydrant" :error="'komentar_box_hydrant'" />
                            ...
                            <div class="row form-group">    
                                <label for="penempatan" class="col-lg-4 col-md-12 col-form-label">Kondisi Penempatan Hydrant</label>
                                <div class="col-lg-8 col-md-12">
                            ...
                            <div class="row form-group">    
                                <label for="label_penanda" class="col-lg-4 col-md-12 col-form-label">Label Penanda Lokasi Hydrant</label>
                                <div class="col-lg-8 col-md-12">
                            ...
                            <div class="row form-group">    
                                <label for="demarkasi" class="col-lg-4 col-md-12 col-form-label">Demarkasi Hydrant</label>
                                <div class="col-lg-8 col-md-12">
                                    ...
                                    >
                                        ...
                                        <select wire:model="demarkasi" id="demarkasi" class="form-select" placeholder="Select Demarkasi Hydrant">
                                            <option value="">Select Demarkasi Hydrant</option>
                                        ...
                                        <x-inputs.texteditor wire:model="komentar_demarkasi" id="komentar_demarkasi" placeholder="Komentar Demarkasi Hydrant" :error="'komentar_demarkasi'" />
