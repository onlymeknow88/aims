<div class="progress-wrapper bg-green rounded-2 p-3 d-flex flex-column gap-2">

    <div class="title-progress text-white">
        <h6>By Kategory</h6>
    </div>
    <div class="progress-item text-white">
        <h6>Pre Employment</h6>
        <div class="progress">
            <div class="progress-bar bg-danger" role="progressbar" style="width: 96%;" aria-valuenow="96" aria-valuemin="0" aria-valuemax="100">96%</div>
        </div>
    </div>
