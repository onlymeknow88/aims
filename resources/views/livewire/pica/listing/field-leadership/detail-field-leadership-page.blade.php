<div class="inner-content">
    ...
    <div class="header-detail-maker h-60px bg-green d-flex gap-2 align-items-center px-3">
        <a href="{{ route('pica::listing.field-leadership.index') }}" class="d-flex align-items-center gap-3 text-white">
            <span><i class="fa-solid fa-arrow-left"></i></span>
            <span>Field Leadership</span>
        </a>
        <a href="{{ route('pica::listing.field-leadership.edit', $field->id) }}"
    ...
    <div class="detail-maker-content d-flex">
        ...
        <div class="section-content w-100 py-3 px-5 d-flex flex-column gap-3">
            ...
            <div class="footer-action mb-2 {{ $field->type == 'Hazard Report' ? '' : 'd-none' }}">
