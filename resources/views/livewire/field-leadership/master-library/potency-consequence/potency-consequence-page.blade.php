<div class="inner-content">
    ...
    <div class="section-content">
        ...
        <div class="section-title py-3 px-2">
            <h4>Potensi Konsekuensi</h4>
        </div><!-- /.section-title -->

        <div class="table-maker">

            <livewire:field-leadership.master-library.potency-consequence.partials.table-maker />
    ...
    <!-- Modal -->
    <div class="modal fade" id="FLPotencyModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="FLPotencyModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="FLPotencyModalLabel">Potensi Konsekuensi</h5>
...
<script>
    window.addEventListener('edit', event => {
        $('#FLPotencyModal').modal('show');
        if (event.detail.id) {
            @this.set('code', event.detail.code);
            @this.set('title', event.detail.name);
            @this.set('idPotency', event.detail.id);
        }
    });

    window.addEventListener('closeModal', event => {
        $('#FLPotencyModal').modal('hide');
        @this.set('code', null);
        @this.set('title', null);
        @this.set('idPotency', null);
        @this.set('edit', false);
    });
