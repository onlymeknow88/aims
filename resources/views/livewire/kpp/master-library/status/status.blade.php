<div class="inner-content">
    ...
    <div class="section-content">
        ...
        <div class="table-maker">
            ...
            <livewire:kpp.master-library.status.partials.table-maker />
    ...
    <!-- Modal -->
    <div class="modal fade" id="FLStatusModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="FLStatusModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="FLStatusModalLabel">Status</h5>
...
<script>
    window.addEventListener('edit', event => {
        $('#FLStatusModal').modal('show');
        if (event.detail.id) {
            @this.set('name', event.detail.name);
            @this.set('idStatus', event.detail.id);
        }
    });

    window.addEventListener('closeModal', event => {
        $('#FLStatusModal').modal('hide');
        @this.set('name', null);
        @this.set('idStatus', null);
    });
</script>
