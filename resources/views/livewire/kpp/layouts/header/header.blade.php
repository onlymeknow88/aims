<div class="container-fluid fixed-top bg-green">
    ...
    <div class="row collapse show d-flex align-items-center justify-content-between h-60px position-relative">
        ...
        <div class="col-3 d-flex align-items-center gap-3">
            <a @click="isSidebar = ! isSidebar" href="#" role="button" class="p-1 text-white">
                <i class="fa-solid fa-bars"></i>
            </a>
            <span class="logo text-white">Kepatuhan Peraturan & Perizinan - Document Systems</span>
        </div>
        <!-- end Toggle -->

        <!-- Start Search -->
        <div class="col">
            {{--@livewire('kpp.layouts.header.search')--}}
        </div>
        <!-- end Search -->
