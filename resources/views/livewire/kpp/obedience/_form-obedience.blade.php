    <div class="own-info mb-5">
        ...
        <div class="mb-3">
            <h5 class="fw-normal">Management Kepatuhan</h5>
        </div>

        <div class="mb-3 row form-group required">
            <label for="department" class="col-sm-4 col-form-label">CCOW</label>
            <div class="col-sm-8">
                <x-inputs.select2 wire:model="type" id="type" data-child="section"
        ...
        <div class="mb-3 row form-group required">
            <label for="department" class="col-sm-4 col-form-label">Perusahaan Mitra Kerja</label>
            <div class="col-sm-8">
                <x-inputs.select2 wire:model="type" id="type" data-child="section"
                    placeholder="Select Type" :error="'type'">
                    @foreach ($types as $key => $type)
        ...
        <div class="mb-3 row form-group required">
            <label for="department" class="col-sm-4 col-form-label">Validator</label>
            <div class="col-sm-8">
                <x-inputs.select2 wire:model="type" id="type" data-child="section"
                    placeholder="Select Type" :error="'type'">
                    @foreach ($types as $key => $type)
    ...
    <div class="own-info mb-5">
        ...
        <div class="mb-3 row form-group required">
            <label for="department" class="col-sm-4 col-form-label">No Peraturan</label>
            <div class="col-sm-8">
                <x-inputs.select2 wire:model="type" id="type" data-child="section"
                    placeholder="Select Type" :error="'type'">
                    @foreach ($types as $key => $type)
    ...
    <div class="own-info mb-5">
        ...
        <div class="mb-3 row form-group required">
            ...
            <div class="col-sm-8">
                <x-inputs.select2 wire:model="status" id="status" data-child="section"
        ...
        <div class="mb-3 row form-group required">
            ...
            <div class="col-sm-8">
                <x-inputs.select2 wire:model="agency_authority" id="agency_authority" data-child="section"
