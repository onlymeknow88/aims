<div class="inner-content">
    ...
    <div class="header-content-csms-add-new-bidding h-60px bg-white shadow-sm d-flex gap-2 align-items-center justify-content-between px-3">
        <div class="left-header">
            <a href="{{ route('mcu::patient') }}" class="d-flex align-items-center gap-3 text-white">
                    ...
                    <div class="info-item py-3 px-4 border-bottom border-1">
                        <div class="nip d-flex flex-column">
                            ...
                            <div class="item-content d-flex gap-1 align-items-center">
                                <span class="opacity-80">{{ $data['employee']['nip'] }} / {{ $data['employee']['nik'] }}</span>
                            </div>
                        </div><!-- /.nip -->
                    </div><!-- /.info-items -->
                        ...
                        <div class="content-section m-4">
                            ...
                            <div class="inner-section mb-5 mx-n">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    ...
                                    <div class="col-8 content-mcu-detail">
                                        <div class="content">{{ $data['sports_per_week'] }}</div>
                                    </div>
                            ...
                            <div class="inner-section mb-5 mx-n">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    ...
                                    <div class="col-8 content-mcu-detail">
                                        <div class="content">{{ $data['sports_per_week'] }} Hari</div>
                                    </div>
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        ...
                        <div class="content-section m-4">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                ...
                                <div class="col-8 content-mcu-detail">
                                    <div class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    ...
                    <div
                        ...
                        <div class="content-section m-4">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                ...
                                <div class="col-8 content-mcu-detail">
                                    <div class="content">Kesan visus</div>
                                </div>
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    ...
                                    <div class="col-8 content-mcu-detail">
                                        <div class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                            sed do eiusmod tempor incididtunt ut labore et dolore magna aliqua. Ut enim
