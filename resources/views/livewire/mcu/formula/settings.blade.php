                ...
                <div class="card border-dark mb-3">
                    ...
                    <div class="card-body text-dark">
                        ...
                        <div class="modal fade" id="modaladdformulabloodpressure" tabindex="-1" role="dialog"
                            aria-labelledby="modaladdformulabloodpressureLabel" aria-hidden="{{ $modalAddFormulaBloodPressure }}" wire:ignore.self>
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modaladdformulabloodpressureLabel">Tambah Formula Blood Pressure
                                        </h5>
                                ...
                                <tbody>
                                    @foreach ($FormulaBloodPressure as $itemIndex => $items)
                                        <tr wire:key="{{ $itemIndex }}"">
                                            <td>{{ $itemIndex + 1 }}</td>
                                            <td>
                                                <a wire:click="editFormulaBloodPressure({{ $items['id'] }})" >FBP-00{{ $items['id'] }}</a>
                                            </td>
                                ...
                                <tbody>
                                    @foreach ($FormulaDislipidemia as $itemIndex => $items)
                                        <tr wire:key="{{ $itemIndex }}"">
                                            ...
                                            <td>
                                                <a data-toggle="modal"
                                                    data-target="#modal-add-f2">FDP-00{{ $items['id'] }}</a>
                                            </td>
                                            <td>{{ $items['created_at'] }}</td>
                                            <td><span><img src="{{ asset('images/icons/user.png') }}"
                                                        alt=""></span>
