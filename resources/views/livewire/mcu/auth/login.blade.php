                    ...
                    <div class="content-login p-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                ...
                                <p class="text-white fs-5 mb-3">Akun-akun test MCU (Password bebas) :</p>
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#" class="d-flex gap-3 align-items-center text-white py-2 fs-5">
                                            ...
                                            <span>staff1@gmail.com</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="d-flex gap-3 align-items-center text-white py-2 fs-5">
                                            <span><img src="{{asset('./images/icons/check-login.png')}}" alt=""></span>
                                            <span>karyawan1@gmail.com</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="d-flex gap-3 align-items-center text-white py-2 fs-5">
                                            <span><img src="{{asset('./images/icons/check-login.png')}}" alt=""></span>
                                            <span>doctor1@gmail.com</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="d-flex gap-3 align-items-center text-white py-2 fs-5">
                                            <span><img src="{{asset('./images/icons/check-login.png')}}" alt=""></span>
                                            <span>company1@gmail.com</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
