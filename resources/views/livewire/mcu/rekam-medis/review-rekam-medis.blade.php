    ...
    <div class="container-fluid g-0 position-relative">
        ...
        <div class="row g-0">
            ...
            <div class="detail-left col-3">
                ...
                <div class="position-sticky top-0 bg-white pb-4">
                    ...
                    <div class="info-item py-3 px-4 border-bottom border-1" x-data="{dataOpen: false, dataClose:true}">
                        ...
                        <div
                            x-cloak
                            class="content-data-rekam-medis w-100 position-absolute top-0 start-0 bg-white vh-100 z-index-3 overflow-auto"
                            x-show="dataOpen"
            ...
            <div class="col pb-7 border-end border-start border-1">
                    ...
                    <div id="wrapper-review" class="wrapper-review border-1 border-bottom p-5">

                        <form action="#" method="post" wire:submit.prevent='saveReview'>

                            <div id="review" class="section-review">

                                <div class="header-accordion d-flex justify-content-between w-100 border-0 bg-white my-3 mx-4">
                                    <h6 class="mb-0 fw-normal">Review Dokter</h6>
                                </div>
                                <div class="wrapper-content-accordion overflow-hidden position-relative transition-all duration-700">
                                    ...
                                    <div class="content-section m-4">
                                        ...
                                        <div class="mb-3 row form-group required">
                                            ...
                                            <label for="status" class="col-12 col-form-label">Status Hasil Peninjauan</label>

                                            <div class="col-12">

                                                <x-inputs.select2 wire:model="status" id="status" placeholder="Select Status">
                                        ...
                                        </div><!-- /.form-group Status Hasil Peninjauan -->

                                        <div class="mb-3 row form-group required">

                                            <label for="dokter" class="col-12 col-form-label">Dokter Spesialis</label>

                                            <div class="col-12">

                                                <x-inputs.text wire:model="dokter" id="dokter" placeholder="Nama Dokter" :error="'dokter'" />

                                            </div>

                                        </div><!-- /.form-group dokter -->

                                        <div class="mb-3 row form-group required">

                                            <label for="saran" class="col-12 col-form-label">Saran</label>

                                            <div class="col-12">

                                                <x-inputs.textarea wire:model="saran" id="saran" rows="7" placeholder="Saran" :error="'saran'" />

                                            </div>

                                        </div><!-- /.form-group saran -->
                            ...
                            <div class="footer-action mb-5 p-4">
                                <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                                    <a href="{{ route('rekam-medis') }}" class="btn btn-outline-secondary" >Cancel</a>
                                    <button type="button" wire:click.prevent='cetakSertifikat()' class="btn btn-outline-default bg-green d-flex justify-content-center align-item-center text-white position-relative px-4">Cetak Sertifikat</button>
                                    <button type="submit" class="btn btn-outline-default bg-green d-flex justify-content-center align-item-center text-white position-relative px-4">Submit Review</button>
                                </div>
                            </div>
