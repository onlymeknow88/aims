<div class="inner-content">
    ...
    <div class="container-fluid g-0 position-relative">
        ...
        <div class="row g-0">
            ...
            <div class="col py-4 border-end border-start border-1">
                ...
                <form action="#" method="post" wire:submit.prevent='save'>
                    ...
                    <div id="karyawan" class="section-karyawan" x-data="{accordionOpen: true}">
                        ...
                        <button
                            class="header-accordion d-flex justify-content-between w-100 border-0 bg-white p-3 border-1 border-top border-bottom"
                    ...
                    <div id="anamnesis" class="section-anamnesis" x-data="{accordionOpen: true}">
                        ...
                        <button
                            class="header-accordion d-flex justify-content-between w-100 border-0 bg-white py-3 px-3"
                            @click.prevent="accordionOpen = ! accordionOpen"
                        >
