                ...
                <form action="#" class="form-horizontal" wire:submit.prevent="save">
                    ...
                    <div class="event-title mb-5">
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col">
                                <input type="text" wire:model.lazy="event.title" class="form-control" placeholder="Add Title" />
                                @error('event.title')
                    ...
                    <div class="event-category mb-5">
                        ...
                        <div class="mb-3 row form-group">
                            <div class="col">
                                <x-inputs.select2 wire:model="event.category_id" id="category" placeholder="Select Category">

                                    @foreach ($this->categories as $category)
                                        <option value="{{ $category->id }}">{{ $category->name }}</option>
                                    @endforeach

                                <label class="input-group-text" for=""><img src="{{asset('./images/icons/refresh.png')}}" alt="" /></label>

                        <div class="mb-3 row form-group">

                            <div class="col">
                                <div class="form-check">
                                    <input disabled wire:model="event.repeat" class="form-check-input" type="checkbox" value="true" id="repeat_checkbox">
                                ...
                                <div x-show="type === 'mingguan'">
                                    ...
                                    <div class="d-flex gap-2 align-items-center">
                                        <x-inputs.datepicker wire:model="start_date" id="start_date" :error="'start_date'" />
                                ...
                                <div x-show="type === 'bulanan'">
                                    <div class="d-flex gap-2 align-items-center">
                                        <x-inputs.bulanpicker wire:model="bulan_start" id="bulan_start" :error="'bulan_start'" />
                                        <div class="input-group-addon">Sampai</div>
                                        <x-inputs.bulanpicker wire:model="bulan_end" id="bulan_end" :error="'bulan_end'" />
                                    </div>
                                </div>

                                <div x-show="type === 'tahunan'">
                                    <div class="d-flex gap-2 align-items-center">
                                        <x-inputs.yearpicker wire:model="tahun_start" id="tahun_start" :error="'tahun_start'" />

                                        <div class="input-group-addon">Sampai</div>
                                        <x-inputs.yearpicker wire:model="tahun_end" id="tahun_end" :error="'tahun_end'" />
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <x-inputs.select2 wire:model="event.section_id" id="section" placeholder="Select Section">
                    ...
                    <div class="description mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-12">
                                <x-inputs.texteditor default="{!! $event->description !!}" model="event.description" id="description" :error="'event.description'" />
                            </div>
                    ...
                    <div class="footer-action mb-2">
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-success">Save Change</a>
                        </div>
                    </div>
