...
class Coe extends Component
{
    ...
    public function confirmDelete($data)
    {
        ...
        if ($event) {
            ...
            $this->flash('success', 'Event berhasil dihapus.', [], route('coe'));
        }
    }
    ...
    public function changeStatus($id, $status)
    {
        ...
        if ($update) {
            $this->flash('success', 'Status event berhasil diperbarui.', [], route('coe'));
        }
    }
