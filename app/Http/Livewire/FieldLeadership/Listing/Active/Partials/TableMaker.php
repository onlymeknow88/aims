...
namespace App\Http\Livewire\FieldLeadership\Listing\Active\Partials;
...
class TableMaker extends Component
{
    ...
    {
        return view('livewire.field-leadership.listing.active.partials.table-maker')->layout('livewire.field-leadership.layouts.app');
    }
}
