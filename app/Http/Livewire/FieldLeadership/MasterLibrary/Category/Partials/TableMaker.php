...
namespace App\Http\Livewire\FieldLeadership\MasterLibrary\Category\Partials;
...
class TableMaker extends Component
{
    ...
    {
        return view('livewire.field-leadership.master-library.category.partials.table-maker')->layout('livewire.field-leadership.layouts.app');
    }
}
