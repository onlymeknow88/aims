...
namespace App\Http\Livewire\FieldLeadership\MasterLibrary\TypeKtaTta\Partials;
...
class TableMaker extends Component
{
    ...
    {
        return view('livewire.field-leadership.master-library.type-kta-tta.partials.table-maker')->layout('livewire.field-leadership.layouts.app');
    }
}
