...
class EditFieldLeadershipPage extends Component
{
    use WithFileUploads;
    ...
    public function mount($id)
    {
        ...
        if (!empty($this->fieldLeadership->questions)) {
            ...
            $this->question1 = $this->fieldQuestion[0]['question'];
            $this->question2 = $this->fieldQuestion[1]['question'];
            $this->question3 = $this->fieldQuestion[2]['question'];

            $this->answer1 = $this->fieldQuestion[0]['answer'];
            $this->answer2 = $this->fieldQuestion[1]['answer'];
            $this->answer3 = $this->fieldQuestion[2]['answer'];
        }
    ...
    {
        return view('livewire.pica.listing.field-leadership.edit-field-leadership-page')->extends('livewire.pica.layouts.no-header');
    }
}
