                ...
                <form action="#" class="form-horizontal" wire:submit.prevent="save">
                        ...
                        <div class="mb-3 mt-4 row form-group">
                            ...
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select wire:model="frequency" class="form-select" id="frequency" disabled>
                            ...
                            <div class="col-4">
                                <div class="input-group">
                                    <label class="input-group-text" for=""><img
                                            src="{{ asset('./images/icons/refresh.png') }}" alt="" /></label>
                                    <select wire:model="repeat_day" class="form-select" id="repeat_day" disabled>
                        ...
                        <div class="mb-3 mt-3 row form-group">
                            ...
                            <div x-show="frequency == 'once'">
                                <div class="d-flex gap-3 align-items-center">
                                    ...
                                    <div :class="repeat_day != 'once' ? 'd-flex' : 'd-none'" class="gap-3 align-items-center">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            <div class="col-sm-3">
                                <a wire:click="change_attachment()" class="btn btn-warning"><i
                                        class="fa fa-file"></i> Ganti Attachment</a>
                            </div>
                            <div class="col-sm-9">
                                @if ($changeAttachment)
                                ...
                                @else
                                    @if ($file)
                                        <a href="{{ route('coe::attachment', $event->id) }}" class="form-control"
                    ...
                    <div class="description mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            <div class="col-sm-12">
                                <x-coe-texteditor default="{!! $event->description !!}" model="event.description"
                                    id="description" :error="'event.description'" />
                            </div>
