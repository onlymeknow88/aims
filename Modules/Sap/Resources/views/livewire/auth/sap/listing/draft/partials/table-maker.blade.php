<div x-data="{ itemSelected: @entangle('itemSelected'), info: @entangle('info') }">
    ...
    <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2">
        ...
        <div class="toolbar-left d-flex align-items-center">
            ...
            @if ($countSelected == 1)
                <a href="{{ route('field-leadership::listing.active.edit', $itemSelected) }}" type="button"
                    class="button-toolbar d-flex gap-2 align-items-center py-2 px-3">
                    <span class="icon d-flex align-items-center"><img src="{{ asset('images/icons/pencil.png') }}"
                            alt="image delete"></span>
        ...
        <div class="toolbar-right d-flex align-items-center">
            ...
            <a href="#" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3"
                data-bs-toggle="modal" data-bs-target="#sortModal_table">
                <span class="icon d-flex align-items-center"><img src="{{ asset('images/icons/sort.png') }}"
                        alt="image add"></span>
            </a>

            <button class="btn btn-outline-light button-toolbar d-flex text-white position-relative py-2 px-3 border-0"
    ...
    <div class="section-footer d-flex justify-content-between sticky-bottom bg-white align-items-center h-60px">
        ...
        {{ $this->activeListings->appends($latestUpdate)->links('components.paginate.paginate') }}
    </div><!-- /.section-footer -->
