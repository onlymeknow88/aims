<div class="own-info mb-5">
    ...
    <div class="mb-3 row form-group required">
        ...
        <div class="col-sm-8">
            ...
            <x-document-system-select-2 wire:model="company" id="company" placeholder="Select Company"
                data-child="department">
    ...
    <div class="mb-3 row form-group required">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2 wire:model="department" id="department" data-child="section"
    ...
    <div class="mb-3 row form-group required">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2 wire:model="section" id="section" data-child="pj"
    ...
    <div class="mb-3 row form-group required">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2-avatar wire:model="pj" id="pj" class="form-select"
...
<div class="map-info mb-5">
    ...
    <div class="mb-3 row form-group required">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2 wire:model="module" data-child="category" id="module"
    ...
    <div class="mb-3 row form-group required">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2 wire:model="category" data-child="map" id="category"
    ...
    <div class="mb-3 row form-group required">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2 wire:model="map" id="map" placeholder="Select Mapping">
...
<div class="doc-info mb-5">
    ...
    <div class="mb-3 row form-group">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2 wire:model="jenis_upload" id="jenis_upload" placeholder="Select Jenis Upload">
                <option value=""></option>
    ...
    <div class="mb-3 row form-group">
        ...
        <div class="col-sm-8">
            <x-document-system-select-2 wire:model="jenis_doc" id="jenis_doc" placeholder="Select Jenis Document">
                        ...
                        @if ($attachments && $attachments->count() > 0)
                            @foreach ($attachments as $file)
                                <div class="image position-relative d-flex flex-column align-items-start justify-content-center bg-white rounded p-3 border border-1"
                                    ...
                                    <a href="" class="btn-closed position-absolute"
                                        wire:click.prevent="deleteAttach('{{ $file->id }}' )">
                                        <img src="{{ asset('/images/icons/delete.png') }}" alt="">
                                    </a>
                                </div>
                            @endforeach
