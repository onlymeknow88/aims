...
<div class="inner-content">
    ...
    <div class="section-content">
        ...
        <div class="section-title py-3 px-2">
            <h4>Draft Job Safety Analysis (JSA)</h4>
        </div><!-- /.section-title -->
                            ...
                            <tbody>
                                @foreach ($this->listings as $itemIndex => $items)
                                    <tr wire:key="row-{{ $items->id }}"
                                        ...
                                        <td class="title">
                                            <a
                                                href="{{ route('document-systems::jsa.detail', ['id' => $items->id, 'type' => 'active-document']) }}" @click.stop>
                                            ...
                                            <b>
                                                <ol>
                                                    @foreach ($items->attachments as $attachment)
                                                        ...
                                                        @endphp
                                                        <li>
                                                            <a href="javascript:void(0)" onclick="event.stopPropagation(); previewBlobFile('{{ $attachment->id }}','{{ $attachment->file_name }}','jsa')" class="d-block" @click.stop>
