                                    ...
                                    <div
                                        ...
                                        @if (!$readonly)
                                            <button class="btn-closed"><img
                                                    src="{{ asset('/images/icons/delete-top.svg') }}"
                        ...
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            ...
                            <div class="button-document" wire:loading.remove wire:target='saveData'>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <button type="button" wire:click="confirmRooting(2)" class="dropdown-item">
                                            @lang('global.save_as_draft')
                                        </button>
                                    </li>
                                    <li>
                                        <button type="button" wire:click.prevent="confirmRooting(1)"
                                            class="dropdown-item">
                                            Submit Document
                                        </button>
                                    </li>
    ...
    <script>
        ...
        window.addEventListener('confirm-rooting-approval', (detail) => {
            ...
            if (parseInt(status) == 1) {
                textConfirm =
                    "Are you sure want to save this document? once saved the document will be active and cannot be edited.";
            } else {
        ...
        function uploadTmpFile(data) {
            $.ajax({
                ...
                url: "{{ route('document-systems::jsa.files') }}",
                data: data,
