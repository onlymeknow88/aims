<div class="inner-content">
    ...
    <div class="header-detail-approval h-60px border d-flex align-items-center px-3">
        <a href="{{ route('document-systems::review') }}" class="d-flex align-items-center gap-3 ">
    ...
    <div class="detail-approval-content d-flex">
        ...
        @include('documentsystem::livewire.review._center-detail')
        @include('documentsystem::livewire.review._right-detail')

    </div>

    <!-- Modal review -->
    <div class="modal fade" wire:ignore.self id="modalReview" tabindex="-1" aria-labelledby="modalReview"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <form action="#">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" wire:click="saveToReturn" class="btn btn-success">Submit this
                            comment</button>
                    </div>
                </form>
            </div>
    ...
    {{-- Modal Approval --}}
    <div class="modal fade" wire:ignore.self id="modalApproved" tabindex="-1" aria-labelledby="modalApproved"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="#">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="button" wire:click="saveToApproved" class="btn btn-success">Submit this
                            comment</button>
                    </div>
                </form>
            </div>
