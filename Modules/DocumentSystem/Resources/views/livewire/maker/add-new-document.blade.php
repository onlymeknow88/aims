            ...
            <div class="col-8">
                ...
                <form wire:submit.prevent='saveData' wire:ignore.self class="form-horizontal">
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 id="module_id" placeholder="Select Module"
                                    wire:model="module_id" error="module_id" data-child="category_id">
                        ...
                        <div class="mb-3 row form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 id="mapping_id" placeholder="Select Mapping"
                                    error="mapping_id" wire:model.defer="mapping_id" :disabled="empty($category_id)">
                    ...
                    <div class="doc-info mb-5">
                        ...
                        <div x-cloak
                            x-show="document_type == {{ \Modules\DocumentSystem\Entities\Document::SOP_DOC_TYPE }} ? true : false"
                            ...
                            <div class="col-sm-8" x-data="{ focus1: false }">
                                @if ($template_form != '')
                                    <div class="input-group" :class="focus1 ? 'input-group-focus' : ''">
                                        <span
                        ...
                        @if ($show_children_form)
                            ...
                            {{-- <div class="mb-3 row form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    </x-document-system-select-2-doctype>
                                </div>

                            </div><!-- /.form-group --> --}}

                            @if ($document_type == \Modules\DocumentSystem\Entities\Document::WIN_DOC_TYPE)
                                <div class="mb-3 row form-group document-number" x-data="{ focus1: false }">
                                    ...
                                    <div class="col-sm-8">
                                        @if ($template_win_number != '')
                                            ...
                                            @enderror
                                        @else
                                            <input type="text" class="form-control" disabled placeholder="Number"
                        ...
                        <div class="mb-3 row form-group document-number {{ $document_type != \Modules\DocumentSystem\Entities\Document::SOP_DOC_TYPE && $document_type != \Modules\DocumentSystem\Entities\Document::WIN_DOC_TYPE && $document_type != \Modules\DocumentSystem\Entities\Document::FORM_DOC_TYPE ? '' : 'd-none' }}"
                            x-data="{ focus1: false }">
                            ...
                            <div class="col-sm-8">
                                <div class="@if ($showDocumentType) input-group @endif"
                                    :class="focus1 ? 'input-group-focus' : ''">
                                    @if ($showDocumentType)
                                        <span
                                    ...
                                    <input type="text"
                                        ...
                                        aria-describedby="basic-addon4" x-ref="input_1" @blur="focus1 = false"
                                        @focus="focus1 = true">
                                </div>
