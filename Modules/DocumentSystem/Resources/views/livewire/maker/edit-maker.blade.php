<div class="inner-content">
    ...
    <div class="header-add-maker h-60px border d-flex gap-2 align-items-center justify-content-between px-3">
        <div class="left-header">
            <a href="{{ route('maker') }}" class="d-flex align-items-center gap-3 ">
                    ...
                    <div class="own-info mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 wire:model="company" id="company"
                                    placeholder="Select Company">

                                    @foreach ($companies as $key => $company)
                                        <option value="{{ $company['id'] }}"
                                            @if ($company['id'] == $company) 'selected' @else not-selected @endif>
                                            {{ $company['name'] }}</option>
                                    @endforeach
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 wire:model="department" id="department"
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2-avatar wire:model="pjSelected" id="pj" name="pj"
                                    class="form-select" placeholder="Select Penanggung Jawab">
                                ...
                                </x-document-system-select-2-avatar>
                    ...
                    <div class="map-info mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 wire:model="module" id="module" class="form-select"
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 wire:model="category" id="category" class="form-select"
                                    placeholder="Select Category Module">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 wire:model="map" id="map" class="form-select"
                    ...
                    <div class="doc-info mb-5">
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <x-document-system-select-2 wire:model="jenis_upload" id="jenis_upload"
                                    class="form-select" placeholder="Select upload metode">
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col-sm-8">
                                <x-document-system-select-2 wire:model="jenis_doc" id="jenis_doc" class="form-select"
                        ...
                        @if ($jenis_doc === 'sop')
                            <div class="mb-3 row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" wire:model="sop_number" class="form-control"
                                        id="sop_number" placeholder="Your ID Document" />
                                </div>
                            ...
                            <div class="mb-3 row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" wire:model="win_number" class="form-control"
                                        id="win_number" placeholder="Your ID Document" />
                                </div>
                            ...
                            <div class="mb-3 row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" wire:model="form_number" class="form-control"
                                        id="form_number" placeholder="Your ID Document" />
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="position-relative input-group">
                                    ...
                                    <input class="form-control" type="email" id="invited_people"
                                        wire:model="inputInvited" wire:keydown.enter.prevent="addInvitedPeople()" />
                                </div>
                            </div>
