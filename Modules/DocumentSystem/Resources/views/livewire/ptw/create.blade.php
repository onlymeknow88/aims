                ...
                <form wire:submit.prevent='saveData' wire:ignore.self class="form-horizontal">
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text wire:model.defer="detail_location" id="detail_location" error="detail_location"
                                    placeholder="{{ trans('global.detail_location') }}"></x-inputs.text>
                            </div>
                    ...
                    <div class="description mb-5">
                        ...
                        <div class="mb-3 row form-group ">
                            ...
                            <div class="col-sm-12">
                                <x-inputs.texteditor wire:model.defer="description" id="description" model="description"
                                    :error="'description'" />
                            </div>
                        ...
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            ...
                            <div class="button-document" wire:loading.remove wire:target='saveData'>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <button type="button" wire:click.prevent="confirmRooting(2)"
                                            class="dropdown-item">
                                            Inactive Document
                                        </button>
                                    </li>
