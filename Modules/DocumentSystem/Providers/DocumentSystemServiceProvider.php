...
namespace Modules\DocumentSystem\Providers;
...
class DocumentSystemServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'DocumentSystem';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'documentsystem';
    ...
    public function boot()
    {
        ...
        Blade::component('document-system-base', Base::class);
        Blade::component('document-system-app', App::class);
        Blade::component('document-system-select-2', Select2::class);
