<div class="inner-content">
    ...
    <div class="header-detail-maker h-60px border d-flex gap-2 align-items-center px-3">
        <a href="/ibpr-and-bowtie/ibpr/active/list"
            class="d-flex align-items-center gap-3">
            <span><i class="fa-solid fa-arrow-left"></i></span>
            <span>IBPR</span>
        </a>
        <a href="/ibpr-and-bowtie/ibpr/active/edit/{{$field->id}}"
            ...
            <div class="section-info py-3 px-2 d-flex flex-column gap-2">
                ...
                <div class="content-section d-flex flex-column gap-1">
                    ...
                    <div class="module-info-items row">
                        ...
                        <div class="col-8">
                            <a href="#" class="" wire:click="goto_list_ibpr">{{count($field->forms)}} IBPR Active Record</a>
                        </div>
                    </div><!-- /.module-info-items -->
            ...
            <div class="footer-action mb-2">
                <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                    <div class="button-document">
                        ...
                        @elseif($field->status === 'Menuggu Persetujuan DH/OHS')
                            <button type="button" wire:click="changeStatus" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4">
                        ...
                        @elseif(
                                ...
                                $field->status == 'Pengajuan Kepada DH/OHS' ||
                                $field->status == 'Diajukan Untuk Persetujuan KTT'
                                )
                                <button @if($loadingButton === true) disabled @endif type="button" onclick="reject()" class="btn btn-outline-danger px-4">
                                    Reject
                                </button>
                                <button @if($loadingButton === true) disabled @endif type="button" wire:click="changeStatus" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4">
                                    {{ $loadingButton ? 'Loading...' : 'Approve' }}
                                </button>
    ...
    <div wire:ignore.self class="modal fade" id="rejectForm" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="rejectFormLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <h5 class="modal-title">Reject IBPR</h5>
                ...
                <div class="modal-footer w-full flex justify-end footer-action">
                    <div>
                      ...
                      <div>
                        <button type="button" wire:click="submit_reject" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4">Submit</button>
                      </div>
                </div>
            </div>
        </div>
