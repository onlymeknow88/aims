...
<div class="inner-content">
    ...
    <div class="header-detail-maker h-60px border d-flex gap-2 align-items-center px-3">
        <div class="left-header">
            <a href="/ibpr-and-bowtie/iadl/active/detail/{{$iadl->id}}" class="d-flex align-items-center gap-3">
            ...
            <div class="col-8">
                ...
                <div class="w-full flex footer-action">
                    ...
                    <div class="w-full flex justify-end gap-2">
                        <a href="/ibpr-and-bowtie/iadl/active/detail/{{$iadl->id}}" class="btn btn-outline-secondary">
                            CANCEL
                        </a>
