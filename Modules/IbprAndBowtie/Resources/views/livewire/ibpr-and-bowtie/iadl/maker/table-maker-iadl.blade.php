...
<div x-data="{ itemSelected: @entangle('itemSelected'), info: @entangle('info') }">
    ...
    <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2 sticky-top">
        ...
        <div class="toolbar-left d-flex align-items-center">
            ...
            {{-- @if($title === 'Active') --}}
            @can('Ibpr And Bowtie - Create IADL')
            <a href="/ibpr-and-bowtie/iadl/create" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3">
            ...
            <table class="table table-document">
                ...
                <tbody>
                    @foreach ($data as $itemIndex => $items)
                        ...
                        <tr>
                            <td class="title"><a href="/ibpr-and-bowtie/iadl/active/detail/{{ $items->id }}" class="text-link">{{$items->document_no}}</a></td>
