<div class="inner-content">
    ...
    <div class="section-content">
        ...
        <div class="section-title py-3 px-2">
            <h4>Bahaya dan Keselamatan</h4>
        </div><!-- /.section-title -->

        <div class="table-maker">


            <livewire:ibprandbowtie::master.bahaya.partials.table-maker />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="FLTypeModalLabel">Bahaya dan Keselamatan</h5>
...
<script>
    window.addEventListener('edit', event => {
        ...
        if (event.detail.id) {
            ...
            @this.set('idBahaya', event.detail.id);
        }
    });
