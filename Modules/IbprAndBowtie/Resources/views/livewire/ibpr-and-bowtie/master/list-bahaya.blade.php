...
<div class="inner-content">
    <div class="section-content">
        <div class="section-title py-3 px-2">
            <h4>Master Keselamatan Bahaya Pertambangan</h4>
        </div><!-- /.section-title -->
            ...
            <div x-data="{ itemSelected: @entangle('itemSelected'), info: @entangle('info') }">
                ...
                <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2 sticky-top">
                    ...
                    <div class="toolbar-left d-flex align-items-center">
                        ...
                        {{-- @if($title === 'Active') --}}
                        <a onclick="openModalMasterBahaya()" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3">
    ...
    <div wire:ignore.self class="modal fade" id="modal_master_bahaya" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal_master_bahayaLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            <div class="modal-title" id="modal_master_bahayaLabel">Keselamatan Bahaya Pertambangan</div>
            ...
            <div class="modal-footer">
                <div class="flex w-full justify-end gap-3">
                    <button onclick="closeModalMasterBahaya()" type="button" class="btn btn-danger">
                        Cancel
                    </button>
...
@push('scripts')
    ...
    <script>
        ...
        function closeModalMasterBahaya() {
            $('#modal_master_bahaya').modal('hide');
        }

        function openModalMasterBahaya() {
            $('#modal_master_bahaya').modal('show');
        }

        Livewire.on('closeModalBahaya', () => {
            closeModalMasterBahaya();
        })

        Livewire.on('openModalBahaya', () => {
            openModalMasterBahaya();
        })
    </script>
@endpush
