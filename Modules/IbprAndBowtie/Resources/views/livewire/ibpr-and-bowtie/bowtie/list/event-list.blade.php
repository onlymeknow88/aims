    ...
    <div class="section-content">
        ...
        <div class="py-3 px-2 flex gap-4">
            <div class="section-title ">
                <p class="text-xl text-black">Bowtie Event List</p>
            </div>
            ...
            <div x-data="{ itemSelected: @entangle('itemSelected'), info: @entangle('info') }">
                ...
                <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2 sticky-top">
                    ...
                    <div class="toolbar-left d-flex align-items-center">
                        <button onclick="tryToOpenModal()" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3">
                            ...
                            <tbody>
                                @if (count($data) > 0)
                                    @foreach ($data as $itemIndex => $item)
                                        <tr>
                                            <td><a href="/ibpr-and-bowtie/bowtie/detail-event/{{ $item->id }}" class="text-link">{{ $item->name }}</a></td>
                                            <td style="min-width: 200px; white-space: normal">
                                                @php echo str_ireplace([';'],['<br />'], $item->description) @endphp
                                            </td>
                                            
                                            <td>
                                                <button type="submit" class="px-3 py-2 bg-green-500 rounded-md text-white duration-300 hover:bg-green-700" onclick="clickEditModalFromList('{{ $item->id }}')">
                                                    Edit
                                                </button>
                                            </td>
                                        </tr>
