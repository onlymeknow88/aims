<div class="inner-content">
    ...
    <div class="section-content">
        ...
        <div class="section-title py-3 px-2">
            <h4>Berita Acara - Coordinator Verification</h4>
        </div><!-- /.section-title -->
                    ...
                    <div class="toolbar-left d-flex align-items-center">
                        ...
                        @if ($countSelected > 0)
                            ...
                            <a href="#" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3" data-bs-toggle="modal" data-bs-target="#submit">
                                <span class="icon d-flex align-items-center"><img src="{{ asset('images/icons/export.png') }}"
                                        alt="image export"></span>
                                <span class="text-button">Mark As Solved</span>
                            </a>
                        @endif
                    </div><!-- /.toolbar-left -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ContractorModallLabel">Mark As Solved</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            Berita Acara akan ditandai Telah Diselesaikan, lanjutkan?
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click="markAsSolved()"
