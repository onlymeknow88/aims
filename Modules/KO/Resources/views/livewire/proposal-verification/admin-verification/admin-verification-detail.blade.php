...
<div class="inner-content">
    ...
    <div class="detail-approval-content d-flex">
        ...
        <div class="section-content w-100 py-3 px-5 d-flex flex-column gap-3">
            ...
            <div class="footer-action mb-2">
                <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                    ...
                    @if($koProposal->status == \App\Enums\KO\KoStatus::AdminProposalVerification()->value)
                        <a href="#" type="button" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4" data-bs-toggle="modal" data-bs-target="#reject">
                            <span class="text-button">Reject</span>
                        </a>

                        <a href="#" type="button" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4" data-bs-toggle="modal" data-bs-target="#verify">
                            <span class="text-button">Verify</span>
                        </a>
                    @endif
        ...
        <div class="modal fade" id="reject" data-bs-backdrop="static" data-bs-keyboard="false"
         tabindex="-1" aria-labelledby="ContractorModallLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="brand" class="col-sm-4 col-form-label">Note</label>
                                <div class="col-sm-12">
                                    <x-inputs.text type="text" wire:model="proposal_reject_note" class="form-control" id="proposal_reject_note" placeholder="" :error="'proposal_reject_note'"></x-inputs.text>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="verify" data-bs-backdrop="static" data-bs-keyboard="false"
         tabindex="-1" aria-labelledby="ContractorModallLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ContractorModallLabel">Verify</h5>
                        <button type="button" class="btn-close" wire:click="closeModal()"
                                data-bs-dismiss="modal"
                                aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                Pilih Tanggal Komisioning
                                <x-inputs.datepicker wire:model="internal_komisioning_schedule" id="internal_komisioning_schedule" :error="'internal_komisioning_schedule'" required></x-inputs.datepicker>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
