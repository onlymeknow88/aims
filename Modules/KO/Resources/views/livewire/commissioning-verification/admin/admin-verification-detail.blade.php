        ...
        <div class="section-content w-100 py-3 px-5 d-flex flex-column gap-3">
            ...
            <div class="footer-action mb-2">
                <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                    ...
                    @if($koProposal->status == \App\Enums\KO\KoStatus::CommissionerCommissioningVerification()->value)
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <x-inputs.text type="text" wire:model="commissioning_reject_note" class="form-control" id="commissioning_reject_note" placeholder="" :error="'commissioning_reject_note'"></x-inputs.text>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                Proposal akan di verify, Lanjutkan?
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
