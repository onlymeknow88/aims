                            ...
                            <tbody>
                                @foreach ($this->koProposals as $itemIndex => $item)
                                    <tr>
                                        @if (in_array('Number', $selectedColumns))
                                            <td scope="row">
                                                <a style="color: green; font-weight: bold" href="{{ route('ko::ko.returned.edit.proposal', $item->id) }}">
                                                    {{ $item->number }}
                                                </a>
                                            </td>
                                        @endif
                                        ...
                                        @if (in_array('Note', $selectedColumns))
                                            <td>{{ $item->proposal_reject_note }}</td>
                                        @endif
                                        ...
                                        <td>{{ $item->admin_proposal_verified == 1 ? 'Coordinator' : 'Admin' }}</td>
