                ...
                <form class="form-horizontal" enctype="multipart/form-data">
                    <div class="own-info mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model.defer="ccow_id" id="ccow_id" placeholder="Select CCOW" :error="'ccow_id'">
                                    @foreach ($ccows as $key => $ccow)
                                        <option value="{{ $ccow->id }}">{{$ccow->company_name}}</option>
                                    @endforeach
                                </x-ko-select-2>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model.defer="area" id="area"
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model="spip_category_id" id="spip_category_id" placeholder="Select Kategori SPIP" data-child="spip_type_id,spip_unit_id,unit_id">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model="spip_type_id" id="spip_type_id" placeholder="Select Klasifikasi SPIP" data-child="spip_unit_id,unit_id" :disabled="empty($spip_category_id)">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model="spip_unit_id" id="spip_unit_id" placeholder="Select Unit SPIP" data-child="unit_id" :disabled="empty($spip_type_id)">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model="unit_id" id="unit_id" placeholder="Select Call Sign" :disabled="empty($spip_unit_id)">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="identity_number" class="form-control" id="identity_number" placeholder="Nomor STNK/IMB" :error="'identity_number'" readonly></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="brand" class="form-control" id="brand" placeholder="Merk / Brand SPIP" :error="'brand'" readonly></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="serial_number" class="form-control" id="serial_number" placeholder="Nomor Serial SPIP" :error="'serial_number'" readonly></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="production_year" class="form-control" id="production_year" placeholder="Tahun Pembuatan Unit SPIP" :error="'production_year'" readonly></x-inputs.text>
                            </div>
                        </div>
                        ...
                        {{--<div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model="usage_purpose" class="form-control" id="usage_purpose" placeholder="Tujuan Penggunaan" :error="'usage_purpose'"></x-inputs.text>
                            </div>
                        </div>--}}
                    </div>
                    ...
                    <div class="own-info mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model="company_id" id="company_id" placeholder="Select Perusahaan" data-child="department_id">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model.defer="department_id" id="department_id" placeholder="Select Department" :disabled="empty($company_id)">
                        ...
                        @if ($department_id === 'other')
                            <div class="mb-3 row form-group required">
                                ...
                                <div class="col-sm-8">
                                    <x-inputs.text type="text" wire:model.defer="other_department" class="form-control" id="other_department" placeholder="Other Department" :error="'other_department'"></x-inputs.text>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="applicant_email" class="form-control" id="applicant_email" placeholder="Alamat Email Pemohon" :error="'applicant_email'"></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-ko-select-2 wire:model.defer="pjo_id" id="pjo_id" placeholder="Select PJO">
