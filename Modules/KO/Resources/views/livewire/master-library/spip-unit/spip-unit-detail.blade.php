                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <x-ko-select-2-multiple wire:model.defer="attachment_fields" id="attachment_fields" name="attachment_fields[]" class="form-select" placeholder="">
                                    <option value="stnk">Fotokopi STNK</option>
                                    <option value="nota_pajak">Copy Nota Pajak</option>
                                    <option value="surat_pengantar">Surat Pengantar</option>
                                    <option value="re_manufacture">Bukti Service/Re-Manufacture</option>
                                    <option value="oem">Data Pemeriksaan (OEM)</option>
                                    <option value="dokumen_sertifikat">Dokumen Sertifikat ROPs / FOPs</option>
                                    <option value="inspeksi_p3k">Hasil Inspeksi Kotak P3K</option>
                                    <option value="kir">Copy KIR Aktif</option>
                                    <option value="uji_pjit">Riksa Uji PJIT</option>
                                    <option value="pra_komisioning">Pra Komisioning</option>
                                    <option value="setting_radio">Bukti Setting Radio</option>
                                    <option value="slo">SLO/Sertifikan Distributor</option>
                                    <option value="komisioning_internal">Bukti Commissioning Internal</option>
