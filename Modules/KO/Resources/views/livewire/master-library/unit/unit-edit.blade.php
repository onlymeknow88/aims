                ...
                <form class="form-horizontal" enctype="multipart/form-data">
                    <div class="own-info mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="call_sign" class="form-control" id="call_sign" placeholder="Call Sign" :error="'call_sign'"></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="identity_number" class="form-control" id="identity_number" placeholder="Nomor STNK/IMB" :error="'identity_number'"></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="serial_number" class="form-control" id="serial_number" placeholder="Nomor Serial SPIP" :error="'serial_number'"></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="text" wire:model.defer="model_unit" class="form-control" id="model_unit" placeholder="Model Unit" :error="'model_unit'"></x-inputs.text>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-inputs.text type="number" wire:model.defer="production_year" class="form-control" id="production_year" min="1900" max="2099" step="1" placeholder="Tahun Pembuatan Unit SPIP" :error="'production_year'"></x-inputs.text>
                            </div>
                        </div>
                    </div>
