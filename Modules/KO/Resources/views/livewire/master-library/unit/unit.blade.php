            ...
            <div x-data="{ itemSelected: @entangle('itemSelected'), info: @entangle('info') }">
                ...
                <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2">
                    ...
                    <div class="toolbar-left d-flex align-items-center">
                        <a href="{{ route('ko::master-library.unit.create') }}" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3 add-new">
                        ...
                        @if ($countSelected > 0)
                            ...
                            <a href="#" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3" data-bs-toggle="modal" data-bs-target="#revoke">
                                <span class="icon d-flex align-items-center"><img src="{{ asset('images/icons/export.png') }}"
                                        alt="image export"></span>
                                <span class="text-button">Demob</span>
                            </a>
                        @endif
                    </div><!-- /.toolbar-left -->
                                                    ...
                                                    <div class="dropdown-content p-3 d-flex gap-3 flex-column">
                                                        ...
                                                        <div class="pilih-all d-flex gap-2">
                                                            <a href="#" class="fw-normal text-green"
                                                                wire:click="removeItemFilter('searchCallSign')">
                                                                Hapus Filter
                                                            </a>
                                                        </div>
                                                ...
                                                <span>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" wire:ignore.self>
                                                        ...
                                                        <div class="dropdown-content p-3 d-flex gap-3 flex-column">
                                                            ...
                                                            <div class="pilih-all d-flex gap-2">
                                                                <a href="#" class="fw-normal text-green"
                                                                    x-on:click="selectAllCheckboxes('ko_spip_unit_id')"
                                                                    wire:click="removeItemFilter('ko_spip_unit_id')">
                                                                    Hapus Filter
                                                                </a>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                @foreach ($fieldKoSpipUnit as $index => $item)
                                                                    <div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label fw-normal"
                                                                            for="ko_spip_unit_id">{{ $item->name }}</label>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                        </div>
                                                ...
                                                <span>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" wire:ignore.self>
                                                        ...
                                                        <div class="dropdown-content p-3 d-flex gap-3 flex-column">
                                                            ...
                                                            <div class="pilih-all d-flex gap-2">
                                                                <a href="#" class="fw-normal text-green"
                                                                    wire:click="removeItemFilter('searchIdentityNumber')">
                                                                    Hapus Filter
                                                                </a>
                                                            </div>
                                                ...
                                                <span>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" wire:ignore.self>
                                                        ...
                                                        <div class="dropdown-content p-3 d-flex gap-3 flex-column">
                                                            ...
                                                            <div class="pilih-all d-flex gap-2">
                                                                <a href="#" class="fw-normal text-green"
                                                                    wire:click="removeItemFilter('searchSerialNumber')">
                                                                    Hapus Filter
                                                                </a>
                                                            </div>
                            ...
                            <tbody>
                                @foreach ($this->units as $itemIndex => $item)
                                    ...
                                    >
                                        ...
                                        <td>
                                            @if($item->is_revoked == 1)
                                                Demobilized
                                            @else
                                                @if($item->revoke_requested_date != null)
                                                    Request Demob
                                                @else
                                                    Active
                                                @endif
                                        ...
                                        <td>
                                            <a href="{{ route('ko::master-library.unit.edit', $item->id) }}" class="action-icon m-1">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ContractorModallLabel">Request Demob</h5>
