...
class AdminRevokeRequest extends Component
{
    use LivewireAlert;
    ...
    public function getUnitsProperty(): LengthAwarePaginator
    {
        ...
        return UnitModel::whereNotNull('revoke_requested_date')
            ->where('revoke_status', UnitRevokeStatus::AdminVerification()->value)
    ...
    public function revoke()
    {
        try {
            ...
            $units = UnitModel::whereIn('id', $this->itemSelected)->update([
                'revoke_status' => UnitRevokeStatus::CoordinatorVerification()->value
            ]);
    ...
    {
        return view('ko::livewire.revoke-request.admin-revoke-request')->layout('ko::layouts.app');
    }
}
