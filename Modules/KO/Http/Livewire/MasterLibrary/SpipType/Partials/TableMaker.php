...
namespace Modules\KO\Http\Livewire\MasterLibrary\SpipType\Partials;
...
class TableMaker extends Component
{
    ...
    public function getSpipTypesProperty()
    {
        return KoSpipType::all();
    }
    ...
    {
        return view('ko::livewire.master-library.spip-type.partials.table-maker');
    }
}
