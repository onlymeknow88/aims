...
namespace Modules\KO\Http\Livewire\MasterLibrary\SpipCategory\Partials;
...
class TableMaker extends Component
{
    ...
    public function getSpipCategoriesProperty()
    {
        return KoSpipCategory::all();
    }
    ...
    {
        return view('ko::livewire.master-library.spip-category.partials.table-maker');
    }
}
