...
class KoReturned extends Component
{
    public $limit;
    public $countData;
    ...
    public $columns = ['Number', 'CCOW', 'Perusahaan', 'Kriteria Perusahaan', 'Area', 'Waktu Komisioning', 'Jadwal Komisioning', 'Komisioning Selanjutnya', 'Periode', 'SPIP Desc', 'Call Sign', 'Note', 'Status'];
    ...
    {
        return view('ko::livewire.ko.returned.ko-returned')->layout('ko::layouts.app');
    }
}
