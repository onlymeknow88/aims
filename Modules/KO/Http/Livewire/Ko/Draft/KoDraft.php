...
namespace Modules\KO\Http\Livewire\Ko\Draft;
...
class KoDraft extends Component
{
    public $limit;
    public $countData;
    ...
    public function getKoProposalsProperty(): LengthAwarePaginator
    {
        ...
        return KoProposal::query()
            ...
            ->where('status', KoStatus::Draft()->value)
    ...
    {
        return view('ko::livewire.ko.draft.ko-draft')->layout('ko::layouts.app');
    }
}
