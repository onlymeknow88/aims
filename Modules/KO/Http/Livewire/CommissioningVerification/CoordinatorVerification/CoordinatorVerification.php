...
class CoordinatorVerification extends Component
{
    ...
    public function getKoProposalsProperty(): LengthAwarePaginator
    {
        ...
        return KoProposal::query()
            ->where('status', KoStatus::CoordinatorCommissioningVerification()->value)
    ...
    {
        return view('ko::livewire.commissioning-verification.coordinator.coordinator-verification')->layout('ko::layouts.app');
    }
}
