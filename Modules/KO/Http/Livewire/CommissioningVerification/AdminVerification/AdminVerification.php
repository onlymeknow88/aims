...
class AdminVerification extends Component
{
    ...
    public function getKoProposalsProperty(): LengthAwarePaginator
    {
        ...
        return KoProposal::query()
            ->where('status', KoStatus::CommissionerCommissioningVerification()->value)
    ...
    {
        return view('ko::livewire.commissioning-verification.admin.admin-verification')->layout('ko::layouts.app');
    }
}
