...
class Commissioned extends Component
{
    public $limit;
    public $countData;
    ...
    public function getKoProposalsProperty(): LengthAwarePaginator
    {
        ...
        return KoProposal::query()
            ->whereIn('status', [KoStatus::Issue()->value, KoStatus::CommissionerCommissioningVerification()->value, KoStatus::CoordinatorCommissioningVerification()->value, KoStatus::CommissioningReturned()->value, KoStatus::Completed()->value])
    ...
    public function generateQR()
    {
        ...
        $customPaper = array(0,0,376.40,267.75);
    ...
    {
        return view('ko::livewire.commissioning.commissioned')->layout('ko::layouts.app');
    }
}
