...
class ReturnedCommissioning extends Component
{
    public $limit;
    public $countData;
    ...
    public function getKoProposalsProperty(): LengthAwarePaginator
    {
        ...
        return KoProposal::query()
            ->where('status', KoStatus::CommissioningReturned()->value)
    ...
    {
        return view('ko::livewire.commissioning.returned-commissioning')->layout('ko::layouts.app');
    }
}
