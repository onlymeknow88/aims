            ...
            <div class="col-3 justify-content-end">
                <div class="profile-menu dropdown d-flex justify-content-end align-items-center">
                    ...
                    <ul class="dropdown-menu">
                        <a href="{{ route('mcu::logout') }}" class="dropdown-item">Logout</a>
                    </ul>
                </div>
            </div>
        </div><!-- /.right-header -->
                    ...
                    <div class="position-sticky top-0 bg-white pb-4">
                        ...
                        <div class="info-item py-3 px-4 border-bottom border-1">
                            <div class="ttl d-flex flex-column">
                                <h6>Tanggal Lahir</h6>
                                <div class="item-content d-flex gap-1 align-items-center">
                                    <span class="opacity-80">{{ $employee_birthdate }} ({{ $employee_age }}
                                        Tahun)</span>
                                </div>
                            </div><!-- /.ttl -->
                        </div><!-- /.info-items -->
                ...
                <div class="col pb-7 border-end border-start border-1">
                        ...
                        <div id="virus" class="section-virus border-1 border-bottom p-5">
                            ...
                            <div
                                ...
                                <div class="content-section m-4">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">READING TEST / Visus Dekat / Jaeger
                                            Test</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="content-section m-4">
                                        <div class="inner-section mb-5">
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                ...
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_air_conduction_1000'] }}
                                                </div>
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                ...
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_air_conduction_2000'] }}
                                                </div>
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                ...
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_air_conduction_3000'] }}
                                                </div>
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                ...
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_air_conduction_4000'] }}
                                                </div>
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                ...
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_air_conduction_6000'] }}
                                                </div>
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                ...
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_air_conduction_8000'] }}
                                                </div>
                                        ...
                                        <div class="inner-section mb-5">
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">500</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_500'] }}
                                                </div>
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">1000</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_1000'] }}
                                                </div>
                                                <div class="col-2">
                                                    {{ $data['audiometry_left_bone_conduction_1000'] }}
                                                </div>
                                            </div><!-- Visus 1000 -->
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">2000</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_2000'] }}
                                                </div>
                                                <div class="col-2">
                                                    {{ $data['audiometry_left_bone_conduction_2000'] }}
                                                </div>
                                            </div><!-- Visus 2000 -->
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">3000</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_3000'] }}
                                                </div>
                                                <div class="col-2">
                                                    {{ $data['audiometry_left_bone_conduction_3000'] }}
                                                </div>
                                            </div><!-- Visus 3000 -->
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">4000</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_4000'] }}
                                                </div>
                                                <div class="col-2">
                                                    {{ $data['audiometry_left_bone_conduction_4000'] }}
                                                </div>
                                            </div><!-- Visus 4000 -->
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">6000</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_6000'] }}
                                                </div>
                                                <div class="col-2">
                                                    {{ $data['audiometry_left_bone_conduction_6000'] }}
                                                </div>
                                            </div><!-- Visus 6000 -->
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">8000</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_8000'] }}
                                                </div>
                                                <div class="col-2">
                                                    {{ $data['audiometry_left_bone_conduction_8000'] }}
                                                </div>
                                            </div><!-- Visus 8000 -->
                                            ...
                                            <div class="mb-3 mcu-detail-item row">
                                                <label class="col-6 opacity-50">HTL</label>
                                                <div class="col-2">
                                                    {{ $data['audiometry_right_bone_conduction_htl'] }}
                                                </div>
                                                <div class="col-2">
                                                    {{ $data['audiometry_left_bone_conduction_htl'] }}
                                                </div>
                                            </div><!-- Visus HTL -->
                            ...
                            <div class="content-section m-4">
                                ...
                                <div class="inner-section mb-5">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        ...
                                        <div class="col-6 content-mcu-detail">
                                            <div class="content">{{ $data['jakarta_cardiovascular_risk_level'] }}
                                            </div>
                                        </div>
                                ...
                                <div class="inner-section mb-5">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        ...
                                        <div class="col-6 content-mcu-detail">
                                            <div class="content">{{ $data['laboratory_urinalysis_billirubin'] }}
                                            </div>
                                        </div>
                                ...
                                <div class="inner-section mb-5">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        ...
                                        <div class="col-6 content-mcu-detail">
                                            <div class="content">
                                                {{ $data['laboratory_urinalysis_leukocyte_sediment'] }}
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Eritrosit</label>
                                        <div class="col-6 content-mcu-detail">
                                            <div class="content">{{ $data['laboratory_urinalysis_erythrocyte'] }}
                                            </div>
                                        </div>
                                    </div><!-- /.mcu-detail-item Eritrosit -->
                    ...
                    <div id="temuan" class="section-temuan border-1 border-bottom p-5">
                        ...
                        <div
                            ...
                            <div class="content-section m-4">
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Hasil Temuan</label>
                                    <div class="col-6 content-mcu-detail">
                                        @if ($data['findings'])
                                            ...
                                            @if (array_key_exists('diastolic_blood_pressure', $data['findings']))
                                                <div class="content">
                                                    {{ $data['findings']['diastolic_blood_pressure'] }}
                                                </div>
                                            @endif
            ...
            @else
                <div class="detail-left col-3">
                    ...
                    <div class="position-sticky top-0 bg-white pb-4">
                        ...
                        <div class="info-item py-3 px-4 border-bottom border-1" x-data="{ dataOpen: false, dataClose: true }">
                            ...
                            <div x-cloak
                                ...
                                <a>
                                    <div
                                        class="history-rekam-medis-item border-1 border-bottom p-4 d-flex flex-column gap-2">
                                        <div class="header-history fw-semibold">-</div>
                                        <div class="content-history">-</div>
                                        <div class="date opacity-50">-</div>
                                    </div><!-- /.history-rekam-medis-item -->
                                </a>
                        ...
                        $employee_age = $employee ? \Carbon\Carbon::parse($employee->birth_date)->age : null;
                        ?>
                        ...
                        <div class="info-item py-3 px-4 border-bottom border-1">
                            <div class="nip d-flex flex-column">
                                ...
                                <div class="item-content d-flex gap-1 align-items-center">
                                    <span
                                        class="opacity-80">{{ $employee ? ($employee->company_id ? $employee->company_id . '/' : '') : '' }}{{ $employee ? $employee->id_number : '' }}</span>
                                </div>
                            </div><!-- /.nip -->
                        </div><!-- /.info-items -->
                        ...
                        <div class="info-item py-3 px-4 border-bottom border-1">
                            <div class="ttl d-flex flex-column">
                                ...
                                <div class="item-content d-flex gap-1 align-items-center">
                                    <span
                                        class="opacity-80">{{ $employee ? ($employee_age ? $employee->date_of_birth : '-') : '-' }}</span>
                                </div>
                            </div><!-- /.ttl -->
                        </div><!-- /.info-items -->
                        <div class="info-item py-3 px-4 border-bottom border-1">
                ...
                <div class="col pb-7 border-end border-start border-1">
                    ...
                    <div id="karyawan" class="section-karyawan border-1 border-bottom p-5">
                        <div class="header-section d-flex justify-content-between w-100 border-0 bg-white my-3 mx-4">
                            <h6 class="mb-0 fw-normal">Data MCU Tidak Ditemukan</h6>
                        </div>
