                        ...
                        <div class="content-section p-4" wire:ignore.self>
                            ...
                            <div class="mb-5 row form-group">
                                ...
                                <div class="col-8">
                                    <x-inputs.textarea wire:model="employeeAddress" id="employeeAddress"
                                        rows="5" placeholder="Alamat Lengkap" :error="'employeeAddress'" disabled />
                                </div>
                            </div><!-- /.form-group jk -->
                            ...
                            <div class="mb-5 row form-group required">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    @if ($file_status)
                                        <a style="color: rgb(0, 60, 255)"><small>{{ $file_exist }}</small></a>
                                        {{-- @else
                                        @if ($file)
                            ...
                            <div class="content-section p-4">
                                ...
                                @if ($medical_ex_type == 'food-handler')
                                    ...
                                    <div class="mb-3 row form-group required">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.text wire:model="vaccination_hep_a1"
                                                id="vaccination_hep_a1" placeholder=""
                                    ...
                                    <div class="mb-3 row form-group required">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.datepicker wire:model="vaccination_hep_a2"
                                                id="vaccination_hep_a2" placeholder=""
                                    ...
                                    <div class="mb-3 row form-group required">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.datepicker wire:model="vaccination_hep_a3"
                                                id="vaccination_hep_a3" placeholder=""
                                    ...
                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_typhoid_1" class="col col-form-label">Typhoid -
                                            1st</label>
                                        <div class="col-8">
                                            <x-inputs.datepicker wire:model="vaccination_typhoid_1"
                                                id="vaccination_typhoid_1" placeholder=""
                                    ...
                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_typhoid_3" class="col col-form-label">Typhoid - 3
                                            years</label>
                                        <div class="col-8">
                                            <x-inputs.datepicker wire:model="vaccination_typhoid_3"
                                                id="vaccination_typhoid_3" placeholder=""
                                    ...
                                    <div class="mb-3 row form-group required">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.datepicker wire:model="vaccination_albendandazole"
                                                id="vaccination_albendandazole" placeholder=""
