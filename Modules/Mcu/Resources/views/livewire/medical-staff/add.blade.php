<div class="inner-content">
    ...
    <div
        ...
        <div class="left-header">
            <a href="{{ route('mcu::medical-staff') }}" class="d-flex align-items-center gap-3">
                <span><i class="fa-solid fa-arrow-left"></i></span>
                <span>Tambah Data MCU</span>
            </a>
        </div><!-- /.left-header -->
    ...
    <div class="mcu-form-content d-flex">
                        ...
                        <div class="pt d-flex flex-column gap-2">
                            ...
                            <div class="item-content d-flex gap-2 align-items-start">
                                ...
                                <div class="position-name d-flex flex-column">
                                    ...
                                    <span>{{ $staff->position ? $staff->position : '-' }}</span>
                                </div>
                            </div>
                            <div class="item-content d-flex gap-2 align-items-start">
                                <div class="thumb">
                                ...
                                <div class="department-name d-flex flex-column">
                                    ...
                                    <span>{{ $staff->user->department ? $staff->user->department->name : '-' }}</span>
        ...
        <div class="col p-4">
            <form wire:submit.prevent="save">
                    ...
                    <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                        ...
                        <div class="content-section p-4" wire:ignore.self>
                            ...
                            <div class="mb-3 row form-group required">
                                <label for="medical_ex_type" class="col col-form-label"><small>Item Pemeriksaan
                                        Kesehatan</small></label>
                                <div class="col-8">
                                    <select wire:model="medical_ex_type" id="medical_ex_type" class="form-select"
                                        placeholder="Select Item" value='{{ $medical_ex_type }}'>
                                        <option hidden>Pilih Item</option>
                            ...
                            <div class="mb-3 row form-group required">
                                <label for="employeeIdNumber" class="col col-form-label">NIK (Nomor KTP)</label>
                                <div class="col-8">
                                    <input type="text" class="form-control" wire:model="employeeIdNumber"
                                        wire:keyup="checkIdNumber" />
                                    @error('employeeIdNumber')
                                        <small style="color: red">
                                            {{ $message }}
                                        </small>
                                    @enderror
                            ...
                            <div class="mb-3 row form-group required">
                                <label for="employeeEmail" class="col col-form-label">Email Karyawan</label>
                                <div class="col-8">
                                    <input type="email" wire:model="employeeEmail" class="form-control"
                                        {{ $formEmployee }} />
                                    @error('employeeEmail')
                                        <small style="color: red">
                                            {{ $message }}
                            ...
                            <div class="mb-3 row form-group required">
                                <label for="employeeName" class="col col-form-label">Nama Karyawan</label>
                                <div class="col-8">
                                    <input type="text" wire:model="employeeName" class="form-control"
                                        value="{{ $employeeName }}" {{ $formEmployee }} />
                                    @error('employeeName')
                                        <small style="color: red">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="mb-3 row form-group required">
                                <label for="employeeDepartment" class="col col-form-label">Departemen</label>
                                <div class="col-8">
                                    <x-inputs.select2 wire:model="employeeDepartment" id="employeeDepartment"
                                        {{-- <x-inputs.select2 wire:model="employeeDepartment" id="employeeDepartment" --}} class="form-select" placeholder="Select Department"
                                        formEmployee="{{ $formEmployee }}">
                                        @foreach ($department as $d)
                                            <option value="{{ $d->id }}">
                                                {{ $d->name }} - {{ $d->company->company_name }}
                                            </option>
                                        @endforeach
                                    </x-inputs.select2>
                            ...
                            <div class="mb-3 row form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" wire:model="employeePosition" class="form-control"
                                        value="{{ $employeePosition }}" {{ $formEmployee }} />
                                </div>
                            </div><!-- /.form-group position -->

                            @if ($medical_type && $medical_type != 'pre-employment')
                                <div class="mb-3 row form-group">
                                    <label for="employeeNip" class="col col-form-label">NIP</label>
                                    <div class="col-8">
                                        <input type="text" wire:model="employeeNip" class="form-control"
                                            value="{{ $employeeNip }}" {{ $formEmployee }} />
                                    </div>
                                </div><!-- /.form-group nip -->
                            @endif
                            ...
                            <div class="mb-3 row form-group required">
                                ...
                                <div class="col-4">
                                    <x-inputs.datepicker-mcu wire:model="employeeBirthdate" id="employeeBirthdate"
                                        placeholder="Pilih Tanggal" :error="'employeeBirthdate'"
                                        formEmployee="{{ $formEmployee }}" />
                                ...
                                <div class="col-4 input-group w-33">
                                    <input type="text" class="form-control" value="{{ $employeeAge }}"
                                        disabled />
                            ...
                            <div class="mb-3 row form-group required">
                                ...
                                <div class="col-8">
                                    <select wire:model="employeeGender" id="employeeGender" class="form-select"
                                        placeholder="Pilih Jenis Kelamin" {{ $formEmployee }}>
                                        <option hidden>Pilih Item</option>
                            ...
                            <div class="mb-5 row form-group">
                                <label for="employeeAddress" class="col col-form-label">Alamat</label>
                                <div class="col-8">
                                    <x-inputs.textarea wire:model="employeeAddress" id="employeeAddress"
                                        rows="5" placeholder="Alamat Lengkap" :error="'employeeAddress'" />
                                </div>
                            </div><!-- /.form-group jk -->
                            ...
                            <div class="mb-5 row form-group required">
                                <label for="mcu_date" class="col-sm-4 col-form-label">Attachment</label>
                                <div class="col-sm-8">
                                    <input type="file" wire:model="file" id="file" class="form-control">
                                    {{-- <a style="color: rgb(0, 60, 255)" href="{{ URL::to('/') }}">{{ $file }}</a> --}}
                                    @if ($file_status)
                                        <a style="color: rgb(0, 60, 255)">{{ $file }}</a>
                                        {{-- @else
                                        @if ($file)
                                            <a style="color: rgb(0, 60, 255)">Ok</a>
                                        @endif --}}
                                    @endif
                ...
                @if ($employeeIdNumber && $employeeGender && $employeeBirthdate)
                    ...
                    <div id="anamnesis" class="section-anamnesis" x-data="{ accordionOpen: true }">
                        ...
                        <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                            ...
                            <div class="content-section p-4">
                                ...
                                <div class="mb-3 row form-group required">
                                    <label for="previous_disease_history" class="col-sm-4 col-form-label">Riwayat
                                        Penyakit
                                        Dahulu</label>
                                    <div class="col-sm-8">
                                        <x-inputs.text wire:model="previous_disease_history"
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-sm-8 @error('family_disease_history') is-invalid @enderror">
                                        <x-inputs.select2_multiple wire:model="family_disease_history"
                                            ...
                                            <option
                                                value="{{ App\Enums\MCU\FamilyDiseaseHistory::Tidak_Ada()->value }}">
                                                {{ App\Enums\MCU\FamilyDiseaseHistory::Tidak_Ada()->description }}
                                            </option>
                                            <option
                                                value="{{ App\Enums\MCU\FamilyDiseaseHistory::Jantung()->value }}">
                                                {{ App\Enums\MCU\FamilyDiseaseHistory::Jantung()->description }}
                                            </option>
                                            <option
                                                value="{{ App\Enums\MCU\FamilyDiseaseHistory::Diabetes()->value }}">
                                ...
                                <div class="mb-3 row form-group required">
                                    ...
                                    <div class="col-8">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="smoking-1">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input wire:model="smoking"
                                                class="form-check-input @error('smoking') is-invalid @enderror"
                                                type="radio" id="smoking-2" value="no">
                                            <label class="form-check-label" for="smoking-2">Tidak</label>
                                        </div>
                                    </div>
                                ...
                                @if ($smoking == 'yes')
                                    <div class="mb-3 row form-group">
                                        ...
                                        <div class="col-8 input-group">
                                            <x-inputs.text wire:model="smoking_per_day" id="smoking_per_day"
                                                placeholder="0" value="0" :error="'smoking_per_day'" />
                                ...
                                @if ($employeeGender == 'female')
                                    {{-- <h6 class="fw-normal mb-3 mt-3">Menstruasi</h6> --}}

                                    <div class="mb-3 mt-5 row form-group">
                                        <label for="menstrual_menarche" class="col">Kondisi
                                            menstruasi</label>
                                        <div class="col-8">
                                            <x-inputs.text wire:model="menstrual_menarche" id="menstrual_menarche"
                                                placeholder="" :error="'menstrual_menarche'" />
                                        </div>
                                    ...
                                    <div class="mb-3 row form-group">
                                        ...
                                        <div class="col-8 input-group">
                                            <x-inputs.number step=".01" wire:model="menstrual_period"
                                                id="menstrual_period" placeholder="0" value="0"
                                    ...
                                    <div class="mb-3 mt-5 row form-group">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.number step=".01" wire:model="pregnant_period"
                                                id="pregnant_period" placeholder="0" value="0"
                                                :error="'pregnant_period'" />
                                        </div>
                                    ...
                                    <div class="mb-3 row form-group">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.number step=".01" wire:model="pregnant_spontan"
                                                id="pregnant_spontan" placeholder="0" value="0"
                                                :error="'pregnant_spontan'" />
                                        </div>
                                    ...
                                    <div class="mb-3 row form-group">
                                        <label for="pregnant_surgery" class="col">Bantuan /
                                            Operasi</label>
                                        <div class="col-8">
                                            <x-inputs.number step=".01" wire:model="pregnant_surgery"
                                                id="pregnant_surgery" placeholder="0" value="0"
                                                :error="'pregnant_surgery'" />
                                        </div>
                                    ...
                                    <div class="mb-3 row form-group">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.number step=".01" wire:model="pregnant_abortion"
                                                id="pregnant_abortion" placeholder="0" value="0"
                                                :error="'pregnant_abortion'" />
                                        </div>
                                    ...
                                    <div class="mb-3 row form-group">
                                        ...
                                        <div class="col-8">
                                            <div class="form-check form-check-inline">
                                                <input wire:model="contraception" class="form-check-input"
                                                    type="radio" name="contraception" id="contraception-1"
                                                    value="yes">
                                                <label class="form-check-label" for="contraception-1">Ya</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input wire:model="contraception" class="form-check-input"
                                                    type="radio" name="contraception" id="contraception-2"
                                                    value="no">
                                    ...
                                    @if ($contraception == 'yes')
                                        <div class="mb-3 row form-group">
                                            <label for="contraception_type" class="col"></label>
                                            <div class="col-8">
                                                <x-inputs.textarea wire:model="contraception_type"
                                                    id="contraception_type" placeholder="Tipe Kontrasepsi"
                                                    :error="'contraception_type'" />
                                            </div>
                                ...
                                @if ($medical_ex_type == 'food-handler')
                                    ...
                                    {{-- Tanggal --}}
                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_hep_a1" class="col col-form-label">Hep A - 1st</label>
                                        <div class="col-8">
                                            <x-inputs.text wire:model="vaccination_hep_a1"
                                                id="vaccination_hep_a1" placeholder="Pilih Tanggal"
                                                :error="'vaccination_hep_a1'" />
                                        </div>
                                    </div><!-- /.form-group vaccination_hep_a1 -->

                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_hep_a2" class="col col-form-label">Hep A - 2nd</label>
                                        <div class="col-8">
                                            <x-inputs.text wire:model="vaccination_hep_a2"
                                                id="vaccination_hep_a2" placeholder="Pilih Tanggal"
                                                :error="'vaccination_hep_a2'" />
                                        </div>
                                    </div><!-- /.form-group vaccination_hep_a2 -->

                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_hep_a3" class="col col-form-label">Hep A - 3 years</label>
                                        <div class="col-8">
                                            <x-inputs.text wire:model="vaccination_hep_a3"
                                                id="vaccination_hep_a3" placeholder="Pilih Tanggal"
                                                :error="'vaccination_hep_a3'" />
                                        </div>
                                    </div><!-- /.form-group vaccination_hep_a3 -->

                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_typhoid_1" class="col col-form-label">Typhoid -
                                            1st</label>
                                        <div class="col-8">
                                            <x-inputs.text wire:model="vaccination_typhoid_1"
                                                id="vaccination_typhoid_1" placeholder="Pilih Tanggal"
                                                :error="'vaccination_typhoid_1'" />
                                        </div>
                                    </div><!-- /.form-group vaccination_typhoid_1 -->

                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_typhoid_3" class="col col-form-label">Typhoid - 3
                                            years</label>
                                        <div class="col-8">
                                            <x-inputs.text wire:model="vaccination_typhoid_3"
                                                id="vaccination_typhoid_3" placeholder="Pilih Tanggal"
                                                :error="'vaccination_typhoid_3'" />
                                        </div>
                                    </div><!-- /.form-group vaccination_typhoid_3 -->

                                    <div class="mb-3 row form-group required">
                                        <label for="vaccination_albendandazole" class="col col-form-label">Albendandazole
                                            400mg</label>
                                        <div class="col-8">
                                            <x-inputs.text wire:model="vaccination_albendandazole"
                            ...
                            <div class="content-section p-4">
                                ...
                                <div class="mb-3 row form-group required">
                                    <label for="tinggi" class="col col-form-label">Tanda-tanda vital dan
                                        antropometry</label>
                                    <div class="col-4 input-group w-33">
                                        <x-inputs.number wire:model="height" id="height"
                                            placeholder="Masukkan tinggi" value="0" :error="'height'" />
                                        <span class="input-group-text" id="addons-tinggi">/cm</span>
                                    </div>
                                    <div class="col-4 input-group w-33">
                                        <x-inputs.number wire:model="weight" id="weight"
                                            placeholder="Masukkan berat badan" value="0" :error="'weight'" />
                                ...
                                <div class="mb-3 row form-group">
                                    <label for="name" class="col d-flex flex-column">
                                        ...
                                        <span class="opacity-90 lh-sm">Auto calculation
                                            <span class="icon-tooltip" x-data="{ tooltip: false }"
                                                x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false">
                                                <i class="fa-solid fa-circle-question pt-2 text-info"></i>
                                                <div class="tooltip-content" x-show="tooltip">Additional Diagnosis
                                                    Tooltip</div>
                                            </span></span>
                                    </label>
                                    <div class="col-8 input-group">
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8">
                                        <x-inputs.text wire:model="bmi_lower" id="bmi_lower"
                                            placeholder="Show Result" :error="'bmi_lower'" value="{{ $bmi_lower }}"
                                            disabled />
                                    </div>
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8">
                                        <x-inputs.text wire:model="bmi_upper" id="bmi_upper"
                                            placeholder="Show Result" :error="'bmi_upper'" value="{{ $bmi_upper }}"
                                            disabled />
                                    </div>
                                </div><!-- /.form-group bb_tertinggi -->

                                <div class="mb-3 row form-group required">
                                    <label for="systolic_blood_pressure" class="col col-form-label">Tekanan Darah
                                        Sistolik</label>
                                    <div class="col-8 input-group">
                                        <x-inputs.number step=".01" wire:model="systolic_blood_pressure"
                                            id="systolic_blood_pressure" placeholder="Masukkan tinggi" value="0"
                                ...
                                <div class="mb-3 row form-group required">
                                    <label for="diastolic_blood_pressure" class="col col-form-label">Tekanan Darah
                                        Diastolik</label>
                                    <div class="col-8 input-group">
                                        <x-inputs.number step=".01" wire:model="diastolic_blood_pressure"
                                            id="diastolic_blood_pressure" placeholder="Masukkan tinggi"
                                            value="0" :error="'diastolic_blood_pressure'" />
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8 input-group">
                                        <x-inputs.number step=".01" wire:model="arteries" id="arteries"
                                ...
                                <div class="mb-3 row form-group">
                                    <label for="rr" class="col d-flex flex-column col-form-label">Respiratory
                                        Rate</label>
                                    <div class="col-8 input-group">
                                        <x-inputs.number step=".01" wire:model="rr" id="rr"
                                            placeholder="Masukkan tinggi" value="0" :error="'rr'" />
                                ...
                                <div class="mb-3 row form-group">
                                    <label for="body_temperature" class="col d-flex flex-column col-form-label">Suhu
                                        Tubuh</label>
                                    <div class="col-8 input-group">
                                        <x-inputs.number step=".01" wire:model="body_temperature"
                                            id="body_temperature" placeholder="Masukkan tinggi" value="0"
                        ...
                        <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                            ...
                            <div class="content-section p-4">
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8">
                                        <x-inputs.text wire:model="heent" id="heent" rows="7"
                                            placeholder="" :error="'heent'" />
                                    </div>
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8">
                                        <x-inputs.text wire:model="orodental_caries" id="orodental_caries"
                                            rows="7" placeholder="" :error="'orodental_caries'" />
                                    </div>
                                ...
                                <div class="mb-3 row form-group">
                                    <label for="orodental_gangren_radix" class="col col-form-label">ORODENTAL GANGREN
                                        RADIX</label>
                                    <div class="col-8">
                                        <x-inputs.text wire:model="orodental_gangren_radix"
                                            id="orodental_gangren_radix" rows="7" placeholder=""
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8">
                                        <x-inputs.select2 wire:model="cardiovascular_system"
                                            id="cardiovascular_system" class="form-select"
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8">
                                        <x-inputs.select2 wire:model="genitounrinarius_system"
                                            id="genitounrinarius_system" class="form-select"
                                            placeholder="Select result">
                                            <option value="Normal">Normal</option>
                                            <option value="Tidak Normal">Tidak Normal</option>
                                        </x-inputs.select2>
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <x-inputs.select2 wire:model="fitness_test" id="fitness_test"
                                            class="form-select" placeholder="Select result">
                        ...
                        <div id="visus" class="section-visus" x-data="{ accordionOpen: true }">
                            ...
                            <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                                ...
                                <div class="content-section p-4">
                                    ...
                                    <div class="mb-3 row form-group">
                                        <div class="col">
                                            ...
                                            <x-inputs.mask wire:model="visus_non_correction_od"
                                                id="visus_non_correction_od" :error="'visus_non_correction_od'" />
                                        </div>
                                        <div class="col">
                                            <label for="visus_non_correction_os" class="col col-form-label">Visus jauh
                                                OS</label>
                                            <x-inputs.mask wire:model="visus_non_correction_os"
                                                id="visus_non_correction_os" :error="'visus_non_correction_os'" />
                                        </div>
                                        <div class="col">
                                            <label for="visus_non_correction_ods" class="col col-form-label">Visus
                                                jauh
                                                ODS</label>
                                            <x-inputs.mask wire:model="visus_non_correction_ods"
                                                id="visus_non_correction_ods" :error="'visus_non_correction_ods'" />
                                        </div>
                                    ...
                                    <div class="mb-5 row form-group">
                                        ...
                                        <div class="col">
                                            ...
                                            <x-inputs.mask wire:model="visus_correction_ods" id="visus_correction_ods"
                                                :error="'visus_correction_ods'" />
                                        </div>
                                    </div><!-- /.form-group koreksi -->

                                    <div class="mb-3 row form-group">
                                        <label for="visus_impression" class="col col-form-label">Kesan Visus
                                            Jauh</label>
                                        <div class="col-8">
                                    ...
                                    <div class="mb-3 row form-group">
                                        <label for="visus_reading_test" class="col col-form-label">READING TEST /
                                            Visus
                                            Dekat
                                            /
                                            Jaeger Test</label>
                                        ...
                                        <div class="col-8">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label"
                                                    for="visus_color_blind-1">Normal</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input wire:model="visus_color_blind" class="form-check-input"
                                                    ...
                                                    value="Abnormal">
                                                <label class="form-check-label"
                                                    for="visus_color_blind-2">Abnormal</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input wire:model="visus_color_blind" class="form-check-input"
                                                    ...
                                                    value="Parsial">
                                                <label class="form-check-label"
                                                    for="visus_color_blind-3">Parsial</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="content-section p-4">
                                        ...
                                        <div class="mb-3 row form-group">
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_500"
                                            ...
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_1000"
                                            ...
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_2000"
                                            ...
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_3000"
                                        ...
                                        <div class="mb-5 row form-group">
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_4000"
                                            ...
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_6000"
                                            ...
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_8000"
                                            ...
                                            <div class="col">
                                                ...
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_air_conduction_htl"
                                        ...
                                        <div class="mb-3 row form-group">
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_500"
                                                    class="col col-form-label">500</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_500"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_1000"
                                                    class="col col-form-label">1000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_1000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_2000"
                                                    class="col col-form-label">2000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_2000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_3000"
                                                    class="col col-form-label">3000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_3000"
                                        ...
                                        <div class="mb-5 row form-group">
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_4000"
                                                    class="col col-form-label">4000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_4000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_6000"
                                                    class="col col-form-label">6000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_6000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_8000"
                                                    class="col col-form-label">8000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_8000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_right_bone_conduction_htl"
                                                    class="col col-form-label">HTL</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_right_bone_conduction_htl"
                                        ...
                                        <div class="mb-3 row form-group">
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_500"
                                                    class="col col-form-label">500</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_500"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_1000"
                                                    class="col col-form-label">1000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_1000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_2000"
                                                    class="col col-form-label">2000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_2000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_3000"
                                                    class="col col-form-label">3000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_3000"
                                        ...
                                        <div class="mb-5 row form-group">
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_4000"
                                                    class="col col-form-label">4000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_4000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_6000"
                                                    class="col col-form-label">6000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_6000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_8000"
                                                    class="col col-form-label">8000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_8000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_air_conduction_htl"
                                                    class="col col-form-label">HTL</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_air_conduction_htl"
                                        ...
                                        <div class="mb-3 row form-group">
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_500"
                                                    class="col col-form-label">500</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_500"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_1000"
                                                    class="col col-form-label">1000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_1000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_2000"
                                                    class="col col-form-label">2000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_2000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_3000"
                                                    class="col col-form-label">3000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_3000"
                                        ...
                                        <div class="mb-5 row form-group">
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_4000"
                                                    class="col col-form-label">4000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_4000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_6000"
                                                    class="col col-form-label">6000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_6000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_8000"
                                                    class="col col-form-label">8000</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_8000"
                                            ...
                                            <div class="col">
                                                <label for="audiometry_left_bone_conduction_htl"
                                                    class="col col-form-label">HTL</label>
                                                <x-inputs.number step=".01"
                                                    wire:model="audiometry_left_bone_conduction_htl"
                                        ...
                                        <div class="mb-3 row form-group">
                                            <label for="audiometry_impression"
                                                class="col col-form-label">Kesan</label>
                                            <div class="col-8">
                                ...
                                <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                                    ...
                                    <div class="content-section p-4">
                                        ...
                                        <div class="mb-3 row form-group">
                                            ...
                                            <div class="col-8">
                                                <x-inputs.number step=".01" wire:model="spirometry_fvc"
                                                    id="spirometry_fvc" placeholder="0" value="0"
                                                    :error="'spirometry_fvc'" />
                                            </div>
                                        ...
                                        <div class="mb-3 row form-group">
                                            ...
                                            <div class="col-8">
                                                <x-inputs.number step=".01" wire:model="spirometry_fev1"
                                                    id="spirometry_fev1" placeholder="0" value="0"
                                                    :error="'spirometry_fev1'" />
                                            </div>
                                        </div><!-- /.form-group spirometry_fev1 -->

                                        <div class="mb-3 row form-group">
                                            <label for="spirometry_impression"
                                                class="col col-form-label">Kesan</label>
                                            <div class="col-8">
                    ...
                    <div id="penunjang" class="section-penunjang" x-data="{ accordionOpen: true }">
                        ...
                        <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                            ...
                            <div class="content-section p-4">
                                ...
                                <div class="mb-3 row form-group">
                                    <label for="xray_thorax_note" class="col col-form-label">Catatan X-RAY
                                        THORAX</label>
                                    <div class="col-8">
                                        <x-inputs.text wire:model="xray_thorax_note" id="xray_thorax_note"
                                            rows="7" placeholder="" :error="'xray_thorax_note'" />
                                    </div>
                                </div><!-- /.form-group xray_thorax_note -->

                                <div class="mb-3 row form-group">
                                    <label for="ekg" class="col col-form-label">EKG</label>
                                    <div class="col-8">
                                        <x-inputs.select2_multiple wire:model="ekg" id="ekg"
                                            class="form-select" placeholder="Select result" multiple>
                                ...
                                <div class="mb-3 row form-group">
                                    <label for="ekg_note" class="col col-form-label">Catatan EKG</label>
                                    <div class="col-8">
                                        <x-inputs.text wire:model="ekg_note" id="ekg_note" rows="7"
                                            placeholder="" :error="'ekg_note'" />
                                    </div>
                                </div><!-- /.form-group ekg_note -->
                                ...
                                @if ($employeeAge > 40)
                                    <div class="mb-3 row form-group">
                                        <label for="treadmill" class="col d-flex gap-3 align-items-center">
                                            ...
                                            <span class="icon-tooltip" x-data="{ tooltip: false }"
                                                x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false">
                                                <i class="fa-solid fa-circle-question pt-2 text-info"></i>
                                                <div class="tooltip-content" x-show="tooltip">Usia >40 tahun wajib
                                                    mengikuti treadmill test</div>
                                            </span>
                                        </label>
                                        <div class="col-8">
                                            <x-inputs.select2 wire:model="treadmill" id="treadmill"
                                                class="form-select" placeholder="Select result">
                                                <option value="Negatif iskemic respon">Negatif iskemic respon</option>
                                                <option value="Suggestive iskemic respon">Suggestive iskemic respon</option>
                                                <option value="Positif iskemic respon">Positif iskemic respon</option>
                                            </x-inputs.select2>
                                        </div>
                                    ...
                                    <div class="mb-3 row form-group">
                                        ...
                                        <label for="additional_diagnosis"
                                            class="col d-flex gap-3 align-items-center">
                                            <span class="col-form-label pb-0 lh-sm">Additional Diagnosis</span>
                                            {{-- <span class="opacity-50 lh-sm">post Cardiologist evaluation</span> --}}
                                            <span class="icon-tooltip" x-data="{ tooltip: false }"
                                                x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false">
                                        ...
                                        <div class="col-8">
                                            <x-inputs.text wire:model="additional_diagnosis"
                                                id="additional_diagnosis" rows="7" placeholder=""
                            ...
                            <div class="content-section p-4">
                                ...
                                <div class="mb-3 row form-group  required">
                                    <div class="col">
                                        ...
                                        <x-inputs.text wire:model="blood_hb" id="blood_hb" placeholder="0/0"
                                            :error="'blood_hb'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_ht" class="col col-form-label">Ht</label>
                                        <x-inputs.text wire:model="blood_ht" id="blood_ht" placeholder="0/0"
                                            :error="'blood_ht'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_leukosit" class="col col-form-label">Leukosit</label>
                                        <x-inputs.text wire:model="blood_leukosit" id="blood_leukosit"
                                            placeholder="0/0" :error="'blood_leukosit'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_thrombosit" class="col col-form-label">Thrombosit</label>
                                        <x-inputs.text wire:model="blood_thrombosit" id="blood_thrombosit"
                                ...
                                <div class="mb-5 row form-group required">
                                    <div class="col-3">
                                        ...
                                        <x-inputs.text wire:model="blood_eritrosit" id="blood_eritrosit"
                                            placeholder="0/0" :error="'blood_eritrosit'" />
                                    </div>
                                    <div class="col-3">
                                        <label for="blood_led" class="col col-form-label">LED</label>
                                        <x-inputs.text wire:model="blood_led" id="blood_led" placeholder="0/0"
                                            :error="'blood_led'" />
                                    </div>
                                </div><!-- /.form-group non koreksi -->
                                ...
                                <div class="mb-3 row form-group">
                                    <div class="col-3">
                                        ...
                                        <x-inputs.select2 wire:model="blood_type" id="blood_type"
                                            class="form-select" placeholder="Pilih Golongan Darah">
                                ...
                                <div class="mb-5 row form-group">
                                    <div class="col">
                                        ...
                                        <x-inputs.number step=".01" wire:model="blood_sgot" id="blood_sgot"
                                            placeholder="0" :error="'blood_sgot'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_sgpt" class="col col-form-label">SGPT</label>
                                        <x-inputs.number step=".01" wire:model="blood_sgpt" id="blood_sgpt"
                                            placeholder="0" :error="'blood_sgpt'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_gamma_gt" class="col col-form-label">Gamma GT</label>
                                        <x-inputs.number step=".01" wire:model="blood_gamma_gt"
                                            id="blood_gamma_gt" placeholder="0" :error="'blood_gamma_gt'" />
                                    </div>
                                ...
                                <div class="mb-3 row form-group required">
                                    ...
                                    <div class="col">
                                        ...
                                        <x-inputs.number wire:model="blood_ldl" wire:keydown="RiskScore()"
                                            id="blood_ldl" placeholder="0" :error="'blood_ldl'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_tga" class="col col-form-label">TGA</label>
                                        <x-inputs.number wire:model="blood_tga" id="blood_tga" placeholder="0"
                                            :error="'blood_tga'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_cholesterol_total" class="col col-form-label">Kolesterol
                                            Total</label>
                                        <x-inputs.number step=".01" wire:model="blood_cholesterol_total"
                                            id="blood_cholesterol_total" placeholder="0" :error="'blood_cholesterol_total'" />
                                    </div>
                                ...
                                <div class="mb-5 row form-group">
                                    <div class="col-3">
                                        <label for="blood_billirubin_direk" class="col col-form-label">Billirubin
                                            direk</label>
                                        <x-inputs.number step=".01" wire:model="blood_billirubin_direk"
                                            id="blood_billirubin_direk" placeholder="0" :error="'blood_billirubin_direk'" />
                                    </div>
                                    <div class="col-3">
                                        <label for="blood_billirubin_indirek" class="col col-form-label">Billirubin
                                            indirek</label>
                                        <x-inputs.number step=".01" wire:model="blood_billirubin_indirek"
                                    ...
                                    <div class="col-3">
                                        <label for="blood_billirubin_total" class="col col-form-label">Billirubin
                                            Total</label>
                                        <x-inputs.number step=".01" wire:model="blood_billirubin_total"
                                            id="blood_billirubin_total" placeholder="Autocalculation"
                                            :error="'blood_billirubin_total'" readonly />
                                    </div>
                                    <div class="col-3">
                                        <label for="blood_dislipidemia" class="col col-form-label"><small>Status
                                                Dislipidemia</small></label>
                                ...
                                <div class="mb-3 row form-group">
                                    <div class="col">
                                        ...
                                        <x-inputs.number step=".01" wire:model="blood_gdpt" id="blood_gdpt"
                                            placeholder="0" :error="'blood_gdpt'" />
                                    </div>
                                    <div class="col">
                                        <label for="blood_g2pp" class="col col-form-label">G2PP</label>
                                        <x-inputs.number step=".01" wire:model="blood_g2pp" id="blood_g2pp"
                                            placeholder="0" :error="'blood_g2pp'" />
                                    </div>
                                    <div class="col">
                                        ...
                                        <x-inputs.text wire:model="blood_hyperglycemic" id="blood_hyperglycemic"
                                            placeholder="Autocalculation" :error="'blood_hyperglycemic'" disabled />
                                        {{-- <small class="warning">*Autocalc</small> --}}
                                    </div>
                                    <div class="col">
                                        <label for="blood_hba1c" class="col col-form-label">HbA1C</label>
                                        <x-inputs.number step=".01" wire:model="blood_hba1c" id="blood_hba1c"
                                            placeholder="0" :error="'blood_hba1c'" />
                                    </div>
                                </div><!-- /.form-group -->
                                ...
                                <div class="mb-5 row form-group">
                                    ...
                                    <div class="col-3">
                                        <label for="frammingham_risk_level" class="col col-form-label">RISK
                                            LEVEL</label>
                                        <x-inputs.text wire:model="frammingham_risk_level"
                                            id="frammingham_risk_level" placeholder="Autocalculation"
                                            :error="'frammingham_risk_level'" value="{{ $frammingham_risk_level }}" disabled />
                                    </div>
                                    <div class="col-3">
                                        <label for="frammingham_risk_level" class="col col-form-label">-</label>
                                        <br>
                                        <label class="btn btn-outline-secondary"
                                            wire:click="RiskScore()">Calculate</label>
                                        {{-- <x-inputs.text wire:model="frammingham_risk_level"
                                            id="frammingham_risk_level" placeholder="Autocalculation"
                                            :error="'frammingham_risk_level'" value="{{ $frammingham_risk_level }}" disabled /> --}}
                                    </div>
                                ...
                                <div class="mb-5 row form-group">
                                    <div class="col-3">
                                        ...
                                        <x-inputs.text wire:model="jakarta_cardiovascular_score"
                                            ...
                                            :error="'jakarta_cardiovascular_score'" value="{{ $jakarta_cardiovascular_score }}"
                                            disabled />
                                    </div>
                                    <div class="col-3">
                                        <label for="jakarta_cardiovascular_risk_level"
                                            class="col col-form-label">RISK
                                            LEVEL</label>
                                ...
                                <div class="mb-3 row form-group">
                                    <div class="col">
                                        ...
                                        <x-inputs.number step=".01" wire:model="laboratory_ureum"
                                            id="laboratory_ureum" placeholder="0" :error="'laboratory_ureum'" />
                                    </div>
                                    <div class="col">
                                        <label for="laboratory_bun" class="col col-form-label">BUN</label>
                                        <x-inputs.number step=".01" wire:model="laboratory_bun"
                                            id="laboratory_bun" placeholder="0" :error="'laboratory_bun'" />
                                    </div>

                                    <div class="col">
                                        <label for="laboratory_creatinin"
                                            class="col col-form-label">Creatinin</label>
                                        <span class="icon-tooltip" x-data="{ tooltip: false }"
                                            x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false">
                                            <i class="fa-solid fa-circle-question pt-2 text-info"></i>
                                            <div class="tooltip-content" x-show="tooltip">Berat Badan Wajib diisi
                                            </div>
                                        </span>

                                        <x-inputs.number step=".01" wire:model="laboratory_creatinin"
                                    ...
                                    <div class="col">
                                        <label for="laboratory_uric_acid" class="col col-form-label">Asam
                                            urat</label>
                                        <x-inputs.number step=".01" wire:model="laboratory_uric_acid"
                                            id="laboratory_uric_acid" placeholder="0" :error="'laboratory_uric_acid'" />
                                    </div>
                                </div><!-- /.form-group -->

                                <div class="mb-5 row form-group">
                                    <div class="col-3">
                                        <label for="laboratory_uric_egfr" class="col col-form-label">eGFR
                                            <span class="icon-tooltip" x-data="{ tooltip: false }"
                                                x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false"
                                                wire:click="eGFR()">
                                                <i class="fa-solid fa-circle-question pt-2 text-info"></i>
                                                <div class="tooltip-content" x-show="tooltip">Klik Untuk
                                                    autocalculation
                                                </div>
                                            </span>
                                        </label>
                                        <x-inputs.text wire:model="laboratory_uric_egfr" id="laboratory_uric_egfr"
                                            placeholder="0" :error="'laboratory_uric_egfr'" />
                                    </div>
                                ...
                                <div class="mb-5 row form-group">
                                    ...
                                    @if ($employeeAge <= 55)
                                        ...
                                        <div class="col-3">
                                            <label for="laboratory_anti_hbs" class="col col-form-label">Anti
                                                HBs</label>
                                            <x-inputs.select2 wire:model="laboratory_anti_hbs"
                                                id="laboratory_anti_hbs" class="form-select" placeholder="Pilih">
                                                <option value="Reaktif">Reaktif</option>
                                                <option value="Non Reaktif">Non Reaktif</option>
                                                <option value="Negatif">Negatif</option>
                                            </x-inputs.select2>
                                    ...
                                    @if ($employeeAge <= 55)
                                        @if (
                                            ...
                                            <div class="col-3">
                                                <label for="laboratory_anti_havlgm" class="col col-form-label">Anti
                                                    HAV
                                                    IgM</label>
                                        ...
                                        @if ($medical_ex_type == 'food-handler')
                                            <div class="col-3">
                                                <label for="laboratory_widal"
                                                    class="col col-form-label">Widal</label>
                                                <x-inputs.select2 wire:model="laboratory_widal"
                                                    id="laboratory_widal" class="form-select" placeholder="Pilih">
                                                    <option value="Reaktif">Reaktif</option>
                                                    <option value="Non Reaktif">Non Reaktif</option>
                                                    <option value="Negatif">Negatif</option>
                                                    <option value="Positif">Positif</option>
                                ...
                                @if ($employeeAge <= 55)
                                    ...
                                    <div class="mb-3 row form-group">
                                        <div class="col-3">
                                            <label for="laboratory_malary"
                                                class="col col-form-label">Malaria</label>
                                ...
                                <div class="mb-3 row form-group">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <x-inputs.number step=".01" wire:model="laboratory_urinalysis_ph"
                                    ...
                                    <div class="col-3">
                                        <label for="laboratory_urinalysis_density" class="col col-form-label">Berat
                                            Jenis</label>
                                        <x-inputs.number step=".01" wire:model="laboratory_urinalysis_density"
                                            id="laboratory_urinalysis_density" placeholder="0"
                                            :error="'laboratory_urinalysis_density'" />
                                    </div>
                                ...
                                <div class="mb-3 row form-group">
                                    <div class="col-3">
                                        <label for="laboratory_urinalysis_leukocyte_sediment"
                                            ...
                                            Leukosit</label>
                                        <x-inputs.number step=".01"
                                            wire:model="laboratory_urinalysis_leukocyte_sediment"
                                    ...
                                    <div class="col-3">
                                        ...
                                        <x-inputs.number step=".01"
                                            wire:model="laboratory_urinalysis_erythrocyte"
                                    ...
                                    <div class="col-3">
                                        ...
                                        <x-inputs.number step=".01" wire:model="laboratory_urinalysis_epitel"
                                ...
                                <div class="mb-5 row form-group">
                                    <div class="col">
                                        <label for="laboratory_urinalysis_etc"
                                            class="col-form-label">Lainnya</label>
                                ...
                                @if ($employeeAge <= 55)
                                    ...
                                    @if (
                                            ...
                                            <label for="laboratory_urinalysis_feces_analysis"
                                                ...
                                                <label for="laboratory_urinalysis_feces_analysis"
                                                    ...
                                                    <span class="icon-tooltip" x-data="{ tooltip: false }"
                                                        ...
                                                        <i class="fa-solid fa-circle-question pt-2 text-info"></i>
                                                        <div class="tooltip-content" x-show="tooltip">Khusus food
                                                            handler</div>
                                                    </span>
                                                </label>
                                            </label>
                                        ...
                                        @if ($medical_type == 'periodic')
                                            @if ($medical_ex_type == 'general-housekeeping')
                                                <div class="mb-3 row form-group">
                                                    <label for="treadmill"
                                                        class="col d-flex gap-3 align-items-center">
                                                        <span class="col-form-label pb-0 lh-sm">Choline
                                                            Esterase</span>
                                                    </label>
                                                    <div class="col-8">
                                                        <x-inputs.number step=".01" wire:model="cholinesterase"
                                                            id="cholinesterase" placeholder="0"
                                                            :error="'cholinesterase'" />
                                                    </div>
                                                </div><!-- /.form-group Choline Esterase -->
                                            @endif
                                        @endif
                                    @endif
                                @endif
