<div class="inner-content">
    <div
        class="header-content-mcu-add-doctor-details h-60px bg-white shadow-sm d-flex gap-2 align-items-center justify-content-between px-3">
        <div class="left-header">
            <a href="{{ route('mcu::doctor-list') }}" class="d-flex align-items-center gap-3">
    ...
    <div class="container-fluid g-0 position-relative">
        <div class="row g-0">
            ...
            <div class="detail-left col-3">
                ...
                <div class="position-sticky top-0 bg-white pb-4">
                            ...
                            @foreach ($mcu_staff_list as $msl)
                                <a href="{{ route('mcu::doctor-detail', $msl['id']) }}">
                                    <div
                                        ...
                                        <div class="header-history fw-semibold">{{ $msl['employee']['name'] }}</div>
                                        <div class="content-history">{{ $msl['provider']['name'] }}</div>
                    ...
                    <div class="info-item py-3 px-4 border-bottom border-1">
                        <center>
                            @if ($file_status)
                                <a href="{{ route('mcu::pdf', $data->id) }}" target="_blank" class="btn btn-success"><i
                                        class="fa fa-file-pdf"></i> Lihat Attachment</a>
                            @else
                                <a class="btn btn-warning"><i class="fa fa-file-pdf"></i> No Attachment</a>
                            @endif
                        </center>
                        <div class="pt d-flex flex-column">
                            ...
                            <div class="item-content d-flex gap-2 align-items-start">
                                ...
                                <div class="department-name d-flex flex-column">
                                    ...
                                    <span>{{ $data->employee->user->department ? $data->employee->user->department->name : '-' }}</span>
                                </div>
                            </div>
                        </div><!-- /.pt -->
                    </div><!-- /.info-items -->
                    ...
                    <div class="info-item py-3 px-4 border-bottom border-1">
                        <div class="ttl d-flex flex-column">
                            ...
                            <div class="item-content d-flex gap-1 align-items-center">
                                <span
                                    class="opacity-80">{{ \Carbon\Carbon::parse($data['employee']['date_of_birth'])->format('d M Y') }}</span>
                            </div>
                        </div><!-- /.ttl -->
                    </div><!-- /.info-items -->
                    <div class="info-item py-3 px-4 border-bottom border-1">
                        <div class="jk d-flex flex-column">
                            ...
                            <div class="item-content d-flex gap-1 align-items-center">
                                <span
                                    class="opacity-80">{{ $data['employee']['gender'] == 'male' ? 'Laki-laki' : 'Perempuan' }}</span>
                            </div>
                        </div><!-- /.jk -->
                    </div><!-- /.info-items -->
                    <div class="info-item py-3 px-4 border-bottom border-1">
                        <div class="created d-flex flex-column">
                            ...
                            <div class="item-content d-flex gap-1 align-items-center">
                                ...
                                <span>{{ \Carbon\Carbon::parse($data['mcu_date'])->format('d M Y') }}</span>
                            </div>
                        </div><!-- /.created -->
                    </div><!-- /.info-items -->
                    <div class="info-item py-3 px-4 border-bottom border-1">
                        <div class="expired d-flex flex-column">
                            ...
                            <div class="item-content d-flex gap-1 align-items-center">
                                <span class="opacity-50">on</span>
                                <span>{{ $data->mcu_exp_date ? \Carbon\Carbon::parse($data->mcu_exp_date)->format('d M Y') : '-' }}</span>
                            </div>
                        </div><!-- /.expired -->
                    </div><!-- /.info-items -->
            ...
            <div class="col pb-7 border-end border-start border-1">
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        <div class="content-section m-4">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Jenis Pemeriksaan Kesehatan</label>
                                <div class="col-6 content-mcu-detail">
                                    <div class="content">{{ strtoupper($data['medical_type']) }}</div>
                                </div>
                            </div><!-- /.mcu-detail-item Type of medical -->

                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Program</label>
                                <div class="col-6 content-mcu-detail">
                                    <div class="content">{{ strtoupper($data['medical_ex_type']) }}</div>
                                </div>
                            </div><!-- /.mcu-detail-item Type of medical -->

                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Provider</label>
                                <div class="col-6 content-mcu-detail">
                                    <div class="content">{{ $data['provider']['name'] }}</div>
                                </div>
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        <div class="content-section m-4">
                            <div class="inner-section mb-5 mx-n">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Keluhan</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Riwayat Penyakit Dahulu</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Riwayat Penyakit Keluarga</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Alergi</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5 mx-n">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Merokok</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['smoking'] == 'no')
                                                Tidak
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Jumlah batang/hari</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['smoking_per_day'])
                                                {{ $data['smoking_per_day'] }}
                                            @else
                                                0
                                            @endif
                                            Batang/Hari
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Olahraga</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['sports'] == 'no')
                                                Tidak
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Frekuensi</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['sports_per_week'] == 'no')
                                                0
                                            @elseif ($data['sports_per_week'] == 'low')
                                                2-3
                                            @elseif ($data['sports_per_week'] == 'medium')
                                                3-4
                                            @elseif ($data['sports_per_week'] == 'high')
                                                4-5
                                            @else
                                                0
                                            @endif
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Jenis Olahraga</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['sports_type'])
                                                {{ $data['sports_type'] }}
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Alkohol</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            @if ($data['gender'] == 'female')
                                ...
                                <div class="inner-section mb-5 mx-n">
                                    ...
                                    @if ($data['menstrual_menarche'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Kondisi menstruasi</label>
                                            <div class="col-6 content-mcu-detail">
                                    ...
                                    @if ($data['menstrual_cycle'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Kondisi keteraturan siklus</label>
                                            <div class="col-6 content-mcu-detail">
                                    ...
                                    @if ($data['menstrual_period'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Kondisi lama haid</label>
                                            <div class="col-6 content-mcu-detail">
                                ...
                                <div class="inner-section mb-5 mx-n">
                                    ...
                                    @if ($data['pregnant_period'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Riwayat Hamil</label>
                                            <div class="col-6 content-mcu-detail">
                                    ...
                                    @if ($data['pregnant_spontan'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Spontan</label>
                                            <div class="col-6 content-mcu-detail">
                                    ...
                                    @if ($data['pregnant_surgery'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Bantuan / Operasi</label>
                                            <div class="col-6 content-mcu-detail">
                                    ...
                                    @if ($data['pregnant_abortion'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Keguguran</label>
                                            <div class="col-6 content-mcu-detail">
                                    ...
                                    @if ($data['contraception_type'])
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Jenis kontrasepsi</label>
                                            <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5 mx-n">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Pekerjaan sebelumnya</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Detail pekerjaan saat ini</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['current_job_details'])
                                                {{ $data['current_job_details'] }}
                                            @else
                                                -
                                            @endif
                                        </div>
                            ...
                            {{-- @if ($data['menstrual_cycle'])
                            @endif --}}
                            @if ($data['medical_ex_type'] == 'food-handler')
                                <div class="inner-section mb-5 mx-n">
                                    <h6 class="mb-3 fw-normal title-accordion">Riwayat Vaksinasi Food handler</h6>

                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Hep A - 1st</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Hep A - 2nd</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Hep A - 3 years </label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Typhoid - 1st</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Typhoid - 3 years</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Albendandazole 400 mg </label>
                                        <div class="col-6 content-mcu-detail">
                ...
                <div id="tanda-vital" class="section-anamnesis_2 border-1 border-bottom p-5">
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        <div class="content-section m-4">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">TB</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">BB</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">BMI</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">STATUS GIZI</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">BB SEHAT TERENDAH</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">BB SEHAT TERTINGGI</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Tekanan Darah Sistolik</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Tekanan Darah Diastolik</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Nadi x/m</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">RR x/m</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Suhu tubuh</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Blood pressure status</label>
                                <div class="col-6 content-mcu-detail">
                ...
                <div id="generalisata" class="section-generalisata border-1 border-bottom p-5">
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        <div class="content-section m-4">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">HEENT</label>
                                <div class="col-6 content-mcu-detail">
                                    <div class="content">
                                        @if ($data['heent'])
                                            {{ $data['heent'] }}
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">ORODENTAL</label>
                                <div class="col-6 content-mcu-detail">
                                    <div class="content">
                                        @if ($data['orodental_caries'])
                                            {{ $data['orodental_caries'] }}
                                        @else
                                            -
                                        @endif
                                    </div>
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">SISTEM KARDIOVASKULER</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">SISTEM RESPIRATORIUS</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">SISTEM DIGESTIVUS</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">SISTEM GENITOURINARIUS+KULIT</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">SISTEM NEUROMUSKULAR</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Lain-lain</label>
                                <div class="col-6 content-mcu-detail">
                    ...
                    <div id="virus" class="section-virus border-1 border-bottom p-5">
                        ...
                        <div
                            ...
                            <div class="content-section m-4">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Kesan Visus Jauh</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">READING TEST / Visus Dekat / Jaeger Test</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Buta Warna</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Lapangan Pandang</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Catatan</label>
                                    <div class="col-6 content-mcu-detail">
                ...
                @if ($data['medical_ex_type'] != 'office-group')
                    @if ($data['medical_ex_type'] != 'food-handler' && $data['medical_type'] != 'periodic')
                            ...
                            <div
                                ...
                                <div class="content-section m-4">
                                    <div class="inner-section mb-5">
                                        ...
                                        <div class="mb-3 mcu-detail-item row">
                                            <div class="col-6">Air conduction</div>
                                            <div class="col-2">Kanan</div>
                                            <div class="col-2">Kiri</div>
                                        </div><!-- header Air conduction -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">500</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_500'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_500'] }}
                                            </div>
                                        </div><!-- Visus 500 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">1000</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_1000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_1000'] }}
                                            </div>
                                        </div><!-- Visus 1000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">2000</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_2000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_2000'] }}
                                            </div>
                                        </div><!-- Visus 2000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">3000</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_3000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_3000'] }}
                                            </div>
                                        </div><!-- Visus 3000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">4000</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_4000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_4000'] }}
                                            </div>
                                        </div><!-- Visus 4000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">6000</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_6000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_6000'] }}
                                            </div>
                                        </div><!-- Visus 6000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">8000</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_8000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_8000'] }}
                                            </div>
                                        </div><!-- Visus 8000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">HTL</label>
                                            <div class="col-2">{{ $data['audiometry_right_air_conduction_htl'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_air_conduction_htl'] }}
                                            </div>
                                        </div><!-- Visus HTL -->
                                    ...
                                    <div class="inner-section mb-5">
                                        ...
                                        <div class="mb-3 mcu-detail-item row">
                                            <div class="col-6">Bone conduction</div>
                                            <div class="col-2">Kanan</div>
                                            <div class="col-2">Kiri</div>
                                        ...
                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">500</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_500'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_500'] }}
                                            </div>
                                        </div><!-- Visus 500 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">1000</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_1000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_1000'] }}
                                            </div>
                                        </div><!-- Visus 1000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">2000</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_2000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_2000'] }}
                                            </div>
                                        </div><!-- Visus 2000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">3000</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_3000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_3000'] }}
                                            </div>
                                        </div><!-- Visus 3000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">4000</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_4000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_4000'] }}
                                            </div>
                                        </div><!-- Visus 4000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">6000</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_6000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_6000'] }}
                                            </div>
                                        </div><!-- Visus 6000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">8000</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_8000'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_8000'] }}
                                            </div>
                                        </div><!-- Visus 8000 -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">HTL</label>
                                            <div class="col-2">{{ $data['audiometry_right_bone_conduction_htl'] }}
                                            </div>
                                            <div class="col-2">{{ $data['audiometry_left_bone_conduction_htl'] }}
                                            </div>
                                        </div><!-- Visus HTL -->
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Kesimpulan</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Kesan</label>
                                        <div class="col-6 content-mcu-detail">
                        ...
                        <div id="spirometri" class="section-spirometri border-1 border-bottom p-5">
                            ...
                            <div
                                ...
                                <div class="content-section m-4">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">FVC</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">FEV1</label>
                                        <div class="col-6 content-mcu-detail">
                ...
                <div id="penunjang" class="section-penunjang border-1 border-bottom p-5">
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        <div class="content-section m-4">
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">X-RAY THORAX</label>
                                <div class="col-6 content-mcu-detail">
                                    <div class="content">
                                        @if ($data['xray_thorax'])
                                            {{ $data['xray_thorax'] }}
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">EKG</label>
                                <div class="col-6 content-mcu-detail">
                                    <div class="content">
                                        @if ($data['ekg'])
                                            {{ $data['ekg'] }}
                            ...
                            @if ($employee_age > 40)
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">TREADMILL</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">ECHOCARDIOGRAPHY</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Additional Diagnosis <small>(post Cardiologist
                                            evaluation)</small></label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['additional_diagnosis'])
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        <div class="content-section m-4">
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Hb</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Ht</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Leukosit</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Thrombosit</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Eritrosit</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">LED</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Golongan Darah</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['blood_type'])
                                                {{ $data['blood_type'] }}
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Rhesus</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">SGOT</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">SGPT</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Gamma GT</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">KOLESTEROL TOTAL</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">HDL</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">LDL</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">TGA</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Billirubin Total</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Billirubin direk</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Billirubin indirek</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Status Dislipidemia</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">GDP</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">G2PP</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">STATUS HIPERGLIKEMIA</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">HbA1C</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Status DM</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Score</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Risk</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Ureum</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">BUN</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Creatinin</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Asam urat</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">eGFR</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['laboratory_uric_egfr'])
                                                {{ $data['laboratory_uric_egfr'] }}
                                            @else
                                                -
                                            @endif
                                        </div>
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">HBs-Ag</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['laboratory_hbsag'])
                                                {{ $data['laboratory_hbsag'] }}
                                            @else
                                                -
                                            @endif
                                        </div>
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Anti HBs</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['laboratory_anti_hbs'])
                                                {{ $data['laboratory_anti_hbs'] }}
                                            @else
                                                -
                                            @endif
                                        </div>
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Anti HAV IgM</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['laboratory_anti_havlgm'])
                                                {{ $data['laboratory_anti_havlgm'] }}
                                            @else
                                                -
                                            @endif
                                        </div>
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Widal</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['laboratory_widal'])
                                                {{ $data['laboratory_widal'] }}
                                            @else
                                                -
                                            @endif
                                        </div>
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Malaria</label>
                                    <div class="col-6 content-mcu-detail">
                                        <div class="content">
                                            @if ($data['laboratory_malary'])
                                                {{ $data['laboratory_malary'] }}
                                            @else
                                                -
                                            @endif
                                        </div>
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Warna</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Kejernihan</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">pH</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Berat Jenis</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Protein</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Glukosa</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Bilirubin</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Urobilinogen/Urobilin</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Keton</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Darah</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Lekositesterase</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Nitrit</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            <div class="inner-section mb-5">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Sedimen Leukosit</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Epitel</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Silinder</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Kristal</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Bakteri</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Catatan Lainnya</label>
                                    <div class="col-6 content-mcu-detail">
                            ...
                            @if ($employee_age <= 55)
                                <div class="inner-section mb-5">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">AMP</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">MET</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">BDZ</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">COC</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">OPI</label>
                                        <div class="col-6 content-mcu-detail">
                                    ...
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">THC</label>
                                        <div class="col-6 content-mcu-detail">
                                ...
                                @if (
                                    ($data['medical_ex_type'] == 'food-handler' && $data['medical_type'] != 'pre-retirement') ||
                                        ($data['medical_ex_type'] == 'general-housekeeping' && $data['medical_type'] != 'pre-retirement'))
                                    <div class="inner-section mb-5">
                                        <h6 class="mb-3 fw-normal title-accordion">Analisis Feses</h6>

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Analisis Feses</label>
                                            <div class="col-6 content-mcu-detail">
                                                <div class="content">
                                                    {{ $data['laboratory_urinalysis_feces_analysis'] }}
                                                </div>
                                            </div>
                                        </div><!-- /.mcu-detail-item Analisis Feses -->

                                        <div class="mb-3 mcu-detail-item row">
                                            <label class="col-6 opacity-50">Kultur Feses</label>
                                            <div class="col-6 content-mcu-detail">
                                                <div class="content">
                                                    {{ $data['laboratory_urinalysis_feces_culture'] }}</div>
                                            </div>
                ...
                <div id="temuan" class="section-temuan border-1 border-bottom p-5">
                    ...
                    <div class="wrapper-content-section overflow-hidden position-relative transition-all duration-700">
                        <div class="content-section m-4">
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-12 opacity-50">Hasil Temuan</label>
                                <div class="col-12 mt-2 content-mcu-detail">
                                    @if ($data['findings'])
                                        @foreach ($data['findings'] as $key => $value)
                                            <div class="content mt-2 " style="color: red">
                                                {{ $key }} :
                                                {{-- @if ($key == 'family_disease_history')
                                        ...
                                        @endforeach
                                        {{-- @if (array_key_exists('systolic_blood_pressure', $data['findings']))
                                            <div class="content text-red">
                                                {{ $data['findings']['systolic_blood_pressure'] }}
                                            </div>
                                        @endif
                                        @if (array_key_exists('diastolic_blood_pressure', $data['findings']))
                                            <div class="content">{{ $data['findings']['diastolic_blood_pressure'] }}
                                            </div>
                                        @endif
                                        @if (array_key_exists('arteries', $data['findings']))
                                            <div class="content">{{ $data['findings']['arteries'] }}</div>
                                        @endif
                                        @if (array_key_exists('bmi', $data['findings']))
                            ...
                            <div class="mb-3 mcu-detail-item row">
                                <label class="col-6 opacity-50">Kesesuaian Matrix</label>
                                <div class="col-6 content-mcu-detail">
                            ...
                            <form wire:submit.prevent="save">
                                ...
                                <div class="mb-3 mcu-detail-item row">
                                    <label class="col-6 opacity-50">Status Hasil Peninjauan</label>
                                    <div class="col-6 content-mcu-detail">
                                ...
                                @if ($doctor_status_review == 'Fit With Recomendation' || $doctor_status_review == 'Curently Unfit')
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Saran</label>
                                        <div class="col-6 content-mcu-detail">
                                ...
                                @if ($doctor_status_review == 'Curently Unfit')
                                    <div class="mb-3 mcu-detail-item row">
                                        <label class="col-6 opacity-50">Dokter Spesialis</label>
                                        <div class="col-6 content-mcu-detail">
