                    ...
                    <tr>
                        ...
                        <td style="width:50%;">
                            <div class="title-sertifikat text-center font-weight-bold">SERTIFIKAT KESEHATAN KERJA (SKK)
                                SEMENTARA / TEMPORARY OCCUPATIONAL HEALTH CERTIFICATE</div>
                        </td>
                        <td style="width:35%;">
                ...
                <div class="container p-0">
                    ...
                    <table class="table-bordered" style="width: 100%;">
                            ...
                            <td style="width:30%;">
                                <div class="label">
                                    ...
                                    <span class="font-italic"
                                        style="width:100%; display:block;">{{ $employeeBd }}</span>
                                </div>
                            </td>
                            <td style="width:2%; text-align:center;">
                                <div class="">:</div>
                        ...
                        {{-- <tr>
                            ...
                            <td style="width:68%;">
                                <div class="">
                                    <div class="content font-weight-bold">{{ $mcuCompanion }}</div>
                                </div>
                            </td>
                        </tr>
                    ...
                    <div class="row">
                        <div class="keterangan-content mb-3">
                            ...
                            <span style="display:block;" class="font-italic">It has been examined and reviewed in
                                accordance with Company Criterion for Medical Checkup requirement.</span>
                        </div>
                        <div class="keterangan-content mb-3">
                            <span style="display:block;">Sertifikat ini berlaku dari
                                <strong>{{ $validFrom }}</strong> hingga
                                <strong>{{ $validUntil }}</strong></span>
