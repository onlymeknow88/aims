...
namespace Modules\Mcu\Http\Livewire\Formula;
...
class Lists extends Component
{
    ...
    public function setActiveBloodPressure($id)
    {
        try {
            ...
            redirect()->route('mcu::manage-formula');
    ...
    {
        if (Auth::user()->hasPermissionTo('MCU - Manage Formula MCU')) {
            ...
            return view('mcu::livewire.formula.lists', ['FormulaDislipidemia' => $FormulaDislipidemia, 'FormulaBloodPressure' => $FormulaBloodPressure])->layout('mcu::layouts.app');
        } else {
            return abort(404);
        }
    }
