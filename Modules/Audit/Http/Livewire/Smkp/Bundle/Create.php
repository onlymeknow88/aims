...
class Create extends Component
{
    ...
    public function store(): bool | \Illuminate\Http\RedirectResponse |Redirector
    {
        ...
        try {
            ...
            $plan = $auditSMKP->audit_plan()->create();
            $plan->detail()->create();
            $auditSMKP->implementation_activity()->create();
            $moduleCriteria = $auditSMKP->criteria_module()->create();
            ...
            $implementationReport = $auditSMKP->implementation_report()->create();
            ...
            return redirect()->route('audit::smkp.detail.index', ['id' => $auditSMKP->id]);
