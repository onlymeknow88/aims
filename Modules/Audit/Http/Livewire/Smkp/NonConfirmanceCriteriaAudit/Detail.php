...
namespace Modules\Audit\Http\Livewire\Smkp\NonConfirmanceCriteriaAudit;
...
class Detail extends Component
{
    ...
    {
        $this->non_conformance = AuditCriteriaNonConfirmance::with(['audit_sub_criteria.criteria','audit_sub_criteria.parent.parent'])->find($id);
        // dd($this->non_confirmance);
    ...
    public function generatePDF($id,$non_confirmance_id){
        $this->mount($id,$non_confirmance_id);
