...
namespace Modules\Audit\Http\Livewire\Smkp\Location;
...
class Index extends Component
{
    ...
    {
        $this->locationId = $id;
        $text = 'Semua data Audit dari Lokasi juga akan Dihapus. Yakin untuk melanjutkan?';
    ...
    public function deleteLocation(): void
    {
        ...
        AuditSubCriteriaLocation::where('audit_location_id', $this->locationId)->delete();
        $this->dispatchBrowserEvent('closeModal');
        $this->getAudit($this->audit->id);
        $this->resetLocation();
        $this->dispatchBrowserEvent('swal', [
