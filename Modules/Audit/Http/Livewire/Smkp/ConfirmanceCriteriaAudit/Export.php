...
namespace Modules\Audit\Http\Livewire\Smkp\ConfirmanceCriteriaAudit;
...
class Export extends Component
{
    ...
    protected function getConfirmanceByAudit($id): void
    {
        ...
        $this->audit = Audit::with('company.audit_teams')->find($id);
       
        $this->confirmances = AuditCriteriaConfirmance::with(['audit_sub_criteria.criteria.module.audit','audit_sub_criteria.parent'])
