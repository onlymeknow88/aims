...
namespace Modules\Audit\Http\Livewire\Smk3\NoticeLetter;
...
class Index extends Component
{
    ...
    {
        $this->audit = Audit::with(['company','notice_letters'])->find($id);
    ...
    public function saveDoc()
    {
        ...
        if($this->doc){
            try {
                \DB::beginTransaction();
                $image = $this->doc->store('storage/public/smk3/' . $this->audit->id . "/notice-letter");
