...
namespace Modules\Audit\Http\Livewire\Smk3\CriteriaAudit;
...
class Index extends Component
{
    ...
    public function goTo($criteria_id)
    {
        ...
        return redirect()->route('audit::smk3.detail.criteria-audit.detail', ['id' => $this->audit->id, 'criteria_id' => $criteria_id]);
    }

    public function render()
    {
        if (\Auth::user()->hasPermissionTo( 'Audit - Detail SMKP Criteria Audit')) {
            return view('audit::livewire.criteria-audit.index-smk3',[
                'category'=>'smk3'
