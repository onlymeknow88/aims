...
class Detail extends Component
{
    ...
    protected array $rules = [
        ...
        'audit.smk3_level_text' => 'required',
    ...
    protected function getAudit($id)
    {
        ...
        if($this->audit->smk3_level == 1){
            $this->audit->smk3_level_text = "Tingkat Awal";
        }elseif($this->audit->smk3_level == 2){
            $this->audit->smk3_level_text = "Tingkat Transisi";
        }elseif($this->audit->smk3_level == 3){
            $this->audit->smk3_level_text = "Tingkat Lanjutan";
        }
        // dd($this->audit);
    ...
    public function saveStatus($status): void
    {
        ...
        try {
            ...
            unset($this->audit->smk3_level_text);
