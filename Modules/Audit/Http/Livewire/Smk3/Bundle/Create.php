...
namespace Modules\Audit\Http\Livewire\Smk3\Bundle;
...
use Modules\Audit\Enums\AuditSmk3Level;
...
class Create extends Component
{
    ...
    public string $audit_category = AuditCategory::SMK3;
    public int $smk3_level;

    protected $rules = [
        'company_id' => 'required|exists:companies,id',
        'title' => 'required|max:191',
        'audit_type' => 'required|enum_value:' . AuditType::class,
        'smk3_level' => 'required|enum_value:' . AuditSmk3Level::class,
        ...
        try {
            ...
            foreach ($masterCriteria as $masterCriterion):
                ...
                foreach ($masterCriterion->sub_criteria as $sub_criterion):
                    ...
                    if($sub_criterion->smk3_level <= $this->smk3_level):
                        ...
                        foreach ($sub_criterion->children as $child):
                            if($child->smk3_level <= $this->smk3_level):
                            ...
                            foreach ($child->children as $subChildren) {
                                if($subChildren->smk3_level <= $this->smk3_level):
                                ...
                                foreach ($subChildren->children as $subChildChildren) {
                                    if($subChildChildren->smk3_level <= $this->smk3_level):
            ...
            \DB::commit();
            \Session::flash('success', 'Audit telah dibuat');
            return redirect()->route('audit::smk3.detail.index', ['id' => $audit->id]);
