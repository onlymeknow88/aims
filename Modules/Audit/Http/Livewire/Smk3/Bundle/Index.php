...
class Index extends Component
{
    ...
    // | array |\Illuminate\Pagination\LengthAwarePaginator|\LaravelIdea\Helper\Modules\Audit\Entities\_IH_AuditSmkp_C
    {
        ...
        foreach ($audits as $key => $audit) {
            ...
            if($audit->smk3_level == 1){
                $audits[$key]->smk3_level_text = "Tingkat Awal";
            }elseif($audit->smk3_level == 2){
                $audits[$key]->smk3_level_text = "Tingkat Transisi";
            }elseif($audit->smk3_level == 3){
                $audits[$key]->smk3_level_text = "Tingkat Lanjutan";
            }
    ...
    {   
        ...
        return  view('audit::livewire.smk3.bundle.index',[
