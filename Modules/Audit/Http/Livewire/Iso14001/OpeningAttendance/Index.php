...
namespace Modules\Audit\Http\Livewire\Iso14001\OpeningAttendance;
...
class Index extends Component
{
    ...
    public function saveDoc()
    {
        ...
        try {
            \DB::beginTransaction();
            $image = $this->doc->store('storage/public/iso14001/' . $this->audit->id . "/opening-attendance");
            ...
            $this->audit->opening_attendances()->create([
    ...
    public function delete($audit_id,$notice_id){
        ...
        try{
            $opening_attendance = AuditOpeningAttendance::find($notice_id);
