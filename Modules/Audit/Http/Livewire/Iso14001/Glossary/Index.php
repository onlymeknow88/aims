...
namespace Modules\Audit\Http\Livewire\Iso14001\Glossary;
...
class Index extends Component
{
    ...
    private $audit_category = \Modules\Audit\Enums\AuditCategory::ISO14001;
    ...
    public function render()
    {
        ...
        // if (\Auth::user()->hasPermissionTo('Audit - Detail SMKP Notice Letter')) {
            return view('audit::livewire.glossary.index',
                [
                    "category"=>strtolower($this->audit_category),
