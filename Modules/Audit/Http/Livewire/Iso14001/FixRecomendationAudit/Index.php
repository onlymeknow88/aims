...
namespace Modules\Audit\Http\Livewire\Iso14001\FixRecomendationAudit;
...
class Index extends Component
{
    ...
    protected function getConfirmanceByAudit($id): void
    {
        ...
        $this->confirmances = AuditCriteriaConfirmance::with('audit_sub_criteria.criteria.module.audit.company')
