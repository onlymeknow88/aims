...
namespace Modules\Audit\Http\Livewire\Iso14001\CriteriaAudit;
...
class Index extends Component
{
    ...
    public function goTo($criteria_id)
    {
        ...
        return redirect()->route('audit::iso14001.detail.criteria-audit.detail', ['id' => $this->audit->id, 'criteria_id' => $criteria_id]);
    }
