...
namespace Modules\Audit\Http\Livewire\Iso14001\Bundle;
...
class Index extends Component
{
    ...
    public string $audit_category = AuditCategory::ISO14001;
    public $itemSelected = [];
    ...
    {
        return  view('audit::livewire.iso14001.bundle.index',[])->layout('audit::livewire.layouts.app');
    }
}
