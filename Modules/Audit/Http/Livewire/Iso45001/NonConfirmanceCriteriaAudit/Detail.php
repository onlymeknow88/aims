...
namespace Modules\Audit\Http\Livewire\Iso45001\NonConfirmanceCriteriaAudit;
...
class Detail extends Component
{
    ...
    {
        $this->non_conformance = AuditCriteriaNonConfirmance::with(['audit_sub_criteria.criteria.module.audit','audit_sub_criteria.parent.parent'])->find($id);
