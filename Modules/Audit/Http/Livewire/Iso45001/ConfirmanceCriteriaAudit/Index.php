...
namespace Modules\Audit\Http\Livewire\Iso45001\ConfirmanceCriteriaAudit;
...
class Index extends Component
{
    ...
    protected function getConfirmanceByAudit($id): void
    {
        ...
        $this->confirmances = AuditCriteriaConfirmance::with(['audit_sub_criteria.criteria.module.audit','audit_sub_criteria.parent.parent.parent'])
