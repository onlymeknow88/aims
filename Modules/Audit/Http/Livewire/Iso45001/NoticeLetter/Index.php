...
namespace Modules\Audit\Http\Livewire\Iso45001\NoticeLetter;
...
class Index extends Component
{
    ...
    public function saveDoc()
    {
        ...
        if($this->doc){
            try {
                \DB::beginTransaction();
                $image = $this->doc->store('storage/public/iso45001/' . $this->audit->id . "/notice-letter");
    ...
    public function delete($audit_id,$notice_id){
        ...
        // return redirect()->route('audit::iso45001.detail.notice-letter.index',['id'=>$audit_id]);
