...
<div class="inner-content">
    ...
    @include('audit::livewire.smkp.bundle.modal_team')
    <div class="container">
                    ...
                    <div class="footer-action mb-2 p-3">
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            ...
                            <div class="form-group d-flex justify-content-end gap-2">
                                <!-- <button type="button" class="btn btn-outline-default bg-green d-flex justify-content-center align-item-center text-white position-relative px-4"
                                        wire:loading.remove
                                        wire:target='saveStatus'
                                        wire:click="saveStatus('{{Modules\Audit\Enums\BundleStatusEnum::DRAFT}}')">Simpan
                                </button> -->
                                <button
