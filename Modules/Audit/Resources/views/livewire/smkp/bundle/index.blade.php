...
<div class="inner-content">
    @include('audit::livewire.layouts.breadcrumb', [
        'trees' => [['name' => 'Audit', 'url' => route('audit::dashboard')], ['name' => 'SMKP']],
    ])
    <div class="section-content p-3">
        ...
        <div class="table-maker">
            ...
            <div x-data="{ itemSelected: @entangle('itemSelected'), info: @entangle('info') }" x-init="window.addEventListener('showBulkDeleteConfirm', function() {
                Swal.fire({
                ...
                <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2">
                    ...
                    <div class="toolbar-left d-flex align-items-center">
                        ...
                        <a href="{{ route('audit::smkp.create') }}" type="button"
                        ...
                        @if ($countSelected > 0)
                            ...
                            <button x-on:click.prevent="window.dispatchEvent(new CustomEvent('showBulkDeleteConfirm'))"
                                type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3">
                                <span class="icon d-flex align-items-center">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2">Jenis Audit SMKP</th>
                                <th>
                        ...
                        <tbody>
                            @forelse($this->lists as $itemIndex => $list)
                                <tr wire:key="{{ $itemIndex }}" wire:click="onSelectedItem('{{ $list->id }}')">
                                    ...
                                    <td><a href="{{ route('audit::smkp.detail.index', ['id' => $list->id]) }}"
...
@push('scripts')
    <script>
        document.addEventListener('livewire:load', function() {
            Livewire.on('bulkDeleteSuccess', (msg) => {
                Swal.fire({
                    title: 'Success',
                    text: msg,
                    icon: 'success',
            ...
            Livewire.on('bulkDeleteError', (msg) => {
                Swal.fire({
                    title: 'Error',
                    text: msg,
                    icon: 'error',
