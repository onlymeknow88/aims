<x-slot name="sidebar">
    @livewire('audit::layouts.sidebar-smk3',['id'=>$audit->id])
</x-slot>
<div class="inner-content">
    @include('audit::livewire.layouts.breadcrumb',[
        'trees'=>[
            ['name'=>'SMK3 List','url'=>route('audit::smk3.index')],
            ['name'=>'SMK3 Detail'],
        ]
    ])
    @include('audit::livewire.smk3.bundle.modal_team')
    <div class="container">
            ...
            <div class="col-sm-8">
                <form wire:submit.prevent='store' id="form-audit-init" class="py-4 d-flex flex-column gap-5">
                    ...
                    <div class="content-form d-flex flex-column gap-3">
                        ...
                        <div class="row form-group">
                            <label for="smk3_level_text" class="col col-form-label">Tingkat Audit</label>
                            <div class="col-8">
                                <x-inputs.text
                                    id="smk3_level_text"
                                    error="smk3_level_text"
                                    disabled
                                    wire:model='audit.smk3_level_text'
                                    value="{{$audit->smk3_level_text}}"
                                    placeholder="Tingkat Audit"></x-inputs.text>
                            </div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-8" wire:ignore>
                                <select data-placeholder="" 
                                        id="evaluator_ids"
                                        class="form-select w-100 select2 select2-multiple " 
                                        multiple="multiple">
                                    <option></option>
                    ...
                    <div class="content-form d-flex flex-column gap-3">
                        <div class="row form-group">
                            <label for="progress" class="col col-form-label">Progress</label>
                            <div class="col-8"> {{$progress}} %</div>
                        </div>
                        ...
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            ...
                            <div class="form-group d-flex justify-content-end gap-2">
                                <button type="button" class="btn btn-outline-secondary" wire:loading.remove
                                        ...
                                        wire:click="saveStatus('{{Modules\Audit\Enums\BundleStatusEnum::DRAFT}}')">
                                        Simpan Draft
                                </button>
                                <button
