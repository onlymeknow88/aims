<x-slot name="sidebar">
    @livewire('audit::layouts.sidebar-iso45001',['id'=>$audit->id])
</x-slot>
<div class="inner-content">
    @include('audit::livewire.layouts.breadcrumb',[
        'trees'=>[
            ['name'=>'ISO45001 List','url'=>route('audit::iso45001.index')],
            ['name'=>'ISO45001 Detail'],
        ]
    ])
    @include('audit::livewire.iso45001.bundle.modal_team')
    <div class="container">
