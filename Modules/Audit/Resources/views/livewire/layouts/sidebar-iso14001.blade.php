    ...
    <ul class="list-unstyled d-flex flex-column" style="border-color: #0b2e13!important;">
       {{-- @if (auth()->user()->can('Audit - Detail SMKP Dashboard'))
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.dashboard',['id'=>$id])}}"
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.index',['id'=>$id])}}"
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.notice-letter.index',['id'=>$id])}}"
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.audit-plan',['id'=>$id])}}"
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.implementation-schedule.index',['id'=>$id])}}"
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.criteria-audit.index',['id'=>$id])}}"
               class="link-sidebar text-decoration-none p-3 d-flex">4. Kriteria Audit </a>
        </li>
        @endif
        
        @if (auth()->user()->can('Audit - Detail SMKP Criteria Audit Confirmance'))
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.criteria-audit-conformance.index',['id'=>$id])}}"
               class="link-sidebar text-decoration-none p-3 d-flex">5. Kesesuaian Audit</a>
        </li>
        @endif
        @if (auth()->user()->can('Audit - Detail SMKP Criteria Audit'))
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.criteria-audit-non-conformance.index',['id'=>$id])}}"
               class="link-sidebar text-decoration-none p-3 d-flex">6. Ketidaksesuaian dan Tindak Lanjut Audit</a>
        </li>
        @endif
        @if (auth()->user()->can('Audit - Detail SMKP Criteria Audit Confirmance'))
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.fix-recommendation-audit.index',['id'=>$id])}}" 
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.criteria-audit-non-conformance.fix-plan',['id'=>$id])}}" class="link-sidebar text-decoration-none p-3 d-flex">8. Rencana dan Tindak Lanjut Audit</a>
        </li>
        @endif
        <!-- <li class="item-sidebar border-bottom">
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.opening-attendance.index',['id'=>$id])}}" class="link-sidebar text-decoration-none p-3 d-flex">9. Daftar Hadir Pertemuan Pembukaan Audit</a>
        </li>
        @endif
        @if (auth()->user()->can('Audit - Detail SMKP Audit Fix Recomendation'))
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.closing-attendance.index',['id'=>$id])}}" 
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.response-audit.index',['id'=>$id])}}"
        ...
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.report-result.index',['id'=>$id])}}"
               class="link-sidebar text-decoration-none p-3 d-flex">
                12. Laporan Hasil Audit SMK3
            </a>
        </li>
        @endif
        @if (auth()->user()->can('Audit - Detail SMKP Audit Response'))
        <li class="item-sidebar border-bottom">
            <a href="{{route('audit::iso14001.detail.another-attachment.index',['id'=>$id])}}"
               class="link-sidebar text-decoration-none p-3 d-flex">
                13. Lampiran Lainnya
            </a>
        </li>
