...
<div class="inner-content">
    @include('audit::livewire.layouts.breadcrumb',[
         'trees'=>[
            ['name'=>'Mandays','url'=>route('audit::smkp.mandays.index')],
            ['name'=>'Baru'],
        ]
  ])
    <div class="container">
                ...
                <form wire:submit.prevent='store' id="form-audit-init" class="py-4 d-flex flex-column gap-5">
                    ...
                    <div class="content-form d-flex flex-column gap-3">
                        ...
                        <div class="row form-group">
                            <label for="minimum_people" class="col col-form-label">Minimum</label>
                            <div class="col-8">
                                <x-inputs.text
                                    id="minimum_people"
                                    error="minimum_people"
                                    wire:model='minimum_people'
                                    placeholder="1"></x-inputs.text>
                            </div>
                        </div>
                        <div class="row form-group">
                            <label for="maximum_people" class="col col-form-label">Maksimum</label>
                            <div class="col-8">
                                <x-inputs.text
                                    id="maximum_people"
                                    error="maximum_people"
                                    wire:model='maximum_people'
                                    placeholder="5"></x-inputs.text>
                            </div>
                        </div>
                        <h6>Jumlah Hari Kerja Auditor</h6>
                        <div class="row form-group">
                            <label for="high_risk" class="col col-form-label">Risiko Tinggi</label>
                            <div class="col-8">
                                <x-inputs.text
                                    id="high_risk"
                                    error="high_risk"
                                    wire:model='high_risk'></x-inputs.text>
                            </div>
                        </div>
                        <div class="row form-group">
                            <label for="medium_risk" class="col col-form-label">Risiko Sedang</label>
                            <div class="col-8">
                                <x-inputs.text
                                    id="medium_risk"
                                    error="medium_risk"
                                    wire:model='medium_risk'></x-inputs.text>
                            </div>
                        </div>
                        <div class="row form-group">
                            <label for="low_risk" class="col col-form-label">Risiko Rendah</label>
                            <div class="col-8">
                                <x-inputs.text
                                    id="low_risk"
                                    error="low_risk"
                                    wire:model='low_risk'></x-inputs.text>
                            </div>
                        </div>
                    ...
                    <div class="footer-action mb-2 p-3">
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            ...
                            <div class="form-group d-flex justify-content-end gap-2">
                                <a href="{{route('audit::smkp.mandays.index')}}" class="btn btn-outline-secondary">Batal
                                </a>
                                <button
