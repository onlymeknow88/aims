                ...
                <form wire:submit.prevent='saveTeam' wire:ignore.self id="form-date">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <x-inputs.text id="name" wire:model="name" error="name">name</x-inputs.text>
                        </div>
                        <div class="form-group mt-3">
                            <label for="registration_number">Nomor Registrasi</label>
                            <x-inputs.text id="registration_number" wire:model="registration_number" error="registration_number">name</x-inputs.text>
                        </div>
                    </div>
