                ...
                <div class="p-5 vh-100">
                    <div class="content-login p-5">
                        ...
                        <div class="content-center">
                            ...
                            <h3 class="text-white fs-5 mb-3">Audit System</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-xxl-3">
                <div class="bg-white vh-100 p-5">
                    ...
                    <div class="form-wrapper">
                        <form method="POST" wire:submit.prevent="doLogin">
                            ...
                            <div class="input-group mb-3">
                                <div class="form-floating">
                                    ...
                                    @if($show_password)
                                    <a type="button" class="input-group-text" id="show-password" wire:click="toggleShowPassword(false)">
                                        <img  src="{{asset('./images/icons/hide.png')}}" alt="show password">
                                    </a>
                                    @else
                                    <a type="button" class="input-group-text" id="show-password" wire:click="toggleShowPassword(true)">
                            ...
                            <div class="form-check mb-5">
                                <input class="form-check-input @error('remember') is-invalid @enderror" wire:model='remember' type="checkbox" value="1" id="remember">
