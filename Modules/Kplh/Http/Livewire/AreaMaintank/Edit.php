...
class Edit extends Component
{
    ...
    public function mount($id)
    {
        ...
        foreach ($this->kplh->inspection_data as $ins) {
            ...
            if ($ins->criteria == 'maintank_pipes_1_1') {
                $this->maintank_pipes_1_1_value = $ins->k3_value;
                $this->maintank_pipes_1_1_file = $ins->file;
                $this->maintank_pipes_1_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_pipes_2_1') {
                $this->maintank_pipes_2_1_value = $ins->k3_value;
                $this->maintank_pipes_2_1_file = $ins->file;
                $this->maintank_pipes_2_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_pipes_2_2') {
                $this->maintank_pipes_2_2_value = $ins->k3_value;
                $this->maintank_pipes_2_2_file = $ins->file;
                $this->maintank_pipes_2_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_pipes_2_3') {
                $this->maintank_pipes_2_3_value = $ins->k3_value;
                $this->maintank_pipes_2_3_file = $ins->file;
                $this->maintank_pipes_2_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_pipes_3_1') {
                $this->maintank_pipes_3_1_value = $ins->k3_value;
                $this->maintank_pipes_3_1_file = $ins->file;
                $this->maintank_pipes_3_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_pipes_3_2') {
                $this->maintank_pipes_3_2_value = $ins->k3_value;
                $this->maintank_pipes_3_2_file = $ins->file;
                $this->maintank_pipes_3_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_pipes_3_3') {
                $this->maintank_pipes_3_3_value = $ins->k3_value;
                $this->maintank_pipes_3_3_file = $ins->file;
                $this->maintank_pipes_3_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_pipes_3_4') {
                $this->maintank_pipes_3_4_value = $ins->k3_value;
                $this->maintank_pipes_3_4_file = $ins->file;
                $this->maintank_pipes_3_4_note = $ins->note;
            }

            if ($ins->criteria == 'maintank_1_1') {
                $this->maintank_1_1_value = $ins->k3_value;
                $this->maintank_1_1_file = $ins->file;
                $this->maintank_1_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_1_2') {
                $this->maintank_1_2_value = $ins->k3_value;
                $this->maintank_1_2_file = $ins->file;
                $this->maintank_1_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_1_3') {
                $this->maintank_1_3_value = $ins->k3_value;
                $this->maintank_1_3_file = $ins->file;
                $this->maintank_1_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_2_1') {
                $this->maintank_2_1_value = $ins->k3_value;
                $this->maintank_2_1_file = $ins->file;
                $this->maintank_2_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_2_2') {
                $this->maintank_2_2_value = $ins->k3_value;
                $this->maintank_2_2_file = $ins->file;
                $this->maintank_2_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_2_3') {
                $this->maintank_2_3_value = $ins->k3_value;
                $this->maintank_2_3_file = $ins->file;
                $this->maintank_2_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_2_4') {
                $this->maintank_2_4_value = $ins->k3_value;
                $this->maintank_2_4_file = $ins->file;
                $this->maintank_2_4_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_3_1') {
                $this->maintank_3_1_value = $ins->k3_value;
                $this->maintank_3_1_file = $ins->file;
                $this->maintank_3_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_3_2') {
                $this->maintank_3_2_value = $ins->k3_value;
                $this->maintank_3_2_file = $ins->file;
                $this->maintank_3_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_3_3') {
                $this->maintank_3_3_value = $ins->k3_value;
                $this->maintank_3_3_file = $ins->file;
                $this->maintank_3_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_4_1') {
                $this->maintank_4_1_value = $ins->k3_value;
                $this->maintank_4_1_file = $ins->file;
                $this->maintank_4_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_4_2') {
                $this->maintank_4_2_value = $ins->k3_value;
                $this->maintank_4_2_file = $ins->file;
                $this->maintank_4_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_4_3') {
                $this->maintank_4_3_value = $ins->k3_value;
                $this->maintank_4_3_file = $ins->file;
                $this->maintank_4_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_4_4') {
                $this->maintank_4_4_value = $ins->k3_value;
                $this->maintank_4_4_file = $ins->file;
                $this->maintank_4_4_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_4_5') {
                $this->maintank_4_5_value = $ins->k3_value;
                $this->maintank_4_5_file = $ins->file;
                $this->maintank_4_5_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_5_1') {
                $this->maintank_5_1_value = $ins->k3_value;
                $this->maintank_5_1_file = $ins->file;
                $this->maintank_5_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_5_2') {
                $this->maintank_5_2_value = $ins->k3_value;
                $this->maintank_5_2_file = $ins->file;
                $this->maintank_5_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_6_1') {
                $this->maintank_6_1_value = $ins->k3_value;
                $this->maintank_6_1_file = $ins->file;
                $this->maintank_6_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_6_2') {
                $this->maintank_6_2_value = $ins->k3_value;
                $this->maintank_6_2_file = $ins->file;
                $this->maintank_6_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_6_3') {
                $this->maintank_6_3_value = $ins->k3_value;
                $this->maintank_6_3_file = $ins->file;
                $this->maintank_6_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_6_4') {
                $this->maintank_6_4_value = $ins->k3_value;
                $this->maintank_6_4_file = $ins->file;
                $this->maintank_6_4_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_7_1') {
                $this->maintank_7_1_value = $ins->k3_value;
                $this->maintank_7_1_file = $ins->file;
                $this->maintank_7_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_7_2') {
                $this->maintank_7_2_value = $ins->k3_value;
                $this->maintank_7_2_file = $ins->file;
                $this->maintank_7_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_7_3') {
                $this->maintank_7_3_value = $ins->k3_value;
                $this->maintank_7_3_file = $ins->file;
                $this->maintank_7_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_1_1') {
                $this->maintank_roof_1_1_value = $ins->k3_value;
                $this->maintank_roof_1_1_file = $ins->file;
                $this->maintank_roof_1_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_1_2') {
                $this->maintank_roof_1_2_value = $ins->k3_value;
                $this->maintank_roof_1_2_file = $ins->file;
                $this->maintank_roof_1_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_2_1') {
                $this->maintank_roof_2_1_value = $ins->k3_value;
                $this->maintank_roof_2_1_file = $ins->file;
                $this->maintank_roof_2_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_2_2') {
                $this->maintank_roof_2_2_value = $ins->k3_value;
                $this->maintank_roof_2_2_file = $ins->file;
                $this->maintank_roof_2_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_3_1') {
                $this->maintank_roof_3_1_value = $ins->k3_value;
                $this->maintank_roof_3_1_file = $ins->file;
                $this->maintank_roof_3_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_3_2') {
                $this->maintank_roof_3_2_value = $ins->k3_value;
                $this->maintank_roof_3_2_file = $ins->file;
                $this->maintank_roof_3_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_3_3') {
                $this->maintank_roof_3_3_value = $ins->k3_value;
                $this->maintank_roof_3_3_file = $ins->file;
                $this->maintank_roof_3_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_3_4') {
                $this->maintank_roof_3_4_value = $ins->k3_value;
                $this->maintank_roof_3_4_file = $ins->file;
                $this->maintank_roof_3_4_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_4_1') {
                $this->maintank_roof_4_1_value = $ins->k3_value;
                $this->maintank_roof_4_1_file = $ins->file;
                $this->maintank_roof_4_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_4_2') {
                $this->maintank_roof_4_2_value = $ins->k3_value;
                $this->maintank_roof_4_2_file = $ins->file;
                $this->maintank_roof_4_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_5_1') {
                $this->maintank_roof_5_1_value = $ins->k3_value;
                $this->maintank_roof_5_1_file = $ins->file;
                $this->maintank_roof_5_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_5_2') {
                $this->maintank_roof_5_2_value = $ins->k3_value;
                $this->maintank_roof_5_2_file = $ins->file;
                $this->maintank_roof_5_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_roof_5_3') {
                $this->maintank_roof_5_3_value = $ins->k3_value;
                $this->maintank_roof_5_3_file = $ins->file;
                $this->maintank_roof_5_3_note = $ins->note;
            }

            if ($ins->criteria == 'maintank_area_1_1') {
                $this->maintank_area_1_1_value = $ins->k3_value;
                $this->maintank_area_1_1_file = $ins->file;
                $this->maintank_area_1_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_1_2') {
                $this->maintank_area_1_2_value = $ins->k3_value;
                $this->maintank_area_1_2_file = $ins->file;
                $this->maintank_area_1_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_1_3') {
                $this->maintank_area_1_3_value = $ins->k3_value;
                $this->maintank_area_1_3_file = $ins->file;
                $this->maintank_area_1_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_1_4') {
                $this->maintank_area_1_4_value = $ins->k3_value;
                $this->maintank_area_1_4_file = $ins->file;
                $this->maintank_area_1_4_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_2_1') {
                $this->maintank_area_2_1_value = $ins->k3_value;
                $this->maintank_area_2_1_file = $ins->file;
                $this->maintank_area_2_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_2_2') {
                $this->maintank_area_2_2_value = $ins->k3_value;
                $this->maintank_area_2_2_file = $ins->file;
                $this->maintank_area_2_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_2_3') {
                $this->maintank_area_2_3_value = $ins->k3_value;
                $this->maintank_area_2_3_file = $ins->file;
                $this->maintank_area_2_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_2_4') {
                $this->maintank_area_2_4_value = $ins->k3_value;
                $this->maintank_area_2_4_file = $ins->file;
                $this->maintank_area_2_4_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_3_1') {
                $this->maintank_area_3_1_value = $ins->k3_value;
                $this->maintank_area_3_1_file = $ins->file;
                $this->maintank_area_3_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_3_2') {
                $this->maintank_area_3_2_value = $ins->k3_value;
                $this->maintank_area_3_2_file = $ins->file;
                $this->maintank_area_3_2_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_3_3') {
                $this->maintank_area_3_3_value = $ins->k3_value;
                $this->maintank_area_3_3_file = $ins->file;
                $this->maintank_area_3_3_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_4_1') {
                $this->maintank_area_4_1_value = $ins->k3_value;
                $this->maintank_area_4_1_file = $ins->file;
                $this->maintank_area_4_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_5_1') {
                $this->maintank_area_5_1_value = $ins->k3_value;
                $this->maintank_area_5_1_file = $ins->file;
                $this->maintank_area_5_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_6_1') {
                $this->maintank_area_6_1_value = $ins->k3_value;
                $this->maintank_area_6_1_file = $ins->file;
                $this->maintank_area_6_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_area_7_1') {
                $this->maintank_area_7_1_value = $ins->k3_value;
                $this->maintank_area_7_1_file = $ins->file;
                $this->maintank_area_7_1_note = $ins->note;
            }

            if ($ins->criteria == 'maintank_maintenance_1_1') {
                $this->maintank_maintenance_1_1_value = $ins->k3_value;
                $this->maintank_maintenance_1_1_file = $ins->file;
                $this->maintank_maintenance_1_1_note = $ins->note;
            }
            if ($ins->criteria == 'maintank_maintenance_1_2') {
                $this->maintank_maintenance_1_2_value = $ins->k3_value;
                $this->maintank_maintenance_1_2_file = $ins->file;
                $this->maintank_maintenance_1_2_note = $ins->note;
            }
        }
    }
    ...
    {
        return view('kplh::livewire.area-maintank.edit')->extends('kplh::layouts.no-header');
    }
}
