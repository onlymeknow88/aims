...
namespace Modules\Kplh\Http\Livewire\K3\Hr;
...
class Edit extends Component
{
    ...
    public $ukuran_coupling, $ukuran_coupling_2, $ukuran_coupling_3, $ukuran_coupling_file, $ukuran_coupling_note;
    public $jenis_hose_rail, $jenis_hose_rail_2, $jenis_hose_rail_3, $jenis_hose_rail_file, $jenis_hose_rail_note;
    ...
    public $box_hr, $box_hr_2, $box_hr_file, $box_hr_note;
...
$this->companyId = $this->kplh->company_id;
        $this->companyType = Company::find($this->companyId);
        ...
        foreach ($this->kplh->inspection_data as $ins) {
            ...
            if ($ins->criteria == 'jenis_hose_rail') {
                $this->jenis_hose_rail = $ins->k3_value;
                $this->jenis_hose_rail_2 = $ins->k3_value_2;
                $this->jenis_hose_rail_3 = $ins->k3_value_3;
                $this->jenis_hose_rail_file = $ins->file;
                $this->jenis_hose_rail_note = $ins->note;
            }
            ...
            if ($ins->criteria == 'box_hr') {
                $this->box_hr = $ins->k3_value;
                $this->box_hr_2 = $ins->k3_value_2;
                $this->box_hr_file = $ins->file;
                $this->box_hr_note = $ins->note;
            }
    ...
    public function save()
    {
        try {
            ...
            $InspectionDatas = [
                ...
                [
                    'criteria' => 'jenis_hose_rail',
                    'k3_value' => $this->jenis_hose_rail,
                    'k3_value_2' => $this->jenis_hose_rail_2,
                    'k3_value_3' => $this->jenis_hose_rail_3,
                    'note' => $this->jenis_hose_rail_note,
                ],
                [
                ...
                [
                    'criteria' => 'box_hr',
                    'k3_value' => $this->box_hr,
                    'k3_value_2' => $this->box_hr_2,
                    'note' => $this->box_hr_note,
                ],
                [
                    'criteria' => 'penempatan',
            ...
            foreach ($InspectionDatas as $InspectionData) {
                if (isset($InspectionData['k3_value'])) {
                    ...
                    // PICA
                    if ($status != 'draft') {
                        if ($InspectionData['k3_value'] == 'Tidak Standard' || $InspectionData['k3_value'] == 'Tidak Ada' || $InspectionData['k3_value'] == 'Warna Demarkasi Pudar' || $InspectionData['k3_value'] == 'Perlu Penggantian' || $InspectionData['k3_value'] == 'Terdapat Penghalang') {
    ...
    {
        return view('kplh::livewire.k3.hr.edit')->extends('kplh::layouts.no-header');
    }
}
