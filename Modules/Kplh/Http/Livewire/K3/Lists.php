...
namespace Modules\Kplh\Http\Livewire\K3;
...
class Lists extends Component
{
    ...
    public $info = false;
    public $columns = ['Nomor Identitas', 'Tanggal Inspeksi', 'Jenis Inspeksi', 'CCOW', 'Departemen', 'Section', 'Lokasi', 'Detail Lokasi', 'KTT', 'PJA', 'Keterangan Temuan', 'Status'];
    ...
    public $fieldJenisInspeksi, $searchJenisInspeksi;
    ...
    public function mount()
    {
        ...
        $last = KplhLabel::whereIn('inspect_criteria', array('k3-apar', 'k3-apab', 'k3-eye-wash', 'k3-hose-rail', 'k3-hydrant'))
            ->latest()
            ->first();
        ...
        $this->countData = KplhLabel::where('maker_id', auth()->user()->id)
            ->whereIn('inspect_criteria', array('k3-apar', 'k3-apab', 'k3-eye-wash', 'k3-hose-rail', 'k3-hydrant'))
            ->get()
            ->count();
    ...
    {
        if (Auth::user()->hasPermissionTo('KPLH - View List K3')) {
            return view('kplh::livewire.k3.lists')->layout('kplh::layouts.app');
        } else {
            return abort(404);
        }
    }
