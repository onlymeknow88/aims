...
class Lists extends Component
{
    ...
    public $info = false;
    public $searcInspectionType, $inspectionTypes = [
        ...
        'k3-eye-wash' => 'Inspeksi K3 Eyewash',
    ];
    ...
    public function updated($propertyName, $value)
    {
        ...
        if ($propertyName == 'searcInspectionType') {
            ...
            $this->inspectionTypes = array_filter($this->inspectionTypes, function ($var) use ($value) {
                return $this->filterInspectionType($var, $value);
            });

            // dd($this->inspectionTypes);
        }
    }
    ...
    {
        return view('kplh::livewire.lists')->layout('kplh::layouts.app');
    }
}
