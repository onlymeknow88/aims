                                                ...
                                                <div class="wrapper_isi_apab d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="isi_apab">
                                                        <x-kplh-texteditor wire:model="isi_apab_note"
                                                            ...
                                                            :error="'isi_apab_note'" />
                                                        <br>
                                                        <x-kplh-file wire:model="isi_apab_file" id="isi_apab_file"
                                                            placeholder="Choose File" :error="'isi_apab_file'" />
                                                    </div>
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="gol_apab">
                                                        <x-kplh-texteditor wire:model="gol_apab_note"
                                                            ...
                                                            :error="'gol_apab_note'" />
                                                        <br>
                                                        <x-kplh-file wire:model="gol_apab_file" id="gol_apab_file"
                                                            placeholder="Choose File" :error="'gol_apab_file'" />
                                                    </div>
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kapasitas_apab">
                                                        ...
                                                        <x-kplh-file wire:model="kapasitas_apab_file"
                                                            id="kapasitas_apab_file" placeholder="Choose File"
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="tuas_apab === 'Tidak Standard'">
                                                        ...
                                                        <br>
                                                        <x-kplh-file wire:model="tuas_apab_file" id="tuas_apab_file"
                                                            placeholder="Choose File" :error="'tuas_apab_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="handle_apab === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-file wire:model="handle_apab_file"
                                                            id="handle_apab_file" placeholder="Choose File"
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="pressure_gauge === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-file wire:model="pressure_gauge_file"
                                                            id="pressure_gauge_file" placeholder="Choose File"
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="pin_apab === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-texteditor wire:model="pin_apab_note"
                                                            ...
                                                            :error="'pin_apab_note'" />
                                                        <br>
                                                        <x-kplh-file wire:model="pin_apab_file" id="pin_apab_file"
                                                            placeholder="Choose File" :error="'pin_apab_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="hose_apab === 'Tidak Standard'">
                                                        ...
                                                        <br>
                                                        <x-kplh-file wire:model="hose_apab_file" id="hose_apab_file"
                                                            placeholder="Choose File" :error="'hose_apab_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="nozzle_apab === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-file wire:model="nozzle_apab_file"
                                                            id="nozzle_apab_file" placeholder="Choose File"
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kondisi_tabung === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-file wire:model="kondisi_tabung_file"
                                                            id="kondisi_tabung_file" placeholder="Choose File"
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="troli_apab === 'Tidak Standard'">
                                                        <x-inputs.select2 wire:model="troli_apab_2" id="troli_apab_2"
                                                            ...
                                                            <option value="Roda Rusak">Roda Rusak</option>
                                                            <option value="Troli dan Roda Berkarat">Troli dan Roda
                                                                Berkarat</option>
                                                            <option value="Lainnya">Lainnya</option>
                                                        </x-inputs.select2>
                                                        <br>
                                                        ...
                                                        <br>
                                                        <x-kplh-file wire:model="troli_apab_file" id="troli_apab_file"
                                                            placeholder="Choose File" :error="'troli_apab_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="cat_tabung === 'Tidak Standard'">
                                                        ...
                                                        <br>
                                                        <x-kplh-file wire:model="cat_tabung_file" id="cat_tabung_file"
                                                            placeholder="Choose File" :error="'cat_tabung_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="powder === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-file wire:model="powder_file" id="powder_file"
                                                            placeholder="Choose File" :error="'powder_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="bracket === 'Tidak Standard'">
                                                        ...
                                                        <br>
                                                        <x-kplh-file wire:model="bracket_file" id="bracket_file"
                                                            placeholder="Choose File" :error="'bracket_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <x-inputs.select2 wire:model="shelter_apab" id="shelter_apab"
                                                        ...
                                                        <option value="Tidak Ada">Tidak Ada Shelter</option>
                                                        <option value="N/A">N/A</option>
                                                    </x-inputs.select2>
                                                    ...
                                                    <div x-cloak
                                                        ...
                                                        <x-kplh-file wire:model="shelter_apab_file"
                                                            id="shelter_apab_file" placeholder="Choose File"
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kain_pelindung === 'Tidak Ada'">
                                                        ...
                                                        <x-kplh-file wire:model="kain_pelindung_file"
                                                            id="kain_pelindung_file" placeholder="Choose File"
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kondisi_kain === 'Perlu Penggantian'">
                                                        ...
                                                        <x-kplh-file wire:model="kondisi_kain_file"
                                                            id="kondisi_kain_file" placeholder="Choose File"
                                                    ...
                                                    <div x-cloak x-show="penempatan === 'Terdapat Penghalang'">
                                                        <x-inputs.select2 wire:model="penempatan_2" id="penempatan_2"
                                                            ...
                                                            <option value="Penghalang Dipindahkan">Penghalang
                                                                Dipindahkan</option>
                                                            <option value="Penghalang Tidak Dapat Dipindahkan">
                                                                Penghalang Tidak
                                                                Dapat
                                                                Dipindahkan
                                                            </option>
