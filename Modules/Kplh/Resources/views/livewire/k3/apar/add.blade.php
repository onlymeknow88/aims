                                                ...
                                                <div class="wrapper_isi_apar d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="isi_apar">
                                                        <x-kplh-texteditor wire:model="isi_apar_note"
                                                            ...
                                                            :error="'isi_apar_note'" />
                                                        <br>
                                                        <x-kplh-file wire:model="isi_apar_file" id="isi_apar_file"
                                                            placeholder="Choose File" :error="'isi_apar_file'" />
                                                    </div>
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="gol_apar">
                                                        <x-kplh-texteditor wire:model="gol_apar_note"
                                                            ...
                                                            :error="'gol_apar_note'" />
                                                        <br>
                                                        <x-kplh-file wire:model="gol_apar_file" id="gol_apar_file"
                                                            placeholder="Choose File" :error="'gol_apar_file'" />
                                                    </div>
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kapasitas_apar">
                                                        ...
                                                        <x-kplh-file wire:model="kapasitas_apar_file"
                                                            id="kapasitas_apar_file" placeholder="Choose File"
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="tuas_apar === 'Tidak Standard'">
                                                        ...
                                                        <br>
                                                        <x-kplh-file wire:model="tuas_apar_file" id="tuas_apar_file"
                                                            placeholder="Choose File" :error="'tuas_apar_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="handle_apar === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-file wire:model="handle_apar_file"
                                                            id="handle_apar_file" placeholder="Choose File"
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="pin_apar === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-texteditor wire:model="pin_apar_note"
                                                            ...
                                                            :error="'pin_apar_note'" />
                                                        <br>
                                                        <x-kplh-file wire:model="pin_apar_file" id="pin_apar_file"
                                                            placeholder="Choose File" :error="'pin_apar_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="hose_apar === 'Tidak Standard'">
                                                        ...
                                                        <br>
                                                        <x-kplh-file wire:model="hose_apar_file" id="hose_apar_file"
                                                            placeholder="Choose File" :error="'hose_apar_file'" />
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            </div><!-- /.col-lg-12 -->
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="nozzle_apar === 'Tidak Standard'">
                                                        ...
                                                        <x-kplh-file wire:model="nozzle_apar_file"
                                                            id="nozzle_apar_file" placeholder="Choose File"
                                        ...
                                        <div class="row mb-3 form-group">
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak
                                                        x-show="demarkasi === 'Tidak Ada' || demarkasi === 'pudar' ">
