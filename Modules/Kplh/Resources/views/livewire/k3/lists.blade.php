                            ...
                            @can('KPLH - Create K3')
                                <div class="new-wrapper">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="{{ route('kplh::add-k3-apar') }}">Inspeksi Alat
                                                K3 APAR</a></li>
                                        <li><a class="dropdown-item" href="{{ route('kplh::add-k3-apab') }}">Inspeksi Alat
                                                K3 APAB</a></li>
                                        <li><a class="dropdown-item" href="{{ route('kplh::add-k3-hydrant') }}">Inspeksi
                                                Alat K3 Hydrant</a></li>
                                        <li><a class="dropdown-item" href="{{ route('kplh::add-k3-hose-rail') }}">Inspeksi
                                                Alat K3
                                                Hose Rail</a></li>
                                        <li><a class="dropdown-item" href="{{ route('kplh::add-k3-eye-wash') }}">Inspeksi
                                                Alat K3
                                                Eyewash</a></li>
                                    </ul>
                                </div>
