                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="jenis_hose_rail_2 === 'Tidak Standard'">
                                                        ...
                                                        @if ($jenis_hose_rail_file && !Illuminate\Support\Str::contains($jenis_hose_rail_file, 'private/var/folders/'))
                                                            <div class="row mt-3">
                                                                <div class="col-md-3"><button type="button"
                                                                        class="btn btn-outline-secondary"
                                                                        wire:click="setFileNull('jenis_hose_rail_file')"><i
                                                                            class="fa fa-edit"></i> Ubah
                                                                        File</button></div>
                                                                <div class="col-md-9">
                                                                    <a class="btn btn-outline-secondary"
                                                                        href="{{ route('kplh::download-file', ['k3', $jenis_hose_rail_file]) }}"
                                                                        target="_blank"><i class="fa fa-file"></i>
                                                                        {{ Illuminate\Support\Str::limit($jenis_hose_rail_file, 30) }}</a>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <div class="col-md-12 mt-3">
                                                                <x-kplh-file wire:model="jenis_hose_rail_file"
                                                                    id="jenis_hose_rail_file" placeholder="File"
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="box_hr === 'Tidak Standard'">
                                                        ...
                                                        @if ($box_hr_file && !Illuminate\Support\Str::contains($box_hr_file, 'private/var/folders/'))
                                                            <div class="row mt-3">
                                                                <div class="col-md-3"><button type="button"
                                                                        class="btn btn-outline-secondary"
                                                                        wire:click="setFileNull('box_hr_file')"><i
                                                                            class="fa fa-edit"></i> Ubah
                                                                        File</button></div>
                                                                <div class="col-md-9">
                                                                    <a class="btn btn-outline-secondary"
                                                                        href="{{ route('kplh::download-file', ['k3', $box_hr_file]) }}"
                                                                        target="_blank"><i class="fa fa-file"></i>
                                                                        {{ Illuminate\Support\Str::limit($box_hr_file, 30) }}</a>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <div class="col-md-12 mt-3">
                                                                <x-kplh-file wire:model="box_hr_file" id="box_hr_file"
                                                                    placeholder="File" :error="'box_hr_file'" />
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div><!-- /.wrapper_inspeksi -->
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kip === 'Tidak Standard'">
                                                        <x-inputs.select2 wire:model="kip_2" id="kip_2" class="form-select"
