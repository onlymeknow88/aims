                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="type_eye_wash">
                                                        ...
                                                        @if ($type_eye_wash_file && !Illuminate\Support\Str::contains($type_eye_wash_file, 'private/var/folders/'))
                                                            <div class="row mt-3">
                                                                <div class="col-md-3"><button type="button"
                                                                        class="btn btn-outline-secondary"
                                                                        wire:click="setFileNull('type_eye_wash_file')"><i
                                                                            class="fa fa-edit"></i> Ubah
                                                                        File</button></div>
                                                                <div class="col-md-9">
                                                                    <a class="btn btn-outline-secondary"
                                                                        href="{{ route('kplh::download-file', ['k3', $type_eye_wash_file]) }}"
                                                                        target="_blank"><i class="fa fa-file"></i>
                                                                        {{ Illuminate\Support\Str::limit($type_eye_wash_file, 30) }}</a>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <div class="col-md-12 mt-3">
                                                                <x-kplh-file wire:model="type_eye_wash_file"
                                                                    id="type_eye_wash_file" placeholder="File"
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kondisi_tangki === 'Tidak Standard'">
                                                        ...
                                                        @if ($kondisi_tangki_file && !Illuminate\Support\Str::contains($kondisi_tangki_file, 'private/var/folders/'))
                                                            <div class="row mt-3">
                                                                <div class="col-md-3"><button type="button"
                                                                        class="btn btn-outline-secondary"
                                                                        wire:click="setFileNull('kondisi_tangki_file')"><i
                                                                            class="fa fa-edit"></i> Ubah
                                                                        File</button></div>
                                                                <div class="col-md-9">
                                                                    <a class="btn btn-outline-secondary"
                                                                        href="{{ route('kplh::download-file', ['k3', $kondisi_tangki_file]) }}"
                                                                        target="_blank"><i class="fa fa-file"></i>
                                                                        {{ Illuminate\Support\Str::limit($kondisi_tangki_file, 30) }}</a>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <div class="col-md-12 mt-3">
                                                                <x-kplh-file wire:model="kondisi_tangki_file"
                                                                    id="kondisi_tangki_file" placeholder="File"
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                ...
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <div x-cloak x-show="kondisi_air === 'Tidak Standard'">
                                                        ...
                                                        @if ($kondisi_air_file && !Illuminate\Support\Str::contains($kondisi_air_file, 'private/var/folders/'))
                                                            <div class="row mt-3">
                                                                <div class="col-md-3"><button type="button"
                                                                        class="btn btn-outline-secondary"
                                                                        wire:click="setFileNull('kondisi_air_file')"><i
                                                                            class="fa fa-edit"></i> Ubah
                                                                        File</button></div>
                                                                <div class="col-md-9">
                                                                    <a class="btn btn-outline-secondary"
                                                                        href="{{ route('kplh::download-file', ['k3', $kondisi_air_file]) }}"
                                                                        target="_blank"><i class="fa fa-file"></i>
                                                                        {{ Illuminate\Support\Str::limit($kondisi_air_file, 30) }}</a>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <div class="col-md-12 mt-3">
                                                                <x-kplh-file wire:model="kondisi_air_file"
                                                                    id="kondisi_air_file" placeholder="File"
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="wrapper_inspeksi d-flex flex-column gap-3"
                                                    ...
                                                    <di x-cloak x-show="pancuran_air === 'Tidak Standard'">
                                                        ...
                                                        @if ($pancuran_air_file && !Illuminate\Support\Str::contains($pancuran_air_file, 'private/var/folders/'))
                                                            <div class="row mt-3">
                                                                <div class="col-md-3"><button type="button"
                                                                        class="btn btn-outline-secondary"
                                                                        wire:click="setFileNull('pancuran_air_file')"><i
                                                                            class="fa fa-edit"></i> Ubah
                                                                        File</button></div>
                                                                <div class="col-md-9">
                                                                    <a class="btn btn-outline-secondary"
                                                                        href="{{ route('kplh::download-file', ['k3', $pancuran_air_file]) }}"
                                                                        target="_blank"><i class="fa fa-file"></i>
                                                                        {{ Illuminate\Support\Str::limit($pancuran_air_file, 30) }}</a>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <div class="col-md-12 mt-3">
                                                                <x-kplh-file wire:model="pancuran_air_file"
                                                                    id="pancuran_air_file" placeholder="File"
