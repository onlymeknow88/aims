                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_1_a d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_a_file" id="jetty_1_a_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_1_a_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_b_1_file"
                                                            id="jetty_1_b_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_b_2_file"
                                                            id="jetty_1_b_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_b_3_file"
                                                            id="jetty_1_b_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_c_1_file"
                                                            id="jetty_1_c_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_c_2_file"
                                                            id="jetty_1_c_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_c_3_file"
                                                            id="jetty_1_c_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_d_1_file"
                                                            id="jetty_1_d_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_d_2_file"
                                                            id="jetty_1_d_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_d_3_file"
                                                            id="jetty_1_d_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_d_4_file"
                                                            id="jetty_1_d_4_file" placeholder="Upload foto temuan"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_1_e d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_e_file" id="jetty_1_e_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_1_e_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_f_1_file"
                                                            id="jetty_1_f_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_f_2_file"
                                                            id="jetty_1_f_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_g_1_file"
                                                            id="jetty_1_g_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_g_2_file"
                                                            id="jetty_1_g_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_g_3_file"
                                                            id="jetty_1_g_3_file" placeholder="Upload foto temuan"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_1_h d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_h_file" id="jetty_1_h_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_1_h_file'" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_1_i d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_i_file" id="jetty_1_i_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_1_i_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_j_1_file"
                                                            id="jetty_1_j_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_j_2_file"
                                                            id="jetty_1_j_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_1_j_3_file"
                                                            id="jetty_1_j_3_file" placeholder="Upload foto temuan"
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_a_1_file"
                                                            id="jetty_2_a_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_a_2_file"
                                                            id="jetty_2_a_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_a_3_file"
                                                            id="jetty_2_a_3_file" placeholder="Upload foto temuan"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_2_b d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_b_file" id="jetty_2_b_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_2_b_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_c_1_file"
                                                            id="jetty_2_c_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_c_2_file"
                                                            id="jetty_2_c_2_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="jetty_2_c_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan jembatan ponton rata dan
                                            stabil
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_c_3_file"
                                                            id="jetty_2_c_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_c_4_file"
                                                            id="jetty_2_c_4_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_d_1_file"
                                                            id="jetty_2_d_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_d_2_file"
                                                            id="jetty_2_d_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_e_1_file"
                                                            id="jetty_2_e_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_e_2_file"
                                                            id="jetty_2_e_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_e_3_file"
                                                            id="jetty_2_e_3_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="jetty_2_f_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan di jembatan ponton tidak
                                            ada sampah
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_2_f d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_f_file" id="jetty_2_f_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_2_f_file'" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_2_g d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_g_file" id="jetty_2_g_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_2_g_file'" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_2_h d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_h_file" id="jetty_2_h_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_2_h_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_i_1_file"
                                                            id="jetty_2_i_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_i_2_file"
                                                            id="jetty_2_i_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_i_3_file"
                                                            id="jetty_2_i_3_file" placeholder="Upload foto temuan"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_2_j d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_j_file" id="jetty_2_j_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_2_j_file'" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_2_k d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_k_file" id="jetty_2_k_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_2_k_file'" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_jetty_2_l d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_2_l_file" id="jetty_2_l_file"
                                                            placeholder="Upload foto temuan" :error="'jetty_2_l_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_3_a_1_file"
                                                            id="jetty_3_a_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="jetty_3_a_2_file"
                                                            id="jetty_3_a_2_file" placeholder="Upload foto temuan"
