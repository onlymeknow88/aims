<div class="inner-content">
    ...
    <div
        class="header-content-inspeksi-area-maintank h-60px d-flex gap-2 align-items-center justify-content-between px-3">
                ...
                <div class="col-12 col-md-12 col-lg-8">
                    ...
                    <form class="py-4 d-flex flex-column gap-5" action="#" action="post"
                        ...
                        <div id="label" class="section-label" x-data="{ accordionOpen: true }">
                            ...
                            <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                    ...
                                    <div class="row mb-3 form-group">
                                        <label for="kttId" class="col-lg-4 col-md-12 col-form-label">KTT</label>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_1_1_file"
                                                            id="maintank_pipes_1_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_1_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_2_1_file"
                                                            id="maintank_pipes_2_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_2_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_2_2_file"
                                                            id="maintank_pipes_2_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_2_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_2_3_file"
                                                            id="maintank_pipes_2_3_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_2_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_3_1_file"
                                                            id="maintank_pipes_3_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_3_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_3_2_file"
                                                            id="maintank_pipes_3_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_3_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_3_3_file"
                                                            id="maintank_pipes_3_3_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_3_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_pipes_3_4_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_pipes_3_4_file'" />
                                                    </div>
                                                </div>
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_1_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Dinding plat tidak ada rembesan,
                                            Berkarat & penyok.
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_1_1_file"
                                                            id="maintank_1_1_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_1_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Keliling maintank bagian
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_1_2_file"
                                                            id="maintank_1_2_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_1_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Sambungan antar plat tidak ada
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_1_3_file"
                                                            id="maintank_1_3_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <h4 class="col-lg-12 col-md-12 col-form-label">2. Pressure Safety Valve</h4>
                                    </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_2_1_file"
                                                            id="maintank_2_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_2_2_file"
                                                            id="maintank_2_2_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_2_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan tuas sebelum PSV dalam
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_2_3_file"
                                                            id="maintank_2_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_2_4_file"
                                                            id="maintank_2_4_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_3_1_file"
                                                            id="maintank_3_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_3_2_file"
                                                            id="maintank_3_2_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_3_3_label" class="col-lg-4 col-md-12 col-form-label">Baut
                                            penghubung flexible hose harus lengkap dan tidak bisa diputar dengan tangan.
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_3_3_file"
                                                            id="maintank_3_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_4_1_file"
                                                            id="maintank_4_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_4_2_file"
                                                            id="maintank_4_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_4_3_file"
                                                            id="maintank_4_3_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_4_4_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Meter ketinggian volume
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_4_4_file"
                                                            id="maintank_4_4_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_4_5_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Katrol dapat berputar,
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_4_5_file"
                                                            id="maintank_4_5_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_5_1_file"
                                                            id="maintank_5_1_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_5_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan sambungan pipa hydrant
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_5_2_file"
                                                            id="maintank_5_2_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_6_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Kabel penangkal petir
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_6_1_file"
                                                            id="maintank_6_1_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_6_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan grounding system tidak
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_6_2_file"
                                                            id="maintank_6_2_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_6_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan grounding system dan
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_6_3_file"
                                                            id="maintank_6_3_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_6_4_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Kabel grounding tertanam
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_6_4_file"
                                                            id="maintank_6_4_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_7_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Tanda aliran (panah arah minyak)
                                            terlihat jelas
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_7_1_file"
                                                            id="maintank_7_1_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_7_2_label" class="col-lg-4 col-md-12 col-form-label">Drat
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_7_2_file"
                                                            id="maintank_7_2_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_7_3_label" class="col-lg-4 col-md-12 col-form-label">Gate
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_7_3_file"
                                                            id="maintank_7_3_file" placeholder="Upload foto temuan"
                        ...
                        <div id="maintank_roof" class="section-maintank_roof" x-data="{ accordionOpen: false }">
                            ...
                            <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                                x-ref="maintank_roof" x-bind:style="accordionOpen ? 'max-height: ' + 20000 + 'px' : ''"
                                x-transition.delay.5000ms>
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_1_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Handrail tidak rapuh,
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_1_1_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_1_1_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_1_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Pijakan tangga tidak
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_1_2_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_1_2_file'" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <h4 class="col-lg-12 col-md-12 col-form-label">2. Handrail atap maintank</h4>
                                    </div>

                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_2_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan sambungan tiap handrail
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_2_1_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_2_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_2_2_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_2_2_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <h4 class="col-lg-12 col-md-12 col-form-label">3. Plat bagian atas maintank
                                        </h4>
                                    </div>

                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_3_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan free venting maintank
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_3_1_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_3_1_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_3_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan tampak fisik plat tidak
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_3_2_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_3_2_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_3_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan atap maintank bersih
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_3_3_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_3_3_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_3_4_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan sambungan antar plat
                                            tidak ada rembesan & tidak lepas.
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_3_4_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_3_4_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_4_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Tutup manhole rapat dan
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_roof_4_1_note"
                                                            id="maintank_roof_4_1_note" placeholder="Keterangan"
                                                            :error="'maintank_roof_4_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_4_1_file"
                                                            id="maintank_roof_4_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_4_1_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_4_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Sambungan las pada
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_roof_4_2_note"
                                                            id="maintank_roof_4_2_note" placeholder="Keterangan"
                                                            :error="'maintank_roof_4_2_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_4_2_file"
                                                            id="maintank_roof_4_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_4_2_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_5_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan Tutup tersegel dan
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_roof_5_1_note"
                                                            id="maintank_roof_5_1_note" placeholder="Keterangan"
                                                            :error="'maintank_roof_5_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_5_1_file"
                                                            id="maintank_roof_5_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_5_1_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_roof_5_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan angka tinggi referensi
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_roof_5_2_note"
                                                            id="maintank_roof_5_2_note" placeholder="Keterangan"
                                                            :error="'maintank_roof_5_2_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_5_2_file"
                                                            id="maintank_roof_5_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_5_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_roof_5_3_note"
                                                            id="maintank_roof_5_3_note" placeholder="Keterangan"
                                                            :error="'maintank_roof_5_3_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_roof_5_3_file"
                                                            id="maintank_roof_5_3_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_roof_5_3_file'" />
                                                    </div>
                                                </div>
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_1_1_note"
                                                            id="maintank_area_1_1_note" placeholder="Keterangan"
                                                            :error="'maintank_area_1_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_1_1_file"
                                                            id="maintank_area_1_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_1_1_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_1_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan di pagar bundwall
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_1_2_note"
                                                            id="maintank_area_1_2_note" placeholder="Keterangan"
                                                            :error="'maintank_area_1_2_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_1_2_file"
                                                            id="maintank_area_1_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_1_2_file'" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_1_3_note"
                                                            id="maintank_area_1_3_note" placeholder="Keterangan"
                                                            :error="'maintank_area_1_3_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_1_3_file"
                                                            id="maintank_area_1_3_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_1_3_file'" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_1_4_label"
                                            class="col-lg-4 col-md-12 col-form-label">Warna perbedaan ketinggian
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_1_4_note"
                                                            id="maintank_area_1_4_note" placeholder="Keterangan"
                                                            :error="'maintank_area_1_4_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_1_4_file"
                                                            id="maintank_area_1_4_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_1_4_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_2_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan aliran air limbah pada
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_2_1_note"
                                                            id="maintank_area_2_1_note" placeholder="Keterangan"
                                                            :error="'maintank_area_2_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_2_1_file"
                                                            id="maintank_area_2_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_2_1_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_2_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan saluran drainase tidak
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_2_2_note"
                                                            id="maintank_area_2_2_note" placeholder="Keterangan"
                                                            :error="'maintank_area_2_2_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_2_2_file"
                                                            id="maintank_area_2_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_2_2_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_2_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan gate valve drainage
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_2_3_note"
                                                            id="maintank_area_2_3_note" placeholder="Keterangan"
                                                            :error="'maintank_area_2_3_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_2_3_file"
                                                            id="maintank_area_2_3_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_2_3_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_2_4_label"
                                            class="col-lg-4 col-md-12 col-form-label">Kondisi konkrit tidak boleh
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_2_4_note"
                                                            id="maintank_area_2_4_note" placeholder="Keterangan"
                                                            :error="'maintank_area_2_4_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_2_4_file"
                                                            id="maintank_area_2_4_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_2_4_file'" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_3_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan pagar dalam keadaan
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_3_1_note"
                                                            id="maintank_area_3_1_note" placeholder="Keterangan"
                                                            :error="'maintank_area_3_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_3_1_file"
                                                            id="maintank_area_3_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_3_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_3_2_note"
                                                            id="maintank_area_3_2_note" placeholder="Keterangan"
                                                            :error="'maintank_area_3_2_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_3_2_file"
                                                            id="maintank_area_3_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_3_2_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_3_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan pagar tidak dapat
                                            diakses.
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_3_3_note"
                                                            id="maintank_area_3_3_note" placeholder="Keterangan"
                                                            :error="'maintank_area_3_3_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_3_3_file"
                                                            id="maintank_area_3_3_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_3_3_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_4_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pastikan tidak ada sampah di
                                            area maintank.
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_4_1_note"
                                                            id="maintank_area_4_1_note" placeholder="Keterangan"
                                                            :error="'maintank_area_4_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_4_1_file"
                                                            id="maintank_area_4_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_4_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_5_1_note"
                                                            id="maintank_area_5_1_note" placeholder="Keterangan"
                                                            :error="'maintank_area_5_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_5_1_file"
                                                            id="maintank_area_5_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_5_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_6_1_note"
                                                            id="maintank_area_6_1_note" placeholder="Keterangan"
                                                            :error="'maintank_area_6_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_6_1_file"
                                                            id="maintank_area_6_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_6_1_file'" />
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="maintank_area_7_1_label"
                                            class="col-lg-4 col-md-12 col-form-label">Dapat ditutup dengan rapat dan
                                            terkunci.
                                        </label>
                                        <div class="col-lg-8 col-md-12">
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_area_7_1_note"
                                                            id="maintank_area_7_1_note" placeholder="Keterangan"
                                                            :error="'maintank_area_7_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_area_7_1_file"
                                                            id="maintank_area_7_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_area_7_1_file'" />
                                                    </div>
                                                </div>
                        ...
                        <div id="maintank_maintenance" class="section-maintank_maintenance"
                            ...
                            <div class="wrapper-content-accordion max-h-0 overflow-hidden position-relative transition-all duration-700"
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                    ...
                                    <div class="row form-group mb-4">
                                        <h4 class="col-lg-12 col-md-12 col-form-label">1. Perawatan dan Perbaikan
                                        </h4>
                                    </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_maintank_maintenance_1_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_maintenance_1_1_note"
                                                            id="maintank_maintenance_1_1_note"
                                                            placeholder="Keterangan" :error="'maintank_maintenance_1_1_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_maintenance_1_1_file"
                                                            id="maintank_maintenance_1_1_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_maintenance_1_1_file'" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_maintank_maintenance_1_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div>
                                                        <x-kplh-texteditor wire:model="maintank_maintenance_1_2_note"
                                                            id="maintank_maintenance_1_2_note"
                                                            placeholder="Keterangan" :error="'maintank_maintenance_1_2_note'" />
                                                    </div>
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="maintank_maintenance_1_2_file"
                                                            id="maintank_maintenance_1_2_file"
                                                            placeholder="Upload foto temuan" :error="'maintank_maintenance_1_2_file'" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
