                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_1_file"
                                                            id="building_criteria_1_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_2_file"
                                                            id="building_criteria_2_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_3_file"
                                                            id="building_criteria_3_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_4_file"
                                                            id="building_criteria_4_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_4_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_5_file"
                                                            id="building_criteria_5_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_5_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_6_file"
                                                            id="building_criteria_6_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_6_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_7_file"
                                                            id="building_criteria_7_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_7_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_8_file"
                                                            id="building_criteria_8_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_8_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_9_file"
                                                            id="building_criteria_9_file"
                                                            placeholder="Upload foto temuan" :error="'building_criteria_9_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_10_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'building_criteria_10_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="building_criteria_11_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'building_criteria_11_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="sanitation_1_file"
                                                            id="sanitation_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="sanitation_2_file"
                                                            id="sanitation_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <x-kplh-file wire:model="sanitation_3_file"
                                                            id="sanitation_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="sanitation_4_file"
                                                            id="sanitation_4_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="sanitation_5_file"
                                                            id="sanitation_5_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="sanitation_6_file"
                                                            id="sanitation_6_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_1_file"
                                                            id="equipment_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_2_file"
                                                            id="equipment_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_3_file"
                                                            id="equipment_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_4_file"
                                                            id="equipment_4_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_5_file"
                                                            id="equipment_5_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_6_file"
                                                            id="equipment_6_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_7_file"
                                                            id="equipment_7_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="equipment_8_file"
                                                            id="equipment_8_file" placeholder="Upload foto temuan"
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_1_file"
                                                            id="food_handler_1_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="food_handler_2_label"
                                            class="col-lg-4 col-md-12 col-form-label">Pengelola/ penjamah makanan harus
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_2_file"
                                                            id="food_handler_2_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_3_file"
                                                            id="food_handler_3_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_4_file"
                                                            id="food_handler_4_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_5_file"
                                                            id="food_handler_5_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="food_handler_6_label"
                                            class="col-lg-4 col-md-12 col-form-label">Setiap petugas dapur memiliki APD
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_6_file"
                                                            id="food_handler_6_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_7_file"
                                                            id="food_handler_7_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_8_file"
                                                            id="food_handler_8_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_9_file"
                                                            id="food_handler_9_file" placeholder="Upload foto temuan"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="food_handler_10_label"
                                            class="col-lg-4 col-md-12 col-form-label">Semua kegiatan pengolahan makanan
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_10_file"
                                                            id="food_handler_10_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_11_file"
                                                            id="food_handler_11_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_handler_12_file"
                                                            id="food_handler_12_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_storage_1_file"
                                                            id="food_storage_1_file" placeholder="Upload foto temuan"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_storage_2_file"
                                                            id="food_storage_2_file"
                                                            placeholder="Upload foto temuan" :error="'food_storage_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_storage_3_file"
                                                            id="food_storage_3_file"
                                                            placeholder="Upload foto temuan" :error="'food_storage_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_storage_4_file"
                                                            id="food_storage_4_file"
                                                            placeholder="Upload foto temuan" :error="'food_storage_4_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_storage_5_file"
                                                            id="food_storage_5_file"
                                                            placeholder="Upload foto temuan" :error="'food_storage_5_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_processers_1_file"
                                                            id="food_processers_1_file"
                                                            placeholder="Upload foto temuan" :error="'food_processers_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_processers_2_file"
                                                            id="food_processers_2_file"
                                                            placeholder="Upload foto temuan" :error="'food_processers_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_processers_3_file"
                                                            id="food_processers_3_file"
                                                            placeholder="Upload foto temuan" :error="'food_processers_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_processers_4_file"
                                                            id="food_processers_4_file"
                                                            placeholder="Upload foto temuan" :error="'food_processers_4_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_processers_5_file"
                                                            id="food_processers_5_file"
                                                            placeholder="Upload foto temuan" :error="'food_processers_5_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_processers_6_file"
                                                            id="food_processers_6_file"
                                                            placeholder="Upload foto temuan" :error="'food_processers_6_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_processers_7_file"
                                                            id="food_processers_7_file"
                                                            placeholder="Upload foto temuan" :error="'food_processers_7_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_transport_1_1_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'food_transport_1_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_transport_1_2_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'food_transport_1_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_transport_1_3_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'food_transport_1_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_transport_2_1_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'food_transport_2_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_transport_2_2_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'food_transport_2_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="food_transport_2_3_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'food_transport_2_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="general_precautions_1_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'general_precautions_1_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="general_precautions_2_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'general_precautions_2_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="general_precautions_3_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'general_precautions_3_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="general_precautions_4_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'general_precautions_4_file'" />
                                                    </div>
                                                </div>
                                                ...
                                                <div x-cloak
                                                    ...
                                                    <div class="mt-3">
                                                        <x-kplh-file wire:model="general_precautions_5_file"
                                                            ...
                                                            placeholder="Upload foto temuan" :error="'general_precautions_5_file'" />
                                                    </div>
                                                </div>
