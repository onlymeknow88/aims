                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_1_file && !Illuminate\Support\Str::contains($workplace_a_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_1_file"
                                                                id="workplace_a_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_2_file && !Illuminate\Support\Str::contains($workplace_a_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_2_file"
                                                                id="workplace_a_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_3_file && !Illuminate\Support\Str::contains($workplace_a_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_3_file"
                                                                id="workplace_a_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_4_file && !Illuminate\Support\Str::contains($workplace_a_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_4_file"
                                                                id="workplace_a_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_5_file && !Illuminate\Support\Str::contains($workplace_a_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_5_file"
                                                                id="workplace_a_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_6_file && !Illuminate\Support\Str::contains($workplace_a_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_6_file"
                                                                id="workplace_a_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_7_file && !Illuminate\Support\Str::contains($workplace_a_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_7_file"
                                                                id="workplace_a_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_8_file && !Illuminate\Support\Str::contains($workplace_a_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_8_file"
                                                                id="workplace_a_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_9_file && !Illuminate\Support\Str::contains($workplace_a_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_9_file"
                                                                id="workplace_a_9_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_10 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_10_file && !Illuminate\Support\Str::contains($workplace_a_10_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_10_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_10_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_10_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_10_file"
                                                                id="workplace_a_10_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_11 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_11_file && !Illuminate\Support\Str::contains($workplace_a_11_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_11_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_11_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_11_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_11_file"
                                                                id="workplace_a_11_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_12 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_12_file && !Illuminate\Support\Str::contains($workplace_a_12_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_12_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_12_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_12_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_12_file"
                                                                id="workplace_a_12_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_a_13 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_a_13_file && !Illuminate\Support\Str::contains($workplace_a_13_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_a_13_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_a_13_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_a_13_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_a_13_file"
                                                                id="workplace_a_13_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_b_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_b_1_file && !Illuminate\Support\Str::contains($workplace_b_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_b_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_b_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_b_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_b_1_file"
                                                                id="workplace_b_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_b_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_b_2_file && !Illuminate\Support\Str::contains($workplace_b_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_b_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_b_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_b_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_b_2_file"
                                                                id="workplace_b_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_b_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_b_3_file && !Illuminate\Support\Str::contains($workplace_b_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_b_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_b_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_b_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_b_3_file"
                                                                id="workplace_b_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_b_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_b_4_file && !Illuminate\Support\Str::contains($workplace_b_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_b_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_b_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_b_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_b_4_file"
                                                                id="workplace_b_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_b_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_b_5_file && !Illuminate\Support\Str::contains($workplace_b_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_b_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_b_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_b_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_b_5_file"
                                                                id="workplace_b_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_b_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_b_6_file && !Illuminate\Support\Str::contains($workplace_b_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_b_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_b_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_b_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_b_6_file"
                                                                id="workplace_b_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_b_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_b_7_file && !Illuminate\Support\Str::contains($workplace_b_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_b_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_b_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_b_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_b_7_file"
                                                                id="workplace_b_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_c_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_c_1_file && !Illuminate\Support\Str::contains($workplace_c_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_c_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_c_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_c_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_c_1_file"
                                                                id="workplace_c_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_c_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_c_2_file && !Illuminate\Support\Str::contains($workplace_c_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_c_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_c_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_c_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_c_2_file"
                                                                id="workplace_c_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_c_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_c_3_file && !Illuminate\Support\Str::contains($workplace_c_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_c_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_c_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_c_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_c_3_file"
                                                                id="workplace_c_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_1_file && !Illuminate\Support\Str::contains($workplace_d_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_1_file"
                                                                id="workplace_d_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_2_file && !Illuminate\Support\Str::contains($workplace_d_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_2_file"
                                                                id="workplace_d_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_3_file && !Illuminate\Support\Str::contains($workplace_d_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_3_file"
                                                                id="workplace_d_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_4_file && !Illuminate\Support\Str::contains($workplace_d_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_4_file"
                                                                id="workplace_d_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_5_file && !Illuminate\Support\Str::contains($workplace_d_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_5_file"
                                                                id="workplace_d_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_6_file && !Illuminate\Support\Str::contains($workplace_d_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_6_file"
                                                                id="workplace_d_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_7_file && !Illuminate\Support\Str::contains($workplace_d_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_7_file"
                                                                id="workplace_d_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_8_file && !Illuminate\Support\Str::contains($workplace_d_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_8_file"
                                                                id="workplace_d_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_d_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_d_9_file && !Illuminate\Support\Str::contains($workplace_d_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_d_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_d_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_d_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_d_9_file"
                                                                id="workplace_d_9_file" placeholder="Pilih File"
                                ...
                                <div class="content-section p-4" wire:ignore.self>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_e_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_e_1_file && !Illuminate\Support\Str::contains($workplace_e_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_e_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_e_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_e_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_e_1_file"
                                                                id="workplace_e_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_e_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_e_2_file && !Illuminate\Support\Str::contains($workplace_e_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_e_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_e_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_e_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_e_2_file"
                                                                id="workplace_e_2_file" placeholder="Pilih File"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="workplace_e_3_label"
                                            class="col-lg-4 col-md-12 col-form-label">Apakah perancah dilengkapi
                                            dengan
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_e_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_e_3_file && !Illuminate\Support\Str::contains($workplace_e_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_e_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_e_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_e_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_e_3_file"
                                                                id="workplace_e_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_e_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_e_4_file && !Illuminate\Support\Str::contains($workplace_e_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_e_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_e_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_e_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_e_4_file"
                                                                id="workplace_e_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_e_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_e_5_file && !Illuminate\Support\Str::contains($workplace_e_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_e_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_e_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_e_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_e_5_file"
                                                                id="workplace_e_5_file" placeholder="Pilih File"
                                    ...
                                    <div class="row form-group mb-4">
                                        <label for="workplace_e_6_label"
                                            class="col-lg-4 col-md-12 col-form-label">Apakah perancah telah
                                            dipasangkan
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_e_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_e_6_file && !Illuminate\Support\Str::contains($workplace_e_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_e_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_e_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_e_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_e_6_file"
                                                                id="workplace_e_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_1_file && !Illuminate\Support\Str::contains($workplace_f_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_1_file"
                                                                id="workplace_f_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_2_file && !Illuminate\Support\Str::contains($workplace_f_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_2_file"
                                                                id="workplace_f_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_3_file && !Illuminate\Support\Str::contains($workplace_f_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_3_file"
                                                                id="workplace_f_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_4_file && !Illuminate\Support\Str::contains($workplace_f_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_4_file"
                                                                id="workplace_f_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_5_file && !Illuminate\Support\Str::contains($workplace_f_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_5_file"
                                                                id="workplace_f_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_6_file && !Illuminate\Support\Str::contains($workplace_f_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_6_file"
                                                                id="workplace_f_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_7_file && !Illuminate\Support\Str::contains($workplace_f_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_7_file"
                                                                id="workplace_f_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_8_file && !Illuminate\Support\Str::contains($workplace_f_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_8_file"
                                                                id="workplace_f_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_f_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_f_9_file && !Illuminate\Support\Str::contains($workplace_f_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_f_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_f_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_f_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_f_9_file"
                                                                id="workplace_f_9_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_1_file && !Illuminate\Support\Str::contains($workplace_g_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_1_file"
                                                                id="workplace_g_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_2_file && !Illuminate\Support\Str::contains($workplace_g_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_2_file"
                                                                id="workplace_g_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_3_file && !Illuminate\Support\Str::contains($workplace_g_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_3_file"
                                                                id="workplace_g_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_4_file && !Illuminate\Support\Str::contains($workplace_g_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_4_file"
                                                                id="workplace_g_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_5_file && !Illuminate\Support\Str::contains($workplace_g_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_5_file"
                                                                id="workplace_g_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_6_file && !Illuminate\Support\Str::contains($workplace_g_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_6_file"
                                                                id="workplace_g_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_7_file && !Illuminate\Support\Str::contains($workplace_g_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_7_file"
                                                                id="workplace_g_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_g_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_g_8_file && !Illuminate\Support\Str::contains($workplace_g_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_g_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_g_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_g_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_g_8_file"
                                                                id="workplace_g_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_h_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_h_1_file && !Illuminate\Support\Str::contains($workplace_h_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_h_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_h_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_h_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_h_1_file"
                                                                id="workplace_h_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_h_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_h_2_file && !Illuminate\Support\Str::contains($workplace_h_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_h_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_h_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_h_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_h_2_file"
                                                                id="workplace_h_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_h_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_h_3_file && !Illuminate\Support\Str::contains($workplace_h_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_h_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_h_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_h_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_h_3_file"
                                                                id="workplace_h_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_h_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_h_4_file && !Illuminate\Support\Str::contains($workplace_h_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_h_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_h_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_h_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_h_4_file"
                                                                id="workplace_h_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_h_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_h_5_file && !Illuminate\Support\Str::contains($workplace_h_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_h_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_h_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_h_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_h_5_file"
                                                                id="workplace_h_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_h_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_h_6_file && !Illuminate\Support\Str::contains($workplace_h_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_h_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_h_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_h_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_h_6_file"
                                                                id="workplace_h_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_1_file && !Illuminate\Support\Str::contains($workplace_i_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_1_file"
                                                                id="workplace_i_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_2_file && !Illuminate\Support\Str::contains($workplace_i_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_2_file"
                                                                id="workplace_i_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_3_file && !Illuminate\Support\Str::contains($workplace_i_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_3_file"
                                                                id="workplace_i_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_4_file && !Illuminate\Support\Str::contains($workplace_i_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_4_file"
                                                                id="workplace_i_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_5_file && !Illuminate\Support\Str::contains($workplace_i_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_5_file"
                                                                id="workplace_i_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_6_file && !Illuminate\Support\Str::contains($workplace_i_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_6_file"
                                                                id="workplace_i_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_7_file && !Illuminate\Support\Str::contains($workplace_i_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_7_file"
                                                                id="workplace_i_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_i_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_i_8_file && !Illuminate\Support\Str::contains($workplace_i_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_i_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_i_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_i_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_i_8_file"
                                                                id="workplace_i_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_1_file && !Illuminate\Support\Str::contains($workplace_j_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_1_file"
                                                                id="workplace_j_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_2_file && !Illuminate\Support\Str::contains($workplace_j_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_2_file"
                                                                id="workplace_j_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_3_file && !Illuminate\Support\Str::contains($workplace_j_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_3_file"
                                                                id="workplace_j_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_4_file && !Illuminate\Support\Str::contains($workplace_j_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_4_file"
                                                                id="workplace_j_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_5_file && !Illuminate\Support\Str::contains($workplace_j_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_5_file"
                                                                id="workplace_j_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_6_file && !Illuminate\Support\Str::contains($workplace_j_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_6_file"
                                                                id="workplace_j_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_7_file && !Illuminate\Support\Str::contains($workplace_j_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_7_file"
                                                                id="workplace_j_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_j_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_j_8_file && !Illuminate\Support\Str::contains($workplace_j_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_j_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_j_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_j_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_j_8_file"
                                                                id="workplace_j_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_1_file && !Illuminate\Support\Str::contains($workplace_k_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_1_file"
                                                                id="workplace_k_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_2_file && !Illuminate\Support\Str::contains($workplace_k_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_2_file"
                                                                id="workplace_k_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_3_file && !Illuminate\Support\Str::contains($workplace_k_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_3_file"
                                                                id="workplace_k_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_4_file && !Illuminate\Support\Str::contains($workplace_k_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_4_file"
                                                                id="workplace_k_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_5_file && !Illuminate\Support\Str::contains($workplace_k_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_5_file"
                                                                id="workplace_k_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_6_file && !Illuminate\Support\Str::contains($workplace_k_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_6_file"
                                                                id="workplace_k_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_7_file && !Illuminate\Support\Str::contains($workplace_k_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_7_file"
                                                                id="workplace_k_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_8_file && !Illuminate\Support\Str::contains($workplace_k_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_8_file"
                                                                id="workplace_k_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_9_file && !Illuminate\Support\Str::contains($workplace_k_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_9_file"
                                                                id="workplace_k_9_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_10 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_10_file && !Illuminate\Support\Str::contains($workplace_k_10_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_10_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_10_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_10_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_10_file"
                                                                id="workplace_k_10_file" placeholder="Pilih File"
                                                                :error="'workplace_k_10_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_11 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_11_file && !Illuminate\Support\Str::contains($workplace_k_11_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_11_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_11_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_11_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_11_file"
                                                                id="workplace_k_11_file" placeholder="Pilih File"
                                                                :error="'workplace_k_11_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_k_12 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_k_12_file && !Illuminate\Support\Str::contains($workplace_k_12_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_k_12_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_k_12_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_k_12_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_k_12_file"
                                                                id="workplace_k_12_file" placeholder="Pilih File"
                                                                :error="'workplace_k_12_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_1_file && !Illuminate\Support\Str::contains($workplace_l_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_1_file"
                                                                id="workplace_l_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_2_file && !Illuminate\Support\Str::contains($workplace_l_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_2_file"
                                                                id="workplace_l_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_3_file && !Illuminate\Support\Str::contains($workplace_l_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_3_file"
                                                                id="workplace_l_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_4_file && !Illuminate\Support\Str::contains($workplace_l_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_4_file"
                                                                id="workplace_l_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_5_file && !Illuminate\Support\Str::contains($workplace_l_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_5_file"
                                                                id="workplace_l_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_6_file && !Illuminate\Support\Str::contains($workplace_l_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_6_file"
                                                                id="workplace_l_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_7_file && !Illuminate\Support\Str::contains($workplace_l_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_7_file"
                                                                id="workplace_l_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_8_file && !Illuminate\Support\Str::contains($workplace_l_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_8_file"
                                                                id="workplace_l_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_9_file && !Illuminate\Support\Str::contains($workplace_l_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_9_file"
                                                                id="workplace_l_9_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_10 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_10_file && !Illuminate\Support\Str::contains($workplace_l_10_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_10_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_10_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_10_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_10_file"
                                                                id="workplace_l_10_file" placeholder="Pilih File"
                                                                :error="'workplace_l_10_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_11 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_11_file && !Illuminate\Support\Str::contains($workplace_l_11_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_11_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_11_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_11_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_11_file"
                                                                id="workplace_l_11_file" placeholder="Pilih File"
                                                                :error="'workplace_l_11_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_12 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_12_file && !Illuminate\Support\Str::contains($workplace_l_12_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_12_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_12_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_12_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_12_file"
                                                                id="workplace_l_12_file" placeholder="Pilih File"
                                                                :error="'workplace_l_12_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_l_13 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_l_13_file && !Illuminate\Support\Str::contains($workplace_l_13_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_l_13_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_l_13_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_l_13_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_l_13_file"
                                                                id="workplace_l_13_file" placeholder="Pilih File"
                                                                :error="'workplace_l_13_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_m_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_m_1_file && !Illuminate\Support\Str::contains($workplace_m_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_m_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_m_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_m_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_m_1_file"
                                                                id="workplace_m_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_m_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_m_2_file && !Illuminate\Support\Str::contains($workplace_m_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_m_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_m_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_m_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_m_2_file"
                                                                id="workplace_m_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_m_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_m_3_file && !Illuminate\Support\Str::contains($workplace_m_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_m_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_m_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_m_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_m_3_file"
                                                                id="workplace_m_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_m_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_m_4_file && !Illuminate\Support\Str::contains($workplace_m_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_m_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_m_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_m_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_m_4_file"
                                                                id="workplace_m_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_1_file && !Illuminate\Support\Str::contains($workplace_n_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_1_file"
                                                                id="workplace_n_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_2_file && !Illuminate\Support\Str::contains($workplace_n_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_2_file"
                                                                id="workplace_n_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_3_file && !Illuminate\Support\Str::contains($workplace_n_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_3_file"
                                                                id="workplace_n_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_4_file && !Illuminate\Support\Str::contains($workplace_n_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_4_file"
                                                                id="workplace_n_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_5_file && !Illuminate\Support\Str::contains($workplace_n_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_5_file"
                                                                id="workplace_n_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_6_file && !Illuminate\Support\Str::contains($workplace_n_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_6_file"
                                                                id="workplace_n_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_7_file && !Illuminate\Support\Str::contains($workplace_n_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_7_file"
                                                                id="workplace_n_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_8_file && !Illuminate\Support\Str::contains($workplace_n_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_8_file"
                                                                id="workplace_n_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_9_file && !Illuminate\Support\Str::contains($workplace_n_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_9_file"
                                                                id="workplace_n_9_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_10 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_10_file && !Illuminate\Support\Str::contains($workplace_n_10_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_10_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_10_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_10_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_10_file"
                                                                id="workplace_n_10_file" placeholder="Pilih File"
                                                                :error="'workplace_n_10_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_11 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_11_file && !Illuminate\Support\Str::contains($workplace_n_11_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_11_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_11_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_11_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_11_file"
                                                                id="workplace_n_11_file" placeholder="Pilih File"
                                                                :error="'workplace_n_11_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_12 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_12_file && !Illuminate\Support\Str::contains($workplace_n_12_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_12_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_12_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_12_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_12_file"
                                                                id="workplace_n_12_file" placeholder="Pilih File"
                                                                :error="'workplace_n_12_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_13 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_13_file && !Illuminate\Support\Str::contains($workplace_n_13_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_13_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_13_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_13_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_13_file"
                                                                id="workplace_n_13_file" placeholder="Pilih File"
                                                                :error="'workplace_n_13_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_14 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_14_file && !Illuminate\Support\Str::contains($workplace_n_14_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_14_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_14_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_14_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_14_file"
                                                                id="workplace_n_14_file" placeholder="Pilih File"
                                                                :error="'workplace_n_14_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_15 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_15_file && !Illuminate\Support\Str::contains($workplace_n_15_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_15_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_15_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_15_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_15_file"
                                                                id="workplace_n_15_file" placeholder="Pilih File"
                                                                :error="'workplace_n_15_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_n_16 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_n_16_file && !Illuminate\Support\Str::contains($workplace_n_16_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_n_16_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_n_16_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_n_16_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_n_16_file"
                                                                id="workplace_n_16_file" placeholder="Pilih File"
                                                                :error="'workplace_n_16_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_o_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_o_1_file && !Illuminate\Support\Str::contains($workplace_o_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_o_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_o_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_o_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_o_1_file"
                                                                id="workplace_o_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_o_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_o_2_file && !Illuminate\Support\Str::contains($workplace_o_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_o_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_o_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_o_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_o_2_file"
                                                                id="workplace_o_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_o_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_o_3_file && !Illuminate\Support\Str::contains($workplace_o_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_o_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_o_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_o_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_o_3_file"
                                                                id="workplace_o_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_o_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_o_4_file && !Illuminate\Support\Str::contains($workplace_o_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_o_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_o_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_o_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_o_4_file"
                                                                id="workplace_o_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_o_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_o_5_file && !Illuminate\Support\Str::contains($workplace_o_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_o_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_o_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_o_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_o_5_file"
                                                                id="workplace_o_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_o_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_o_6_file && !Illuminate\Support\Str::contains($workplace_o_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_o_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_o_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_o_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_o_6_file"
                                                                id="workplace_o_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_1_file && !Illuminate\Support\Str::contains($workplace_p_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_1_file"
                                                                id="workplace_p_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_2_file && !Illuminate\Support\Str::contains($workplace_p_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_2_file"
                                                                id="workplace_p_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_3_file && !Illuminate\Support\Str::contains($workplace_p_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_3_file"
                                                                id="workplace_p_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_4_file && !Illuminate\Support\Str::contains($workplace_p_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_4_file"
                                                                id="workplace_p_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_5_file && !Illuminate\Support\Str::contains($workplace_p_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_5_file"
                                                                id="workplace_p_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_6_file && !Illuminate\Support\Str::contains($workplace_p_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_6_file"
                                                                id="workplace_p_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_7_file && !Illuminate\Support\Str::contains($workplace_p_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_7_file"
                                                                id="workplace_p_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_p_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_p_8_file && !Illuminate\Support\Str::contains($workplace_p_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_p_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_p_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_p_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_p_8_file"
                                                                id="workplace_p_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_1_file && !Illuminate\Support\Str::contains($workplace_q_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_1_file"
                                                                id="workplace_q_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_2_file && !Illuminate\Support\Str::contains($workplace_q_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_2_file"
                                                                id="workplace_q_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_3_file && !Illuminate\Support\Str::contains($workplace_q_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_3_file"
                                                                id="workplace_q_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_4_file && !Illuminate\Support\Str::contains($workplace_q_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_4_file"
                                                                id="workplace_q_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_5_file && !Illuminate\Support\Str::contains($workplace_q_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_5_file"
                                                                id="workplace_q_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_6_file && !Illuminate\Support\Str::contains($workplace_q_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_6_file"
                                                                id="workplace_q_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_7_file && !Illuminate\Support\Str::contains($workplace_q_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_7_file"
                                                                id="workplace_q_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_8_file && !Illuminate\Support\Str::contains($workplace_q_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_8_file"
                                                                id="workplace_q_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_9_file && !Illuminate\Support\Str::contains($workplace_q_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_9_file"
                                                                id="workplace_q_9_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_q_10 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_q_10_file && !Illuminate\Support\Str::contains($workplace_q_10_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_q_10_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_q_10_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_q_10_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_q_10_file"
                                                                id="workplace_q_10_file" placeholder="Pilih File"
                                                                :error="'workplace_q_10_file'" />
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_r_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_r_1_file && !Illuminate\Support\Str::contains($workplace_r_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_r_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_r_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_r_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_r_1_file"
                                                                id="workplace_r_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_r_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_r_2_file && !Illuminate\Support\Str::contains($workplace_r_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_r_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_r_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_r_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_r_2_file"
                                                                id="workplace_r_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_r_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_r_3_file && !Illuminate\Support\Str::contains($workplace_r_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_r_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_r_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_r_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_r_3_file"
                                                                id="workplace_r_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_r_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_r_4_file && !Illuminate\Support\Str::contains($workplace_r_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_r_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_r_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_r_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_r_4_file"
                                                                id="workplace_r_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_r_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_r_5_file && !Illuminate\Support\Str::contains($workplace_r_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_r_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_r_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_r_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_r_5_file"
                                                                id="workplace_r_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_1 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_1_file && !Illuminate\Support\Str::contains($workplace_s_1_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_1_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_1_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_1_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_1_file"
                                                                id="workplace_s_1_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_2 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_2_file && !Illuminate\Support\Str::contains($workplace_s_2_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_2_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_2_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_2_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_2_file"
                                                                id="workplace_s_2_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_3 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_3_file && !Illuminate\Support\Str::contains($workplace_s_3_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_3_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_3_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_3_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_3_file"
                                                                id="workplace_s_3_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_4 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_4_file && !Illuminate\Support\Str::contains($workplace_s_4_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_4_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_4_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_4_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_4_file"
                                                                id="workplace_s_4_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_5 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_5_file && !Illuminate\Support\Str::contains($workplace_s_5_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_5_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_5_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_5_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_5_file"
                                                                id="workplace_s_5_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_6 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_6_file && !Illuminate\Support\Str::contains($workplace_s_6_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_6_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_6_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_6_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_6_file"
                                                                id="workplace_s_6_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_7 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_7_file && !Illuminate\Support\Str::contains($workplace_s_7_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_7_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_7_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_7_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_7_file"
                                                                id="workplace_s_7_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_8 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_8_file && !Illuminate\Support\Str::contains($workplace_s_8_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_8_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_8_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_8_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_8_file"
                                                                id="workplace_s_8_file" placeholder="Pilih File"
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="wrapper_workplace_s_9 d-flex flex-column gap-3"
                                                ...
                                                <div x-cloak
                                                    ...
                                                    @if ($workplace_s_9_file && !Illuminate\Support\Str::contains($workplace_s_9_file, 'private/var/folders/'))
                                                        <div class="row mt-3">
                                                            <div class="col-md-3"><button type="button"
                                                                    class="btn btn-outline-secondary"
                                                                    wire:click="setFileNull('workplace_s_9_file')"><i
                                                                        class="fa fa-edit"></i> Ubah
                                                                    File</button></div>
                                                            <div class="col-md-9">
                                                                <a class="btn btn-outline-secondary"
                                                                    href="{{ route('kplh::download-file', ['workplace', $workplace_s_9_file]) }}"
                                                                    target="_blank"><i class="fa fa-file"></i>
                                                                    {{ Illuminate\Support\Str::limit($workplace_s_9_file, 30) }}</a>
                                                            </div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12 mt-3">
                                                            <x-kplh-file wire:model="workplace_s_9_file"
                                                                id="workplace_s_9_file" placeholder="Pilih File"
