...
namespace Modules\FieldLeadership\Http\Livewire\MasterLibrary\PotencyConsequence\Partials;
...
class TableMaker extends Component
{
    ...
    public function mount()
    {
        ...
        $this->countData = FieldLeadershipPotencyAndConsequnce::get()->count();
    ...
    public function getPotenciesProperty()
    {
        if ($this->cachedPotencies === null) {
            $this->cachedPotencies = FieldLeadershipPotencyAndConsequnce::search($this->search)->paginate(10);
        }
    ...
    public function toggleSelectAll()
    {
        ...
        if (!$this->selectAll) {
            ...
            // Select all items
            $this->itemSelected = $this->potencies->pluck('id')->map(fn ($id) => (string) $id);
            $this->selectAll = true;
            $this->countSelected = $this->potencies->count();
    ...
    {
        return view('fieldleadership::livewire.master-library.potency-consequence.partials.table-maker')->layout('fieldleadership::layouts.app');
    }
}
