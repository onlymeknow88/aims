...
namespace Modules\FieldLeadership\Http\Livewire\Listing\Document\Draft\Partials;
...
class TableMaker extends Component
{
    ...
    {
        return view('fieldleadership::livewire.listing.document.draft.partials.table-maker')->layout('fieldleadership::layouts.app');
    }
}
