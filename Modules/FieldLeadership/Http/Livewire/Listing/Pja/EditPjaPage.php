...
use App\Mail\FieldLeadership\ApprovalDocument;
...
class EditPjaPage extends Component
{
    ...
    public function saved($publish)
    {
        try {
            ...
            $this->fieldLeadership->update([
                ...
                'status' => $publish != 'Draft' ? FieldLeadershipType::OnReviewApproval : FieldLeadershipType::OnReviewPja,
                'requested' => $publish != 'Draft' ? FieldLeadershipType::RequestedApproval : $this->fieldLeadership->requested,
            ]);
            ...
            FieldLeadershipActivity::create([
                ...
                'description' => 'Field Leadership On Review PJA',
            ...
            // Mail::to($this->fieldLeadership->pjo->email)->send(new ApprovalDocument($this->fieldLeadership));
    ...
    {
        return view('fieldleadership::livewire.listing.pja.edit-page')->extends('fieldleadership::layouts.no-header');
    }
}
