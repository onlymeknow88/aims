<div x-data="{
    ...
    toggleSelectAll() {
        if (this.isAllSelected()) {
            ...
            this.itemSelected = {{ json_encode($this->potencies->pluck('id')->map(fn($id) => (string)$id)->toArray()) }};
        }
    },
    isAllSelected() {
        return this.itemSelected.length > 0 && this.itemSelected.length === {{ $this->potencies->count() }};
    },
    toggleItem(id) {
        id = String(id);
    ...
    <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2">
        ...
        <div class="toolbar-left d-flex align-items-center">
            ...
            <a href="#" type="button" class="button-toolbar d-flex gap-2 align-items-center py-2 px-3 add-new"
                data-bs-toggle="modal" data-bs-target="#FLPotencyModal">
