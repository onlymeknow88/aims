            ...
            <div x-data="{ 
                ...
                <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2">
                    ...
                    <div class="toolbar-left d-flex align-items-center">
                        ...
                        <a x-bind:href="'{{ route('field-leadership::listing.request-review-pja.edit', 'ID_PLACEHOLDER') }}'.replace('ID_PLACEHOLDER', itemSelected[0])"
                            type="button"
                            x-bind:class="itemSelected.length == 1 ? 'd-flex' : 'd-none'"
                            ...
                            <tbody>
                                @foreach ($this->activeListings as $itemIndex => $items)
                                    <tr wire:key="fl-row-{{ $items->id }}"
                                        ...
                                        @if (in_array('Company', $selectedColumns))
                                            <td>
                                                <a href="{{ route('field-leadership::listing.request-review-pja.detail', $items->id) }}"
