<div class="inner-content">
    ...
    <div class="header-detail-maker h-60px border d-flex gap-2 align-items-center px-3">
        @if (auth()->user()->can('Field Leadsership - View Request Review For PJA'))
            ...
            <a href="{{ route('field-leadership::listing.request-review-pja.edit', $field->id) }}"
            ...
            <div class="section-info py-3 px-2 d-flex flex-column gap-2">
                ...
                <div class="content-section d-flex flex-column gap-1">
                    ...
                    <div class="module-info-items row">
                        ...
                        <div class="col-8">
                            <span
                                class="{{ $field->status == App\Enums\FieldLeadership\FieldLeadershipType::Open ? 'cancel' : ($field->status == App\Enums\FieldLeadership\FieldLeadershipType::Close ? 'done' : ($field->status == App\Enums\FieldLeadership\FieldLeadershipType::OnReviewPja ? 'default' : ($field->status == App\Enums\FieldLeadership\FieldLeadershipType::Overdue ? 'cancel' : 'pending'))) }}">
                                {{ $field->status }}
                            </span>
                        </div>
                    </div><!-- /.module-info-items -->
