                        ...
                        <table class="table" style="height: fit-content">
                            <thead>
                                <tr :class="selectAll ? 'selected' : 'tr'">
                                    <th class="sticky-top" @click="
                                         selectAll = !selectAll;
                                         if (selectAll) {
                                             itemSelected = Array.from(document.querySelectorAll('tbody tr[wire\\:key]')).map(tr => tr.getAttribute('wire:key').replace('draft-pica-row-', ''));
                                         } else {
                                             itemSelected = [];
                                         }
                                     ">
                            ...
                            <tbody>
                                @foreach ($this->activeListings as $itemIndex => $items)
                                    <tr wire:key="draft-pica-row-{{ $items->id }}"
