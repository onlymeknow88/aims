...
class EditActiveDocumentPage extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->source = $this->pica->source;
        $this->date = $this->pica->date;
        $this->ccow_id = $this->pica->ccow_id;
        $this->company_id = $this->pica->company_id;
        $this->detail_company = $this->pica->company_detail;
        $this->section_id = $this->pica->section_id;
        $this->area_location_id = $this->pica->location_id;
        $this->detail_location = $this->pica->location_detail;
        $this->pja_id = $this->pica->pja_id;
        $this->pjo_id = $this->pica->pjo_id;
        $this->type = $this->pica->type;
        $this->job = $this->pica->job;
        $this->visit_time = $this->pica->visit_time;
        $this->non_compliance = $this->pica->non_compliance;
        $this->non_compliance_root = $this->pica->non_compliance_root_cause;
        $this->target_date = $this->pica->target_settlement_date;
        $this->settlement_date = $this->pica->settlement_date;
        $this->auditor = $this->pica->auditor;
        $this->corrective_action = $this->pica->corrective_action;
        $this->remarks = $this->pica->remarks;
        $this->status = $this->pica->status;
        $this->company_type = Company::find($this->pica->company_id);

        foreach ($this->pica->picaFiles as $key => $file) {
    ...
    public function saved($published)
    {
        try {
            ...
            $picaDocument = $this->pica;

            $picaDocument->update([
                'identity_id' => $this->pica->identity_id,
                'source' => $this->source,
                'type' => $this->type,
    ...
    {
        return view('pica::livewire.listing.active-document.edit-active-document-page')->extends('pica::layouts.no-header');
    }
}
