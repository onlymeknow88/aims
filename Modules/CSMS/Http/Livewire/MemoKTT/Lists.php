...
class Lists extends Component
{
    ...
    public $info = false;
    public $columns = ['Memo Number', 'Title', 'CCOW', 'Initiator KTT', 'Date', 'Status', 'Published'];
    ...
    {
        try {
            return CsmsMemoKtt::paginate($this->limit);
        } catch (\Throwable $err) {
    ...
    {
        return view('csms::livewire.memo-k-t-t.lists')->layout('csms::layouts.app');
    }
}
