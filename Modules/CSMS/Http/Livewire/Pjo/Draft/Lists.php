...
namespace Modules\CSMS\Http\Livewire\Pjo\Draft;
...
class Lists extends Component
{
    ...
    public function mount()
    {
        ...
        $this->countData = CsmsPjo::where('published', CsmsStatus::Draft)->count();

        $this->limit = $this->countData;

        $this->fieldCompany = CsmsPjo::where('published', CsmsStatus::Draft)
        ...
        $this->fieldCcow = CsmsPjo::where('published', CsmsStatus::Draft)
    ...
    {
        return view('csms::livewire.pjo.draft.lists')->layout('csms::layouts.app');
    }
}
