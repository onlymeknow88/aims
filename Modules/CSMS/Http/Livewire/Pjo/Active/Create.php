...
class Create extends Component
{
    ...
    protected function rules()
    {
        return [
            ...
            'phone' => 'required',
            'email' => 'required',
            'temporaryFile.competency_file' => 'required',
            'temporaryFile.other_file' => 'nullable',
            'temporaryFile.cv_file' => 'required',
            'temporaryFile.appoinment_file' => 'required',
            'temporaryFile.organizational_file' => 'required',
    ...
    public function saved($published)
    {
        try {
            ...
            $messages = [
                ...
                'temporaryFile.competency_file.required' => 'File kompetensi wajib diupload.',
                'temporaryFile.cv_file.required' => 'File CV wajib diupload.',
                'temporaryFile.appoinment_file.required' => 'File penunjukan wajib diupload.',
                'temporaryFile.organizational_file.required' => 'File organisasi wajib diupload.',
            ];
            $company = Bidding::find($this->company_id);
            if ($company && isset($company->type) && $company->type == CompanyType::Subcontractor) {
            ...
            return redirect()->route('csms::pjo.ongoing');
        } catch (\Throwable $err) {
    ...
    {
        return view('csms::livewire.pjo.active.create')->extends('csms::layouts.no-header');
    }
}
