...
class ListsDraft extends Component
{
    ...
    public function getLabelListingsProperty()
    {
        return Bidding::when(!empty($this->sortSelected), function ($query) {
            ...
            ->when(!auth()->user()->can('CSMS - Post Bidding View Draft'), function ($query) {
    ...
    {
        return view('csms::livewire.post-bidding.lists-draft')->layout('csms::layouts.app');
    }
}
