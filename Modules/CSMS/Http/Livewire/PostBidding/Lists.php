...
class Lists extends Component
{
    ...
    public function mount()
    {
        ...
        if (auth()->user()->can('CSMS - Post Bidding View Active')) {
            $b = Bidding::where('criteria', CsmsStatus::PostBidding)
    ...
    public function getBiddingListingsProperty()
    {
        return Bidding::when(!empty($this->sortSelected), function ($query) {
            ...
            ->when(!auth()->user()->can('CSMS - Post Bidding View Active'), function ($query) {
    ...
    {
        return view('csms::livewire.post-bidding.lists')->layout('csms::layouts.app');
    }
}
