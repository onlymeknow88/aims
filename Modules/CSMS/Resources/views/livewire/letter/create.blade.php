            ...
            <div class="col-8">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="own-info mb-5">
                        ...
                        <div class="mb-5">
                            <h5 class="fw-normal">Letter KTT</h5>
                        </div>

                        <div class="row mb-3 form-group required">
                            <label for="letter_number" class="col col-form-label">
                                Letter Number
                            </label>
                            <div class="col-8">
                                <x-inputs.text wire:model.defer="letter_number" id="letter_number" placeholder="Letter Number"
                                    :error="'letter_number'" />
                            </div>
