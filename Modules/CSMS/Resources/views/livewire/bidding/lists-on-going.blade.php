                ...
                <div class="toolbar-tables border-top border-bottom d-flex justify-content-between p-2">
                    <div class="toolbar-left d-flex align-items-center">
                        ...
                        <div class="new-wrapper">
                            <a href="{{ route('csms::bidding.create') }}" type="button"
                        ...
                        @if ($countSelected > 0)
                            ...
                            @if ($countSelected == 1)
                                {{-- @if ($status == 'DRAFT') --}}
                                {{-- @can('CSMS - Edit') --}}
                                <a href="{{ route('csms::bidding.edit', $itemSelected) }}" type="button"
                                                        ...
                                                        <div class="dropdown-content p-3 d-flex gap-3 flex-column">
                                                            <div class="sort-search">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        wire:model.1500ms="searchCriteria" id="searchCriteria"
                                                                        placeholder="Cari data" aria-label="Name"
                                                                        aria-describedby="search-icon">
                                                                </div>
                                                            </div>
                                                                ...
                                                                @foreach ($this->companybusinesstypes as $index => $item)
                                                                    <div class="form-check">
                                                                        <input class="form-check-input rounded-circle"
                                                                            type="checkbox"
                                                                            id="CheckBoxInspectCcowId_{{ $index }}"
                                                                            wire:click="sortCheck('business_entity_id', '{{ $item->id }}')">
                                                                        <label class="form-check-label fw-normal"
                                                                            for="CheckBoxInspectCcowId_{{ $index }}">{{ $item->name }}</label>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                        ...
                                        @if (in_array('CCOW', $selectedColumns))
                                            <td>
                                                @isset($items->ccow->company_name)
                                                    <a href="{{ route('csms::bidding.detail', $items->id) }}"
                                            ...
                                            <td>
                                                @isset($items->requested)
                                                    <span
                                                        ...
                                                        {{ $items->requested == App\Enums\CSMS\CsmsStatus::Approved ? 'On Going' : $items->requested }}
                                                    </span>
                                                @endisset
                                            </td>
                                        @endif
