    ...
    <div
        ...
        <div class="left-header">
            <a href="javascript:history.go(-1)" class="d-flex align-items-center gap-3">
                ...
                <span>EDIT DATA - POST BIDDING</span>
            </a>
        </div><!-- /.left-header -->
                            ...
                            <div class="content-section p-4" wire:ignore.self>
                                ...
                                <div class="row mb-3 form-group">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <x-inputs.select2 id="bidding_id" placeholder="" :error="'bidding_id'"
                                            wire:model.defer="bidding_id" disabled>
                                ...
                                <div class="row mb-3 form-group">
                                    <label for="scope_of_business" class="col-lg-6 col-md-12 col-form-label"><a
                                            href="#" style="color: #00552f">Lingkup Usaha/Jasa (Sesuai Surat Ijin
                                            Dari Instansi
                                            Terkait)</a></label>
                                    <div class="col-lg-6 col-md-12">
                                ...
                                <div class="row mb-4 form-group">
                                    <label for="risk_category" class="col-lg-6 col-md-12 col-form-label">
                                        Persyaratan Administratif
                                    </label>
                                    <div class="col-lg-6 col-md-12">
                                        <h6 for="date" class="col-12 col-form-label mb-3">
                                ...
                                <div class="row mb-3 form-group">
                                    <label for="classification" class="col-lg-6 col-md-12 col-form-label">Klasifikasi</label>
                                    <div class="col-lg-6 col-md-12">
                                ...
                                <div>
                                    <div class="content-section p-4" wire:ignore.self>
                                        ...
                                        @foreach ($bidding->checklists as $index => $value)
                                            {{-- @if ($val->id == $value->question_id) --}}
                                            <h6>{{ $value->point }}</h6>
                                            {{-- @foreach ($v as $i => $value) --}}
                                            <div class="row form-group mb-4 mt-4" x-data="{ checklist_csms_value_{{ $value->question_id }}: @entangle('checklist_csms_value_' . $value->question_id) }">
                                                                ...
                                                                @foreach (${'oldFiles_' . $value->question_id} as $keyFile => $itemFile)
                                                                    ...
                                                                    <div class="row form-group mb-3 m-1">
                                                                        ...
                                                                        <div class="col-sm-1 text-center p-2"
                                                                            ...
                                                                            <button type="button"
                                                                                class="btn btn-light-secondary text-center"
                                                                                wire:click="deleteOldFile('{{ $itemFile['id'] }}', '{{ $value->question_id }}', {{ $keyFile }})">
                                                                                <i class="fa fa-x"></i>
                                                                            </button>
                                                                        </div>
                                            ...
                                            {{-- @endforeach --}}
                                            {{-- @else --}}
                                            {{-- <div class="row form-group mb-4 mt-4" x-data="{ checklist_csms_value_{{ $val->id }}: @entangle('checklist_csms_value_' . $val->id) }">
                                                            <label for="checklist_csms_{{ $val->id }}_label"
                                                                class="col-lg-6 col-md-12 col-form-label">{!! $val->crtiteria !!}
                                                                <br>
                                                                <br>
                                                                <small style="color: blue">{!! $val->legal_base !!}</small>
                                                                <br>
                                                                <br>
                                                                <small style="color: blue">{!! $val->note !!}</small>
                                                            </label>
                                                            <div class="col-lg-6 col-md-12">
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <div class="mt-3">
                                                                            ...
                                                                            @foreach (${'files_data_' . $val->id} as $keyFile => $itemFile)
                                                                                <div class="row form-group mb-3 m-1">
                                                                                    <div
                                                                                        class="col-sm-11 bg-white d-flex justify-content-between p-2 file-list">
                                                                                        <div>
                                                                                    ...
                                                                                    <div class="col-sm-1 text-center p-2"
                                                                                        wire:click="removeFile({{ $val->id }},{{ $keyFile }})">
                                                                                        <button type="button"
                                                                                            class="btn btn-light-secondary text-center"
                                                                                            wire:click="removeFile({{ $val->id }},{{ $keyFile }})">
                                                                                            <i class="fa fa-x"></i>
