<div class="inner-content">
    ...
    <div class="section-content">
        ...
        <div class="section-title py-3 px-2">
            <h4>Otoritas Instansi</h4>
        </div><!-- /.section-title -->

        <div class="table-maker">

            <livewire:kpp::master-library.agency-authority.partials.table-maker />
    ...
    <!-- Modal -->
    <div class="modal fade" id="FLAgencyAuthorityModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="FLAgencyAuthorityModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="FLAgencyAuthorityModalLabel">Otoritas Instansi</h5>
