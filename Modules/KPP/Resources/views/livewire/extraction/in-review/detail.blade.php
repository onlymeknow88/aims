<div class="inner-content">
    ...
    <div class="header-detail-maker h-60px border d-flex gap-2 align-items-center px-3">
        ...
        @if($extraction->status == 'Checking')
            <a href="{{route('kpp::extractions.index')}}" class="d-flex align-items-center gap-3">
                <span><i class="fa-solid fa-arrow-left"></i></span>
                <span>Ekstraksi</span>
            </a>
        @elseif($extraction->status == 'In Review')
            <a href="{{route('kpp::extractions.index')}}" class="d-flex align-items-center gap-3">
                <span><i class="fa-solid fa-arrow-left"></i></span>
                <span>Ekstraksi</span>
            </a>
        @elseif($extraction->status == 'Under Revision')
            <a href="{{route('kpp::extractions.index')}}" class="d-flex align-items-center gap-3">
                <span><i class="fa-solid fa-arrow-left"></i></span>
                <span>Ekstraksi</span>
            </a>
        @elseif($extraction->status == 'Draft')
            <a href="{{route('kpp::extractions.draft')}}" class="d-flex align-items-center gap-3">
                <span><i class="fa-solid fa-arrow-left"></i></span>
                <span>Ekstraksi</span>
            </a>
        @else
        ...
        @if($extraction->status == 'Checking' || $extraction->status == 'Under Revision' || $extraction->status == 'Draft')
            <a href="{{route('kpp::extractions.edit', ['id' => $extraction->id])}}" class="btn btn-edit text-white bg-146943"> <i class="fas fa-pencil"></i> Edit</a>
        @endif
    ...
    <div class="detail-approval-content d-flex">
        ...
        <div class="section-content w-100 py-3 px-5 d-flex flex-column gap-3">
                    ...
                    <div class="col-8">
                            ...
                            <div class="footer-action mb-2">
                                ...
                                <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                                    <!-- <a href="1" class="btn btn-outline-secondary">Ganti Peraturan</a> -->
                                        @if($extraction->status == 'Checking')
                                        ...
                                        @if($extraction->status == 'Under Revision')
                                            <a href="#" wire:click="$emit('submit-reviewer')" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4">Submit for Review</a>
                                        @endif

                                        @if($extraction->status == 'In Review')
                                            <div class="button-document">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <button data-bs-toggle="modal" data-bs-target="#PatuhModal" type="button" class="dropdown-item" href="#">
                                                            Patuh
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button data-bs-toggle="modal" data-bs-target="#TidakPatuhModal" type="button" class="dropdown-item" href="#">
                                                            Tidak Patuh
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button data-bs-toggle="modal" data-bs-target="#TidakBerlakuModal" type="button" class="dropdown-item" href="#">
                                                            Tidak Berlaku
                                                        </button>
                                                    </li>
                                                </ul>
            ...
            <div class="modal fade" id="PatuhModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                aria-labelledby="CommentModal" aria-hidden="true" wire:ignore.self>
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="CommentModal">Patuh</h5>
                            <button type="button" class="btn-close" wire:click="closeModal()" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <p>Yakin untuk mengubah status ekstraksi menjadi Patuh?</p>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                                wire:click="closeModal()">Close</button>
                            <button type="button" wire:click="comply()"
            ...
            <div class="modal fade" id="TidakBerlakuModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                aria-labelledby="CommentModal" aria-hidden="true" wire:ignore.self>
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="CommentModal">Tidak Berlaku</h5>
                            <button type="button" class="btn-close" wire:click="closeModal()" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <p>Yakin untuk mengubah status ekstraksi menjadi Tidak Berlaku?</p>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                                wire:click="closeModal()">Close</button>
                            <button type="button" wire:click="notApplicable()"
                                class="btn btn-outline-success bg-green text-white bg-hover-light-success">
                                Submit
                            </button>
                        </div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="TidakPatuhModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                aria-labelledby="CommentModal" aria-hidden="true" wire:ignore.self>
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="CommentModal">Tidak Patuh</h5>
                            <button type="button" class="btn-close" wire:click="closeModal()" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                                wire:click="closeModal()">Close</button>
                            <button type="button" wire:click="notComply()"
                                class="btn btn-outline-success bg-green text-white bg-hover-light-success">
                                Submit
                            </button>
                        </div>
