<div class="inner-content">
    ...
    <div class="header-detail-maker h-60px border d-flex gap-2 align-items-center px-3">
        ...
        <a href="{{route('kpp::extractions.checking')}}" class="d-flex align-items-center gap-3">
            <span><i class="fa-solid fa-arrow-left"></i></span>
            <span>Back</span>
        </a>

        @if($extraction->status == 'Checking' || $extraction->status == 'Under Revision' || $extraction->status == 'Draft')
            <a href="{{route('kpp::extractions.checking.edit', ['id' => $extraction->id])}}" class="btn btn-edit text-white bg-146943"> <i class="fas fa-pencil"></i> Edit</a>
        @endif
                                        ...
                                        @if($extraction->status == 'In Review')
                                            <div class="button-document">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <button type="button" wire:click="close('Complied')" class="dropdown-item"
                                                            href="#">
                                                            Patuh
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button data-bs-toggle="modal" data-bs-target="#TidakPatuhModal" type="button" class="dropdown-item"
                                                            href="#">
                                                            Tidak Patuh
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button type="button" wire:click="close('NotApplicable')" class="dropdown-item"
                                                            href="#">
                                                            Tidak Berlaku
                                                        </button>
                                                    </li>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                                wire:click="closeModal()">Close</button>
                            <button type="button" wire:click="tidakPatuh()"
                                class="btn btn-outline-success bg-green text-white bg-hover-light-success">
                                Submit
                            </button>
                        </div>
