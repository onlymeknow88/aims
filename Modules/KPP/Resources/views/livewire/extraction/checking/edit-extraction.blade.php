                ...
                <form class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="footer-action mb-2">
                        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                            <a href="{{route('kpp::extractions.checking.detail', ['id' => $this->extraction->id])}}" class="btn btn-outline-secondary">Cancel</a>
                            <a href="#" wire:click="save()" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4">Save</a>
                        </div>
                    </div>
                </form>
