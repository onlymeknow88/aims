...
<html>
  ...
  <body>
    ...
    <table style="background: #fff;" class="table-document">
      <thead>
        <tr>
          	<th style="color: #000; padding-left: 30px;">Number</th>
          	<th style="color: #000; padding-left: 30px;">Company</th>
          	<th style="color: #000; padding-left: 30px;">Nomor Peraturan</th>
          	<th style="color: #000; padding-left: 30px;">Judul Peraturan</th>
          	<th style="color: #000; padding-left: 30px;">Pasal</th>
          	<th style="color: #000; padding-left: 30px;">Ayat</th>
          	<th style="color: #000; padding-left: 30px;">Tenggat Waktu</th>
        </tr>
      </thead>
      <tbody>
        <tr>
            <td style="padding-left: 30px;">PT.VolkmanLtd-2023-05-06-12</td>
            <td style="padding-left: 30px;">PT. Volkman Ltd</td>
            <td style="padding-left: 30px;">1111</td>
            <td style="padding-left: 30px;">Peraturan 1</td>
            <td style="padding-left: 30px;">Article 1</td>
            <td style="padding-left: 30px;">Sub Section 1</td>
            <td style="padding-left: 30px;">May 02, 2023</td>
        </tr>
      </tbody>
    </table>
