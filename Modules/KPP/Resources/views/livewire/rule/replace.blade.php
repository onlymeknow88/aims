            ...
            <div class="info bg-white">
                ...
                <div class="info-item p-3 border-bottom border-1">
                    ...
                    <div class="created d-flex flex-column gap-2">
                        ...
                        <h6 class="fw-normal">Otoritas Instansi</h6>

                        <div class="item-content d-flex gap-1 align-items-center">
                            <span class="opacity-50"></span>
                            <span>
                                {{$rule->agencyAuthority->name}}
                            </span>
                        </div>
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="own-info mb-5">
                            ...
                            <div class="mb-3 row form-group required">
                                ...
                                <div class="col-sm-8">
                                    <x-kpp-select-2 wire:model="status" id="status" data-child="status" placeholder="Select Status" :error="'status'">
                            ...
                            @if($status == 'Mencabut Sebagian' || $status == 'Mengubah')
                                <div class="mb-3 row form-group required">
                                    <label for="title" class="col-sm-4 col-form-label">Note</label>
                                    <div class="col-sm-8">
                                        <x-inputs.textarea wire:model="note" id="note" placeholder="Note" :error="'note'"></x-inputs.textarea>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div class="footer-action mb-2">
                            <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
                                ...
                                @if($this->status == 'Mencabut' || $this->status == 'Dicabut')     
                                    <a href="#" wire:click="$emit('confirm')" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4">Submit</a>
                                @else
                                    <a href="#" wire:click="save()" class="btn btn-outline-default bg-green align-item-center text-white position-relative px-4">Submit</a>
                                @endif
                            </div>
                        </div>
                    </form>
...
@push('scripts')
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            ...
            @this.on('confirm', () => {
                Swal.fire({
                    title: 'Nonaktifkan Ekstraksi',
                    text: 'Seluruh Ekstraksi yang berhubungan dengan Peraturan lama akan di nonaktifkan',
                    icon: "warning",
