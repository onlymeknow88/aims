                ...
                <form class="form-horizontal" enctype="multipart/form-data">
                    <div class="own-info mb-5">
                        ...
                        <div class="mb-3 row form-group required">
                            ...
                            <div class="col-sm-8">
                                <x-kpp-select-2 wire:model="agency_authority" id="agency_authority" data-child="section" placeholder="Select Otoritas Instansi" :error="'agency_authority'">
                    ...
                    <div class="row mb-3 form-group required">
                        <div class="col-sm-12">
                            <label for="">Attachment (max:100MB)</label>
                            <div class="">
