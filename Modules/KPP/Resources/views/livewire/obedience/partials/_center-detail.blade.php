<div class="section-content w-100 py-3 px-5 d-flex flex-column gap-3">
                                ...
                                <tr>
                                    ...
                                    @if($items->status == 'Draft')
                                        <td class="text-center">
                                            <a href="{{ route('kpp::obediences.edit-extraction', ['id' => $items->id]) }}" class="action-icon m-1">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a href="#" wire:click="deleteId('{{ $items->id }}')" class="action-icon m-1">
    ...
    @if($obedience->extractions->where('status', 'Draft')->count() > 0)
    <div class="footer-action mb-2">
        <div class="action-wrapper d-flex align-items-center justify-content-end gap-2">
            <button data-bs-toggle="modal" data-bs-target="#submitModal" class="btn btn-outline-default bg-green d-flex justify-content-center align-item-center text-white position-relative px-4">Submit</button>
        </div>
    </div>
    @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="CommentModal">Delete Ekstraksi</h5>
    ...
    <div class="modal fade" id="submitModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="CommentModal">Submit Ekstraksi</h5>
                    <button type="button" class="btn-close" wire:click="closeModal()" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Semua Draft Ekstraksi akan di submit, Lanjutkan?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                        wire:click="closeModal()">Close</button>
