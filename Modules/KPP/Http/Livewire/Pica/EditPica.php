...
class EditPica extends Component
{
    ...
    {
        return view('kpp::livewire.pica.edit')->extends('kpp::layouts.no-header');
    }
    ...
    public function save()
    {
        ...
        try {
            ...
            return redirect(route('kpp::pica.detail', ['id' => $this->extraction->id]));
        } catch (\Exception $exception) {
            $this->dispatchBrowserEvent('swal', [
                'title' => 'Gagal',
                'icon' => 'error',
