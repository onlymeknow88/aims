...
namespace Modules\KPP\Http\Livewire\Auth;
...
class Login extends Component
{
    ...
    public function loginStore()
    {
        ...
        if (Auth::guard('kpp')->attempt(['email' => $this->email, 'password' => $this->password], $this->remember)) {
    ...
    {
        return view('kpp::livewire.auth.login')->extends('kpp::layouts.no-header');
    }
}
